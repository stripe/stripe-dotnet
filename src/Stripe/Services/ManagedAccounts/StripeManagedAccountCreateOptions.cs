...
namespace Stripe
{
    ...
    {
        //Country is the only always-required property; if not provided though it will default to the country of the account
        [JsonProperty("country")]
        public string Country { get; set; }

        //Managed is required to be set to true if the account is managed; default is false
        [JsonProperty("managed")]
        public bool Managed { get; set; } = true;

        //Email is only required if managed is false;
        [JsonProperty("email")]
