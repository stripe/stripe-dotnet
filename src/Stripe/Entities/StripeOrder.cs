...
{
    /// <summary>
    /// A class describing a stripe order entity
    /// </summary>
    public class StripeOrder : StripeObject
    {
        /// <summary>
        /// Gets or sets the object Type. value is "order"
        /// </summary>
        [JsonProperty("object")]
        public string Object { get; set; }

        /// <summary>
        /// Gets or sets a positive integer in the smallest currency unit (that is, 100 cents for $1.00, or 1 for ¥1, Japanese Yen being a 0-decimal currency) representing the total amount for the order.
        /// </summary>
        [JsonProperty("amount")]
        public int Amount { get; set; }

        /// <summary>
        /// Gets or sets the amount returned
        /// </summary>
        [JsonProperty("amount_returned")]
        public int? AmountReturned { get; set; }

        /// <summary>
        /// Gets or sets the ID of the Connect Application that created the order.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the ID of the payment used to pay for the order. Present if the order status is paid, fulfilled, or refunded.
        /// Expandable
        /// </summary>
