namespace StripeTests
{
    ...
    public class StripeSubscriptionItemServiceTest : BaseStripeTest
    {
        private const string SubscriptionItemId = "si_123";

        private StripeSubscriptionItemService service;
        private StripeSubscriptionItemCreateOptions createOptions;
        private StripeSubscriptionItemUpdateOptions updateOptions;
        private StripeSubscriptionItemListOptions listOptions;
