namespace StripeTests
{
    ...
    public class BalanceTransactionTest : BaseStripeTest
    {
        ...
        public void DeserializeWithExpansions()
        {
            ...
            var balanceTransactions = JsonSerializer.Deserialize<StripeList<BalanceTransaction>>(
                json
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[0].SourceId,
                balanceTransactions.Data[0].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[1].SourceId,
                balanceTransactions.Data[1].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[2].SourceId,
                balanceTransactions.Data[2].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[3].SourceId,
                balanceTransactions.Data[3].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[4].SourceId,
                balanceTransactions.Data[4].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[5].SourceId,
                balanceTransactions.Data[5].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[6].SourceId,
                balanceTransactions.Data[6].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[7].SourceId,
                balanceTransactions.Data[7].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[8].SourceId,
                balanceTransactions.Data[8].Source.Id
            );
            ...
            Assert.Equal(
                balanceTransactions.Data[9].SourceId,
                balanceTransactions.Data[9].Source.Id
            );
