...
namespace Stripe.Tests
{
    public class when_listing_fileuploads
    {
        ...
        Establish context = () =>
        {
            ...
            var fileStream =typeof(when_listing_fileuploads).GetTypeInfo().Assembly.GetManifestResourceStream("Stripe.net.Tests.fileuploads.test_data.logo.png");
            _fileService.Create("logo.png", fileStream, StripeFilePurpose.BusinessLogo);
            var fileStream2 = typeof(when_listing_fileuploads).GetTypeInfo().Assembly.GetManifestResourceStream("Stripe.net.Tests.fileuploads.test_data.logo.png");
            _fileService.Create("logo.png", fileStream2, StripeFilePurpose.BusinessLogo);
            var fileStream3 = typeof(when_listing_fileuploads).GetTypeInfo().Assembly.GetManifestResourceStream("Stripe.net.Tests.fileuploads.test_data.logo.png");
