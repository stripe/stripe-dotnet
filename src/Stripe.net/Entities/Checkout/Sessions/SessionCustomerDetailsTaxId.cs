...
namespace Stripe.Checkout
{
    ...
    public class SessionCustomerDetailsTaxId : StripeEntity<SessionCustomerDetailsTaxId>
    {
        ...
        /// <c>ua_vat</c>, <c>is_vat</c>, or <c>unknown</c>.
        ...
        /// <c>in_gst</c>, <c>is_vat</c>, <c>jp_cn</c>, <c>jp_rn</c>, <c>kr_brn</c>, <c>li_uid</c>,
        /// <c>mx_rfc</c>, <c>my_frp</c>, <c>my_itn</c>, <c>my_sst</c>, <c>no_vat</c>,
        /// <c>nz_gst</c>, <c>ru_inn</c>, <c>ru_kpp</c>, <c>sa_vat</c>, <c>sg_gst</c>,
        /// <c>sg_uen</c>, <c>th_vat</c>, <c>tw_vat</c>, <c>ua_vat</c>, <c>unknown</c>,
