...
namespace Stripe.Checkout
{
    ...
    public class SessionPaymentMethodOptionsPayto : StripeEntity<SessionPaymentMethodOptionsPayto>
    {
        [JsonProperty("mandate_options")]
#if NET6_0_OR_GREATER
        [STJS.JsonPropertyName("mandate_options")]
#endif
        public SessionPaymentMethodOptionsPaytoMandateOptions MandateOptions { get; set; }
