...
namespace Stripe
{
    ...
    public class PaymentIntentNextActionCryptoDisplayDetailsDepositAddressesPolygon : StripeEntity<PaymentIntentNextActionCryptoDisplayDetailsDepositAddressesPolygon>
    {
        /// <summary>
        ...
        public List<PaymentIntentNextActionCryptoDisplayDetailsDepositAddressesPolygonSupportedToken> SupportedTokens { get; set; }
    }
}
