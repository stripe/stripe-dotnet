...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsBillieCompanyDetails : StripeEntity<PaymentIntentPaymentMethodOptionsBillieCompanyDetails>
    {
        [JsonProperty("registered_address")]
        [STJS.JsonPropertyName("registered_address")]
        public PaymentIntentPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress RegisteredAddress { get; set; }
