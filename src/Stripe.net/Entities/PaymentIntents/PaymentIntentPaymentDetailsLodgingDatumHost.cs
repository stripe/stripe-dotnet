...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentDetailsLodgingDatumHost : StripeEntity<PaymentIntentPaymentDetailsLodgingDatumHost>
    {
...
#endif
        public DateTime RegisteredAt { get; set; } = Stripe.Infrastructure.DateTimeUtils.UnixEpoch;
    }
}
