...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsVipps : StripeEntity<PaymentIntentPaymentMethodOptionsVipps>
    {
        /// <summary>
        ...
        public PaymentIntentPaymentMethodOptionsVippsPaymentDetails PaymentDetails { get; set; }
