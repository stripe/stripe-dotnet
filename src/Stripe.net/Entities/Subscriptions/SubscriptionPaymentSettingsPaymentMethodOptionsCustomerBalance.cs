...
namespace Stripe
{
    ...
    public class SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalance
        : StripeEntity<SubscriptionPaymentSettingsPaymentMethodOptionsCustomerBalance>
    {
