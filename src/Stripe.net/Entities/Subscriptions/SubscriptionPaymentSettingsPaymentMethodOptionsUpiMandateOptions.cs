...
namespace Stripe
{
    ...
    public class SubscriptionPaymentSettingsPaymentMethodOptionsUpiMandateOptions : StripeEntity<SubscriptionPaymentSettingsPaymentMethodOptionsUpiMandateOptions>
    {
        /// <summary>
