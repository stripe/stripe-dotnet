...
namespace Stripe
{
    ...
    public class SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptions
        : StripeEntity<SubscriptionPaymentSettingsPaymentMethodOptionsCardMandateOptions>
    {
        /// <summary>
