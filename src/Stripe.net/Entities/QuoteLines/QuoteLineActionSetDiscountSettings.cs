...
namespace Stripe
{
    ...
    public class QuoteLineActionSetDiscountSettings : StripeEntity<QuoteLineActionSetDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public QuoteLineActionSetDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
