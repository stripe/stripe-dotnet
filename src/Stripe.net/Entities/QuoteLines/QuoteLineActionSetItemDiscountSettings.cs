...
namespace Stripe
{
    ...
    public class QuoteLineActionSetItemDiscountSettings : StripeEntity<QuoteLineActionSetItemDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public QuoteLineActionSetItemDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
