...
namespace Stripe
{
    ...
    public class QuoteLineActionAddItemDiscountSettings : StripeEntity<QuoteLineActionAddItemDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public QuoteLineActionAddItemDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
