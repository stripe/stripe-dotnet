...
namespace Stripe
{
    ...
    public class QuoteLineActionAddDiscountSettings : StripeEntity<QuoteLineActionAddDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public QuoteLineActionAddDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
