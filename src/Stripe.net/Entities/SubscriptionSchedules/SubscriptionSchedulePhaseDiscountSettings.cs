...
namespace Stripe
{
    ...
    public class SubscriptionSchedulePhaseDiscountSettings : StripeEntity<SubscriptionSchedulePhaseDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public SubscriptionSchedulePhaseDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
