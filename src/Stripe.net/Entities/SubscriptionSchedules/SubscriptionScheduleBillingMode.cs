...
namespace Stripe
{
    ...
    public class SubscriptionScheduleBillingMode : StripeEntity<SubscriptionScheduleBillingMode>
    {
        /// <summary>
...
#endif
        public SubscriptionScheduleBillingModeFlexible Flexible { get; set; }
