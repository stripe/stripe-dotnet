...
namespace Stripe.SharedPayment
{
    ...
    public class GrantedTokenPaymentMethodDetailsUsBankAccountStatusDetailsBlocked : StripeEntity<GrantedTokenPaymentMethodDetailsUsBankAccountStatusDetailsBlocked>
    {
        /// <summary>
