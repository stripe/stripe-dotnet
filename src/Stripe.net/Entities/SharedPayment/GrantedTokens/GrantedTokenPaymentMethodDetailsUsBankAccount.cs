...
namespace Stripe.SharedPayment
{
    ...
    public class GrantedTokenPaymentMethodDetailsUsBankAccount : StripeEntity<GrantedTokenPaymentMethodDetailsUsBankAccount>
    {
        /// <summary>
        ...
        public GrantedTokenPaymentMethodDetailsUsBankAccountNetworks Networks { get; set; }
        ...
        public GrantedTokenPaymentMethodDetailsUsBankAccountStatusDetails StatusDetails { get; set; }
    }
}
