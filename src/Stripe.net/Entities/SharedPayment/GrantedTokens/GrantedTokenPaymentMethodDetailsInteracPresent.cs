...
namespace Stripe.SharedPayment
{
    ...
    public class GrantedTokenPaymentMethodDetailsInteracPresent : StripeEntity<GrantedTokenPaymentMethodDetailsInteracPresent>
    {
        /// <summary>
        ...
        public GrantedTokenPaymentMethodDetailsInteracPresentNetworks Networks { get; set; }
