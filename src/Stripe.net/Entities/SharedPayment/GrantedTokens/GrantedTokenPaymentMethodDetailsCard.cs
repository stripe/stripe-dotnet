...
namespace Stripe.SharedPayment
{
    ...
    public class GrantedTokenPaymentMethodDetailsCard : StripeEntity<GrantedTokenPaymentMethodDetailsCard>
    {
        /// <summary>
        ...
        public GrantedTokenPaymentMethodDetailsCardChecks Checks { get; set; }
        ...
        public GrantedTokenPaymentMethodDetailsCardNetworks Networks { get; set; }
        ...
        public GrantedTokenPaymentMethodDetailsCardWallet Wallet { get; set; }
    }
}
