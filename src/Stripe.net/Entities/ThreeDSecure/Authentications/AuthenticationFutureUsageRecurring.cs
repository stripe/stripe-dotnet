...
namespace Stripe.ThreeDSecure
{
    ...
    public class AuthenticationFutureUsageRecurring : StripeEntity<AuthenticationFutureUsageRecurring>
    {
        /// <summary>
        ...
        public AuthenticationFutureUsageRecurringExpiry Expiry { get; set; }
