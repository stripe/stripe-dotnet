...
namespace Stripe
{
    ...
    public class TaxId : StripeEntity<TaxId>, IHasId, IHasObject
    {
        ...
        /// <c>gb_vat</c>, <c>ge_vat</c>, <c>hk_br</c>, <c>hu_tin</c>, <c>id_npwp</c>,
        ...
        /// <c>ve_rif</c>, <c>vn_tin</c>, or <c>za_vat</c>. Note that some legacy tax IDs have type
        /// <c>unknown</c>.
        ...
        /// <c>kr_brn</c>, <c>kz_bin</c>, <c>li_uid</c>, <c>mx_rfc</c>, <c>my_frp</c>,
        ...
        /// <c>tw_vat</c>, <c>ua_vat</c>, <c>unknown</c>, <c>us_ein</c>, <c>uy_ruc</c>,
