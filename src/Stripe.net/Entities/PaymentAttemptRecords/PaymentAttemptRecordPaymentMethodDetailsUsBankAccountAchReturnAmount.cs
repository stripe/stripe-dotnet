...
namespace Stripe
{
    ...
    public class PaymentAttemptRecordPaymentMethodDetailsUsBankAccountAchReturnAmount : StripeEntity<PaymentAttemptRecordPaymentMethodDetailsUsBankAccountAchReturnAmount>
    {
        /// <summary>
