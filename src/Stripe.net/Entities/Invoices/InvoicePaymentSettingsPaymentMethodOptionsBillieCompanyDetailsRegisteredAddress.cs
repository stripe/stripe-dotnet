...
namespace Stripe
{
    ...
    public class InvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress : StripeEntity<InvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress>
    {
        /// <summary>
