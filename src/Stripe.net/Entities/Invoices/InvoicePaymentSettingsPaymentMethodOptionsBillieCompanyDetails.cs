...
namespace Stripe
{
    ...
    public class InvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetails : StripeEntity<InvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetails>
    {
        [JsonProperty("registered_address")]
        [STJS.JsonPropertyName("registered_address")]
        public InvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress RegisteredAddress { get; set; }
