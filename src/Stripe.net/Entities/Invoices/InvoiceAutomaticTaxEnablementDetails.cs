...
namespace Stripe
{
    ...
    public class InvoiceAutomaticTaxEnablementDetails : StripeEntity<InvoiceAutomaticTaxEnablementDetails>
    {
        /// <summary>
        ...
        public InvoiceAutomaticTaxEnablementDetailsIntegrationConfigurationDisabledReason IntegrationConfigurationDisabledReason { get; set; }
