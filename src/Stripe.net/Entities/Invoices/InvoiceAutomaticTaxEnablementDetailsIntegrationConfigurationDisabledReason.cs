...
namespace Stripe
{
    ...
    public class InvoiceAutomaticTaxEnablementDetailsIntegrationConfigurationDisabledReason : StripeEntity<InvoiceAutomaticTaxEnablementDetailsIntegrationConfigurationDisabledReason>
    {
        /// <summary>
