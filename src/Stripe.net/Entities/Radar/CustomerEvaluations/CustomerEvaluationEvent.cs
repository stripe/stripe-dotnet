...
namespace Stripe.Radar
{
    ...
    public class CustomerEvaluationEvent : StripeEntity<CustomerEvaluationEvent>
    {
        /// <summary>
        ...
        public CustomerEvaluationEventLoginFailed LoginFailed { get; set; }
        ...
        public CustomerEvaluationEventRegistrationFailed RegistrationFailed { get; set; }
