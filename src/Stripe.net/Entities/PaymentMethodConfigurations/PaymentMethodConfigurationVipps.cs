...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationVipps : StripeEntity<PaymentMethodConfigurationVipps>
    {
        /// <summary>
        ...
        public PaymentMethodConfigurationVippsDisplayPreference DisplayPreference { get; set; }
    }
}
