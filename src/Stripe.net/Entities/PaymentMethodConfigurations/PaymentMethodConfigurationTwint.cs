...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationTwint : StripeEntity<PaymentMethodConfigurationTwint>
    {
        /// <summary>
        ...
        public PaymentMethodConfigurationTwintDisplayPreference DisplayPreference { get; set; }
    }
}
