...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationPaypay : StripeEntity<PaymentMethodConfigurationPaypay>
    {
        /// <summary>
...
#endif
        public PaymentMethodConfigurationPaypayDisplayPreference DisplayPreference { get; set; }
    }
}
