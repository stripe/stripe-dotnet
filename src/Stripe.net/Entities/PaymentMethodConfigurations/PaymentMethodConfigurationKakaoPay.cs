...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationKakaoPay : StripeEntity<PaymentMethodConfigurationKakaoPay>
    {
        /// <summary>
...
#endif
        public PaymentMethodConfigurationKakaoPayDisplayPreference DisplayPreference { get; set; }
    }
}
