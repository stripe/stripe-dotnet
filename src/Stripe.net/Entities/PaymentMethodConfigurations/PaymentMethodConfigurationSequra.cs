...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationSequra : StripeEntity<PaymentMethodConfigurationSequra>
    {
        /// <summary>
        ...
        public PaymentMethodConfigurationSequraDisplayPreference DisplayPreference { get; set; }
    }
}
