...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationZip : StripeEntity<PaymentMethodConfigurationZip>
    {
        /// <summary>
        ...
        public PaymentMethodConfigurationZipDisplayPreference DisplayPreference { get; set; }
    }
}
