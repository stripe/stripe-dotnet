...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationPayco : StripeEntity<PaymentMethodConfigurationPayco>
    {
        /// <summary>
...
#endif
        public PaymentMethodConfigurationPaycoDisplayPreference DisplayPreference { get; set; }
    }
}
