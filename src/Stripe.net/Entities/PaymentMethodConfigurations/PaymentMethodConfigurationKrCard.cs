...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationKrCard : StripeEntity<PaymentMethodConfigurationKrCard>
    {
        /// <summary>
...
#endif
        public PaymentMethodConfigurationKrCardDisplayPreference DisplayPreference { get; set; }
    }
}
