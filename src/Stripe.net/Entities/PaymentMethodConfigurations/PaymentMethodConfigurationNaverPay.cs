...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationNaverPay : StripeEntity<PaymentMethodConfigurationNaverPay>
    {
        /// <summary>
...
#endif
        public PaymentMethodConfigurationNaverPayDisplayPreference DisplayPreference { get; set; }
    }
}
