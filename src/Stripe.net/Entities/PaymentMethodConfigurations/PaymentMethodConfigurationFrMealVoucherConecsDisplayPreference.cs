...
namespace Stripe
{
    ...
    public class PaymentMethodConfigurationFrMealVoucherConecsDisplayPreference : StripeEntity<PaymentMethodConfigurationFrMealVoucherConecsDisplayPreference>
    {
        /// <summary>
