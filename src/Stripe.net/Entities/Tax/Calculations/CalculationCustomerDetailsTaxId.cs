...
namespace Stripe.Tax
{
    ...
    public class CalculationCustomerDetailsTaxId : StripeEntity<CalculationCustomerDetailsTaxId>
    {
        ...
        /// <c>rs_pib</c>, <c>sv_nit</c>, <c>uy_ruc</c>, <c>ve_rif</c>, <c>vn_tin</c>,
        /// <c>gb_vat</c>, <c>nz_gst</c>, <c>au_abn</c>, <c>au_arn</c>, <c>in_gst</c>,
        /// <c>no_vat</c>, <c>za_vat</c>, <c>ch_vat</c>, <c>mx_rfc</c>, <c>sg_uen</c>,
        /// <c>ru_inn</c>, <c>ru_kpp</c>, <c>ca_bn</c>, <c>hk_br</c>, <c>es_cif</c>, <c>tw_vat</c>,
        /// <c>th_vat</c>, <c>jp_cn</c>, <c>jp_rn</c>, <c>jp_trn</c>, <c>li_uid</c>, <c>my_itn</c>,
        ...
        /// <c>si_tin</c>, <c>ke_pin</c>, <c>tr_tin</c>, <c>eg_tin</c>, <c>ph_tin</c>, or
        /// <c>unknown</c>.
