...
namespace Stripe
{
    ...
    public class BankAccountRequirementsError : StripeEntity<BankAccountRequirementsError>
    {
        /// <summary>
        /// The code for the type of error.
        /// One of: <c>external_request</c>, <c>information_missing</c>,
        /// <c>invalid_address_city_state_postal_code</c>, <c>invalid_address_cmra_address</c>,
        /// <c>invalid_address_highway_contract_box</c>, <c>invalid_address_private_mailbox</c>,
        /// <c>invalid_address_registered_agent_address</c>, <c>invalid_business_profile_name</c>,
        /// <c>invalid_business_profile_name_denylisted</c>, <c>invalid_company_name_denylisted</c>,
        /// <c>invalid_dob_age_over_maximum</c>, <c>invalid_dob_age_under_18</c>,
        /// <c>invalid_dob_age_under_minimum</c>, <c>invalid_product_description_length</c>,
        /// <c>invalid_product_description_url_match</c>, <c>invalid_representative_country</c>,
        /// <c>invalid_signator</c>, <c>invalid_statement_descriptor_business_mismatch</c>,
        ...
        /// <c>invalid_url_website_other</c>, <c>invalid_value_other</c>, <c>partner_disabled</c>,
        ...
        public BankAccountRequirementsErrorDetails Details { get; set; }
