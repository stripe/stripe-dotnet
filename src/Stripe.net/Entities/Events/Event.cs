...
namespace Stripe
{
    ...
    public class Event : StripeEntity<Event>, IHasId, IHasObject
    {
        ...
        /// <c>invoiceitem.deleted</c>, <c>invoiceitem.updated</c>,
        ...
        /// <c>issuing_card.updated</c>, <c>issuing_card_design.activated</c>,
        /// <c>issuing_card_design.deactivated</c>, <c>issuing_card_design.updated</c>,
