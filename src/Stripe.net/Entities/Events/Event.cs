...
namespace Stripe
{
    ...
    public class Event : StripeEntity<Event>, IHasId, IHasObject
    {
        ...
        /// <c>application_fee.refunded</c>, <c>apps.install.created</c>,
        /// <c>apps.install.deleted</c>, <c>apps.install.updated</c>, <c>balance.available</c>,
        ...
        /// <c>invoice.will_be_due</c>, <c>invoice_payment.detached</c>,
        /// <c>invoice_payment.paid</c>, <c>invoiceitem.created</c>, <c>invoiceitem.deleted</c>,
        ...
        /// <c>payment_method.updated</c>, <c>payment_plan.created</c>,
        /// <c>payment_plan.installment_due</c>, <c>payment_plan.installment_paid</c>,
        /// <c>payment_plan.installment_will_be_due</c>, <c>payment_plan.updated</c>,
        /// <c>payout.canceled</c>, <c>payout.created</c>, <c>payout.failed</c>, <c>payout.paid</c>,
        ...
        /// <c>product.deleted</c>, <c>product.updated</c>, <c>promotion_code.created</c>,
        /// <c>promotion_code.updated</c>, <c>quote.accept_failed</c>, <c>quote.accepted</c>,
        /// <c>quote.accepting</c>, <c>quote.canceled</c>, <c>quote.created</c>, <c>quote.draft</c>,
        /// <c>quote.finalized</c>, <c>quote.reestimate_failed</c>, <c>quote.reestimated</c>,
        /// <c>quote.stale</c>, <c>radar.early_fraud_warning.created</c>,
        /// <c>radar.early_fraud_warning.updated</c>, <c>refund.created</c>, <c>refund.failed</c>,
        /// <c>refund.updated</c>, <c>reporting.report_run.failed</c>,
        /// <c>reporting.report_run.succeeded</c>, <c>reporting.report_type.updated</c>,
        /// <c>reserve.hold.created</c>, <c>reserve.hold.updated</c>, <c>reserve.plan.created</c>,
        /// <c>reserve.plan.disabled</c>, <c>reserve.plan.expired</c>, <c>reserve.plan.updated</c>,
