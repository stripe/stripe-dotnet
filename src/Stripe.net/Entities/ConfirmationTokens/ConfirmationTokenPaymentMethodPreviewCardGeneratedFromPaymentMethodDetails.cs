...
namespace Stripe
{
    ...
    public class ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetails
        : StripeEntity<ConfirmationTokenPaymentMethodPreviewCardGeneratedFromPaymentMethodDetails>
    {
