...
namespace Stripe
{
    ...
    public class QuoteSubscriptionDataOverrideBillOnAcceptanceBillUntilDuration : StripeEntity<QuoteSubscriptionDataOverrideBillOnAcceptanceBillUntilDuration>
    {
        /// <summary>
