...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertHistoryEntryAuthorizationRateDrop : StripeEntity<AlertHistoryEntryAuthorizationRateDrop>
    {
        /// <summary>
        ...
        public List<AlertHistoryEntryAuthorizationRateDropDimension> Dimensions { get; set; }
