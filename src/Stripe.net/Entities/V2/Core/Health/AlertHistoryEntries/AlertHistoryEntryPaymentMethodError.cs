...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertHistoryEntryPaymentMethodError : StripeEntity<AlertHistoryEntryPaymentMethodError>
    {
        /// <summary>
        ...
        public List<AlertHistoryEntryPaymentMethodErrorTopImpactedAccount> TopImpactedAccounts { get; set; }
    }
}
