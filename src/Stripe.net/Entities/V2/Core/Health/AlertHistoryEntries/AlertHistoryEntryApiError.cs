...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertHistoryEntryApiError : StripeEntity<AlertHistoryEntryApiError>
    {
        /// <summary>
        /// The canonical path.
        /// </summary>
        ...
        public List<AlertHistoryEntryApiErrorTopImpactedAccount> TopImpactedAccounts { get; set; }
    }
}
