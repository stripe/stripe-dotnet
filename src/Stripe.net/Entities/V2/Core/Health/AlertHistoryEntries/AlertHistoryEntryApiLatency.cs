...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertHistoryEntryApiLatency : StripeEntity<AlertHistoryEntryApiLatency>
    {
        /// <summary>
        /// The canonical path.
        /// </summary>
        ...
        public List<AlertHistoryEntryApiLatencyTopImpactedAccount> TopImpactedAccounts { get; set; }
    }
}
