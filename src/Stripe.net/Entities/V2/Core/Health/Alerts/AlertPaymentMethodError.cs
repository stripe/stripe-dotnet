...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertPaymentMethodError : StripeEntity<AlertPaymentMethodError>
    {
        /// <summary>
        ...
        public List<AlertPaymentMethodErrorTopImpactedAccount> TopImpactedAccounts { get; set; }
    }
}
