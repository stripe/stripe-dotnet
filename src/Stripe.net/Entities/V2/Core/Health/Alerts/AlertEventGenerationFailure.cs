...
namespace Stripe.V2.Core.Health
{
    ...
    public class AlertEventGenerationFailure : StripeEntity<AlertEventGenerationFailure>
    {
        /// <summary>
        ...
        public AlertEventGenerationFailureRelatedObject RelatedObject { get; set; }
    }
}
