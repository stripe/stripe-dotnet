...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorCommercialAccountHolder : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorCommercialAccountHolder>
    {
        /// <summary>
