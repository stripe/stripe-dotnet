...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundTransfersFinancialAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundTransfersFinancialAccountsProtectionsPspMigration>
    {
        /// <summary>
