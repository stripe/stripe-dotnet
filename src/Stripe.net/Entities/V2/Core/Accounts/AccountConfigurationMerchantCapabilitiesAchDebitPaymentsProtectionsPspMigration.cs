...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAchDebitPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesAchDebitPaymentsProtectionsPspMigration>
    {
        /// <summary>
