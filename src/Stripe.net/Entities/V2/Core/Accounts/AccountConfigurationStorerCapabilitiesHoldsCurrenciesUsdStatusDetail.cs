...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesHoldsCurrenciesUsdStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesHoldsCurrenciesUsdStatusDetail>
    {
        /// <summary>
