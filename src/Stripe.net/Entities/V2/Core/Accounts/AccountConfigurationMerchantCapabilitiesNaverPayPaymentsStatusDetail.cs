...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesNaverPayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesNaverPayPaymentsStatusDetail>
    {
        /// <summary>
