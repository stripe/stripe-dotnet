...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSwishPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesSwishPaymentsStatusDetail>
    {
        /// <summary>
