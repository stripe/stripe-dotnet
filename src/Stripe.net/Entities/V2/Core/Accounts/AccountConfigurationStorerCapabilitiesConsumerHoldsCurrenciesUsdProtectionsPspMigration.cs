...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdProtectionsPspMigration>
    {
        /// <summary>
