...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundPaymentsFinancialAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundPaymentsFinancialAccountsProtectionsPspMigration>
    {
        /// <summary>
