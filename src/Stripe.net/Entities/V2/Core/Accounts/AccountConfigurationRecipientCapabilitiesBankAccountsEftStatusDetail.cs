...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsEftStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsEftStatusDetail>
    {
        /// <summary>
