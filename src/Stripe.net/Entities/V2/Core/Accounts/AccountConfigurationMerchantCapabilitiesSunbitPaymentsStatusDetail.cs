...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSunbitPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesSunbitPaymentsStatusDetail>
    {
        /// <summary>
