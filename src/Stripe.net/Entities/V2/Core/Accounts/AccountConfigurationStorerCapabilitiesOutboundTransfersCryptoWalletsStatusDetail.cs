...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundTransfersCryptoWalletsStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundTransfersCryptoWalletsStatusDetail>
    {
        /// <summary>
