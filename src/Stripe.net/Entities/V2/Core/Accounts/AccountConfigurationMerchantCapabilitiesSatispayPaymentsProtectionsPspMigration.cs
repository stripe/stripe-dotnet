...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSatispayPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesSatispayPaymentsProtectionsPspMigration>
    {
        /// <summary>
