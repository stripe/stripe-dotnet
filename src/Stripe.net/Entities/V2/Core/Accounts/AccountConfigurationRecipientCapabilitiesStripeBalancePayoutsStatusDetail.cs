...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesStripeBalancePayoutsStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesStripeBalancePayoutsStatusDetail>
    {
        /// <summary>
