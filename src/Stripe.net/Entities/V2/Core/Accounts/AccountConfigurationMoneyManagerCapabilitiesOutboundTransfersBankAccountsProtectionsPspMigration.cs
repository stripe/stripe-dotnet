...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsProtectionsPspMigration>
    {
        /// <summary>
