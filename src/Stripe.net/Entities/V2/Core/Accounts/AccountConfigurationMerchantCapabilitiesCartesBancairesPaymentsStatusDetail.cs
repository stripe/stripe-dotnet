...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesCartesBancairesPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesCartesBancairesPaymentsStatusDetail>
    {
        /// <summary>
