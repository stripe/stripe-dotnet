...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerCelticApplePay : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerCelticApplePay>
    {
        /// <summary>
