...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsStatusDetail>
    {
        /// <summary>
