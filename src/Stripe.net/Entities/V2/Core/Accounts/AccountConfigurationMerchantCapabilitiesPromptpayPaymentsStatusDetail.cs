...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesPromptpayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesPromptpayPaymentsStatusDetail>
    {
        /// <summary>
