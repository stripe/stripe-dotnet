...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialStripePrepaidCardProtectionsPspMigration : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialStripePrepaidCardProtectionsPspMigration>
    {
        /// <summary>
