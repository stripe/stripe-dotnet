...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundTransfersCryptoWalletsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundTransfersCryptoWalletsProtectionsPspMigration>
    {
        /// <summary>
