...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerGlobalAccountHolder : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerGlobalAccountHolder>
    {
        /// <summary>
