...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSepaDebitPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesSepaDebitPaymentsStatusDetail>
    {
        /// <summary>
