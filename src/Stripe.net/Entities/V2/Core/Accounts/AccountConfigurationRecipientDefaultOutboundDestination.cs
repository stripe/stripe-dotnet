...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientDefaultOutboundDestination : StripeEntity<AccountConfigurationRecipientDefaultOutboundDestination>, IHasId
    {
        ...
        /// <c>ci_bank_account</c>, <c>cn_bank_account</c>, <c>co_bank_account</c>,
        ...
        /// <c>gb_bank_account</c>, <c>gm_bank_account</c>, <c>gr_bank_account</c>,
        /// <c>gt_bank_account</c>, <c>gy_bank_account</c>, <c>hk_bank_account</c>,
        /// <c>hr_bank_account</c>, <c>hu_bank_account</c>, <c>id_bank_account</c>,
        /// <c>ie_bank_account</c>, <c>il_bank_account</c>, <c>in_bank_account</c>,
        /// <c>is_bank_account</c>, <c>it_bank_account</c>, <c>jm_bank_account</c>,
        /// <c>jo_bank_account</c>, <c>jp_bank_account</c>, <c>ke_bank_account</c>,
        ...
        /// <c>mc_bank_account</c>, <c>md_bank_account</c>, <c>mg_bank_account</c>,
        /// <c>mk_bank_account</c>, <c>mn_bank_account</c>, <c>mo_bank_account</c>,
        /// <c>mt_bank_account</c>, <c>mu_bank_account</c>, <c>mx_bank_account</c>,
        /// <c>my_bank_account</c>, <c>mz_bank_account</c>, <c>na_bank_account</c>,
