...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientDefaultOutboundDestination : StripeEntity<AccountConfigurationRecipientDefaultOutboundDestination>, IHasId
    {
        ...
        /// <c>am_bank_account</c>, <c>ao_bank_account</c>, <c>ar_bank_account</c>,
        /// <c>at_bank_account</c>, <c>au_bank_account</c>, <c>az_bank_account</c>,
        /// <c>ba_bank_account</c>, <c>bd_bank_account</c>, <c>be_bank_account</c>,
        /// <c>bg_bank_account</c>, <c>bh_bank_account</c>, <c>bj_bank_account</c>,
        /// <c>bn_bank_account</c>, <c>bo_bank_account</c>, <c>br_bank_account</c>,
        ...
        /// <c>cl_bank_account</c>, <c>cn_bank_account</c>, <c>co_bank_account</c>,
        ...
        /// <c>ee_bank_account</c>, <c>eg_bank_account</c>, <c>es_bank_account</c>,
        /// <c>et_bank_account</c>, <c>fi_bank_account</c>, <c>fr_bank_account</c>,
        /// <c>ga_bank_account</c>, <c>gb_bank_account</c>, <c>gh_bank_account</c>,
        /// <c>gi_bank_account</c>, <c>gm_bank_account</c>, <c>gr_bank_account</c>,
        /// <c>gt_bank_account</c>, <c>gy_bank_account</c>, <c>hk_bank_account</c>,
        /// <c>hn_bank_account</c>, <c>hr_bank_account</c>, <c>hu_bank_account</c>,
        /// <c>id_bank_account</c>, <c>ie_bank_account</c>, <c>il_bank_account</c>,
        /// <c>in_bank_account</c>, <c>is_bank_account</c>, <c>it_bank_account</c>,
        /// <c>jm_bank_account</c>, <c>jo_bank_account</c>, <c>jp_bank_account</c>,
        /// <c>ke_bank_account</c>, <c>kh_bank_account</c>, <c>kr_bank_account</c>,
        /// <c>kw_bank_account</c>, <c>kz_bank_account</c>, <c>la_bank_account</c>,
        /// <c>lc_bank_account</c>, <c>li_bank_account</c>, <c>lk_bank_account</c>,
        /// <c>lt_bank_account</c>, <c>lu_bank_account</c>, <c>lv_bank_account</c>,
        /// <c>ma_bank_account</c>, <c>mc_bank_account</c>, <c>md_bank_account</c>,
