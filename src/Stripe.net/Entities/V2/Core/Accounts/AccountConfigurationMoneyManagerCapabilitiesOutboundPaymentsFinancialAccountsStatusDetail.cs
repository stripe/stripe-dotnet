...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsFinancialAccountsStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsFinancialAccountsStatusDetail>
    {
        /// <summary>
