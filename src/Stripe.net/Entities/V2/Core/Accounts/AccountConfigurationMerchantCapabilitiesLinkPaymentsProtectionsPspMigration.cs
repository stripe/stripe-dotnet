...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesLinkPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesLinkPaymentsProtectionsPspMigration>
    {
        /// <summary>
