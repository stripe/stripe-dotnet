...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsInstantStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsInstantStatusDetail>
    {
        /// <summary>
