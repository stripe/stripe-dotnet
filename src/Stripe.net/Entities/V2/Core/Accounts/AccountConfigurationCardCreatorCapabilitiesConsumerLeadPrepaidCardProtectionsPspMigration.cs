...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesConsumerLeadPrepaidCardProtectionsPspMigration : StripeEntity<AccountConfigurationCardCreatorCapabilitiesConsumerLeadPrepaidCardProtectionsPspMigration>
    {
        /// <summary>
