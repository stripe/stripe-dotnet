...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSwishPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesSwishPaymentsProtectionsPspMigration>
    {
        /// <summary>
