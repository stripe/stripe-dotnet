...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesKrCardPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesKrCardPaymentsStatusDetail>
    {
        /// <summary>
