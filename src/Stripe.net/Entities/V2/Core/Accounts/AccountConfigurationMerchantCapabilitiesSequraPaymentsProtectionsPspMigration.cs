...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSequraPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesSequraPaymentsProtectionsPspMigration>
    {
        /// <summary>
