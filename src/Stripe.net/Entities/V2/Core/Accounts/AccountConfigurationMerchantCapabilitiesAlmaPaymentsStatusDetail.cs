...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAlmaPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesAlmaPaymentsStatusDetail>
    {
        /// <summary>
