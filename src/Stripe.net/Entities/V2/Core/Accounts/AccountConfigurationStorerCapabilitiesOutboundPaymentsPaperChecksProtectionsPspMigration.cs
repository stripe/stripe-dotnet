...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksProtectionsPspMigration>
    {
        /// <summary>
