...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAfterpayClearpayPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesAfterpayClearpayPaymentsProtectionsPspMigration>
    {
        /// <summary>
