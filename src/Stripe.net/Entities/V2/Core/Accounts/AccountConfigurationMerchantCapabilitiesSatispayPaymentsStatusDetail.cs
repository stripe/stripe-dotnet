...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSatispayPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesSatispayPaymentsStatusDetail>
    {
        /// <summary>
