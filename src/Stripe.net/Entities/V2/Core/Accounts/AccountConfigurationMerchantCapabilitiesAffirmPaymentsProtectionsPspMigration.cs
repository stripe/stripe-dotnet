...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAffirmPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesAffirmPaymentsProtectionsPspMigration>
    {
        /// <summary>
