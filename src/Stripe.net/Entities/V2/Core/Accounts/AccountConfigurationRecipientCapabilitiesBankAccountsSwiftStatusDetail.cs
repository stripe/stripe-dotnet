...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsSwiftStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsSwiftStatusDetail>
    {
        /// <summary>
