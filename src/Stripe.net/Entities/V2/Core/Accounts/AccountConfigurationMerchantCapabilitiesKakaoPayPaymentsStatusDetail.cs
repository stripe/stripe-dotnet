...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesKakaoPayPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesKakaoPayPaymentsStatusDetail>
    {
        /// <summary>
