...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesMultibancoPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesMultibancoPaymentsStatusDetail>
    {
        /// <summary>
