...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksStatusDetail>
    {
        /// <summary>
