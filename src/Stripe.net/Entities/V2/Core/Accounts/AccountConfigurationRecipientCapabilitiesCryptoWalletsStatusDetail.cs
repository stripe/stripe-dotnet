...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesCryptoWalletsStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesCryptoWalletsStatusDetail>
    {
        /// <summary>
