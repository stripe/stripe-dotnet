...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdProtectionsPspMigration>
    {
        /// <summary>
