...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundTransfersBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundTransfersBankAccountsProtectionsPspMigration>
    {
        /// <summary>
