...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesP24PaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesP24PaymentsProtectionsPspMigration>
    {
        /// <summary>
