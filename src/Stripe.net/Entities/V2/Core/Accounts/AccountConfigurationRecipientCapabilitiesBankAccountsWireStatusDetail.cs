...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsWireStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsWireStatusDetail>
    {
        /// <summary>
