...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesZipPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesZipPaymentsProtectionsPspMigration>
    {
        /// <summary>
