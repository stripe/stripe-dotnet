...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutbound : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutbound>
    {
        ...
        public AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundOusd Ousd { get; set; }
        ...
        public AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundUsdc Usdc { get; set; }
    }
}
