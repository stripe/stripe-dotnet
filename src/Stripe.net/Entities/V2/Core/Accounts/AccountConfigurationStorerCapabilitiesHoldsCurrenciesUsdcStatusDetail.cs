...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesHoldsCurrenciesUsdcStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesHoldsCurrenciesUsdcStatusDetail>
    {
        /// <summary>
