...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAcssDebitPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesAcssDebitPaymentsStatusDetail>
    {
        /// <summary>
