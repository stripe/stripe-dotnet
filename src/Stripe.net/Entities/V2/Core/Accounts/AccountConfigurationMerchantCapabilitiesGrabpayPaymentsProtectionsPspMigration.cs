...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesGrabpayPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesGrabpayPaymentsProtectionsPspMigration>
    {
        /// <summary>
