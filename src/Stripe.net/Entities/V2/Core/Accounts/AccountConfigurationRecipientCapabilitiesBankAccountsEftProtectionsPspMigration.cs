...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsEftProtectionsPspMigration : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsEftProtectionsPspMigration>
    {
        /// <summary>
