...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesOxxoPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesOxxoPaymentsProtectionsPspMigration>
    {
        /// <summary>
