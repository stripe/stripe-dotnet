...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSamsungPayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesSamsungPayPaymentsStatusDetail>
    {
        /// <summary>
