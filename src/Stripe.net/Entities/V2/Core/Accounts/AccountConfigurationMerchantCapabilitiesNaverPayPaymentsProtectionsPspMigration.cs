...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesNaverPayPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesNaverPayPaymentsProtectionsPspMigration>
    {
        /// <summary>
