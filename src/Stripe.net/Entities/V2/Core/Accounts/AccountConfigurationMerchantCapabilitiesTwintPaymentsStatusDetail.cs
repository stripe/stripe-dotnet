...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesTwintPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesTwintPaymentsStatusDetail>
    {
        /// <summary>
