...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundAudProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundAudProtectionsPspMigration>
    {
        /// <summary>
