...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesReceivedDebitsBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesReceivedDebitsBankAccountsProtectionsPspMigration>
    {
        /// <summary>
