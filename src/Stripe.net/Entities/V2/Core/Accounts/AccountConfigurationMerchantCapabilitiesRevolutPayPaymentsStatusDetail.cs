...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesRevolutPayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesRevolutPayPaymentsStatusDetail>
    {
        /// <summary>
