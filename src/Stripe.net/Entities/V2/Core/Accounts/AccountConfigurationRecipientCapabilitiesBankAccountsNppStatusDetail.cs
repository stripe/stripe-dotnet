...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsNppStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsNppStatusDetail>
    {
        /// <summary>
