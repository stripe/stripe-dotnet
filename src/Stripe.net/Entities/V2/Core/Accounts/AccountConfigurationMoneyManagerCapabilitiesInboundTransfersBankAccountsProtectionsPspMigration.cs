...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesInboundTransfersBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesInboundTransfersBankAccountsProtectionsPspMigration>
    {
        /// <summary>
