...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesZipPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesZipPaymentsStatusDetail>
    {
        /// <summary>
