...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesIdealPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesIdealPaymentsStatusDetail>
    {
        /// <summary>
