...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesBlikPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesBlikPaymentsStatusDetail>
    {
        /// <summary>
