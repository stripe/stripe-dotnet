...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesOxxoPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesOxxoPaymentsStatusDetail>
    {
        /// <summary>
