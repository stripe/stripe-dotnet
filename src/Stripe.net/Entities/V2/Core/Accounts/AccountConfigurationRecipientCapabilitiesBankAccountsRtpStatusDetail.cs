...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsRtpStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsRtpStatusDetail>
    {
        /// <summary>
