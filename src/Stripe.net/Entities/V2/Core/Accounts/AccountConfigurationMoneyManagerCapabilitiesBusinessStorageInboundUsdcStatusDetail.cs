...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdcStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdcStatusDetail>
    {
        /// <summary>
