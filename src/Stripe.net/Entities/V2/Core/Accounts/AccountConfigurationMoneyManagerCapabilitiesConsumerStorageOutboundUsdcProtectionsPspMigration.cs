...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcProtectionsPspMigration>
    {
        /// <summary>
