...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAffirmPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesAffirmPaymentsStatusDetail>
    {
        /// <summary>
