...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsSwiftProtectionsPspMigration : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsSwiftProtectionsPspMigration>
    {
        /// <summary>
