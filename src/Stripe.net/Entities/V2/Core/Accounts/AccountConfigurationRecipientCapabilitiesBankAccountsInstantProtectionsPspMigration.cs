...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsInstantProtectionsPspMigration : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsInstantProtectionsPspMigration>
    {
        /// <summary>
