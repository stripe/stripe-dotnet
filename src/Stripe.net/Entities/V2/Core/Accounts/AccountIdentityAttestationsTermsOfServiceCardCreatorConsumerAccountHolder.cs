...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerAccountHolder : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerAccountHolder>
    {
        /// <summary>
