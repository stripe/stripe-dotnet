...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityIndividualDocumentsPrimaryVerificationFrontBack : StripeEntity<AccountIdentityIndividualDocumentsPrimaryVerificationFrontBack>
    {
        /// <summary>
