...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesPaycoPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesPaycoPaymentsStatusDetail>
    {
        /// <summary>
