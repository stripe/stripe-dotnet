...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsProtectionsPspMigration>
    {
        /// <summary>
