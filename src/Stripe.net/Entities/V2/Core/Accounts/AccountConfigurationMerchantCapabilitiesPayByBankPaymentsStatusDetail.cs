...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesPayByBankPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesPayByBankPaymentsStatusDetail>
    {
        /// <summary>
