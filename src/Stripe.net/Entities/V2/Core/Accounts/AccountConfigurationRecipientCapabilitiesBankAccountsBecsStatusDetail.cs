...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsBecsStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsBecsStatusDetail>
    {
        /// <summary>
