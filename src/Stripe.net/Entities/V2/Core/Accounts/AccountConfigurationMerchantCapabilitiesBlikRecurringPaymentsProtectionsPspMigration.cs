...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesBlikRecurringPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesBlikRecurringPaymentsProtectionsPspMigration>
    {
        /// <summary>
