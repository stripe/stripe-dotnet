...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesIdealPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesIdealPaymentsProtectionsPspMigration>
    {
        /// <summary>
