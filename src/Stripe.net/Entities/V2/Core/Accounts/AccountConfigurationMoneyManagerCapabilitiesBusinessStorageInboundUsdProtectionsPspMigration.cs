...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdProtectionsPspMigration>
    {
        /// <summary>
