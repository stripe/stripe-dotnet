...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCustomerCapabilitiesAutomaticIndirectTaxStatusDetail : StripeEntity<AccountConfigurationCustomerCapabilitiesAutomaticIndirectTaxStatusDetail>
    {
        /// <summary>
