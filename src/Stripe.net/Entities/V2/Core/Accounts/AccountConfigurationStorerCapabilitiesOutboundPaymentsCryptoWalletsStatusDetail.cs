...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundPaymentsCryptoWalletsStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundPaymentsCryptoWalletsStatusDetail>
    {
        /// <summary>
