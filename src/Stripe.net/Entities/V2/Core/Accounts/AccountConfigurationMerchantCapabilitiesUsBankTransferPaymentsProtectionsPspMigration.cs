...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsProtectionsPspMigration>
    {
        /// <summary>
