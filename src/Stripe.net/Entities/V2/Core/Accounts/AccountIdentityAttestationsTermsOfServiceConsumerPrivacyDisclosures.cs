...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceConsumerPrivacyDisclosures : StripeEntity<AccountIdentityAttestationsTermsOfServiceConsumerPrivacyDisclosures>
    {
        /// <summary>
