...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesOutboundPaymentsBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesOutboundPaymentsBankAccountsProtectionsPspMigration>
    {
        /// <summary>
