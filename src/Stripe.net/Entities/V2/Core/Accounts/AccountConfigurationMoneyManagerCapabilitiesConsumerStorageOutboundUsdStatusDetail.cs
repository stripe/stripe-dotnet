...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdStatusDetail>
    {
        /// <summary>
