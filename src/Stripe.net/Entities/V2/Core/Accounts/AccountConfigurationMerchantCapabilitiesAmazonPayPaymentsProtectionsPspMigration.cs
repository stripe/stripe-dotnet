...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAmazonPayPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesAmazonPayPaymentsProtectionsPspMigration>
    {
        /// <summary>
