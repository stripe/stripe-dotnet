...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesFpxPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesFpxPaymentsProtectionsPspMigration>
    {
        /// <summary>
