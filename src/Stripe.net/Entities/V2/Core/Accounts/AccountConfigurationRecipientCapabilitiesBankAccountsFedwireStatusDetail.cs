...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsFedwireStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsFedwireStatusDetail>
    {
        /// <summary>
