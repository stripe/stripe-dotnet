...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesJpBankTransferPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesJpBankTransferPaymentsProtectionsPspMigration>
    {
        /// <summary>
