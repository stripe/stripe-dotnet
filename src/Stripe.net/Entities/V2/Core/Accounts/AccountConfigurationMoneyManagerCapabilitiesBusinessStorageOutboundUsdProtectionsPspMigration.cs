...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundUsdProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundUsdProtectionsPspMigration>
    {
        /// <summary>
