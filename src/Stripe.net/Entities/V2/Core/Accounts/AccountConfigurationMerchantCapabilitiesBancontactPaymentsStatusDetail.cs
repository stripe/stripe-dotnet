...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesBancontactPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesBancontactPaymentsStatusDetail>
    {
        /// <summary>
