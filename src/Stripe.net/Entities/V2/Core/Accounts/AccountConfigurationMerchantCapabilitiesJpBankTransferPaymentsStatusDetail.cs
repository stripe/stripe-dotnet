...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesJpBankTransferPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesJpBankTransferPaymentsStatusDetail>
    {
        /// <summary>
