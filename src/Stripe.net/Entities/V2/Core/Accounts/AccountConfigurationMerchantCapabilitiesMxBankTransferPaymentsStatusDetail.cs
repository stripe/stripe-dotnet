...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesMxBankTransferPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesMxBankTransferPaymentsStatusDetail>
    {
        /// <summary>
