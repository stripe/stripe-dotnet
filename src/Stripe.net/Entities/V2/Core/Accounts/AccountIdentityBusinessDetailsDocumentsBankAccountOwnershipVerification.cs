...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsBankAccountOwnershipVerification : StripeEntity<AccountIdentityBusinessDetailsDocumentsBankAccountOwnershipVerification>
    {
        /// <summary>
