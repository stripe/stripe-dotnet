...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcProtectionsPspMigration>
    {
        /// <summary>
