...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsPrimaryVerification : StripeEntity<AccountIdentityBusinessDetailsDocumentsPrimaryVerification>
    {
        /// <summary>
...
#endif
        public AccountIdentityBusinessDetailsDocumentsPrimaryVerificationFrontBack FrontBack { get; set; }
