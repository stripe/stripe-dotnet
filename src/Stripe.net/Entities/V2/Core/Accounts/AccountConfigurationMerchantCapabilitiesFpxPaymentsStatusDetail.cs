...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesFpxPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesFpxPaymentsStatusDetail>
    {
        /// <summary>
