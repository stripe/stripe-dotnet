...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcStatusDetail>
    {
        /// <summary>
