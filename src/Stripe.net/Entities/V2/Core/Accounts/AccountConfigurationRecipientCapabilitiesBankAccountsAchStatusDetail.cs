...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsAchStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsAchStatusDetail>
    {
        /// <summary>
