...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesCryptoWalletsProtectionsPspMigration : StripeEntity<AccountConfigurationRecipientCapabilitiesCryptoWalletsProtectionsPspMigration>
    {
        /// <summary>
