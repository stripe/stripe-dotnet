...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesCardPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesCardPaymentsStatusDetail>
    {
        /// <summary>
