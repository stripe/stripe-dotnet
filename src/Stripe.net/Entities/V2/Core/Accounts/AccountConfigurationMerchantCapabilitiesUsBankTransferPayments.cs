...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesUsBankTransferPayments : StripeEntity<AccountConfigurationMerchantCapabilitiesUsBankTransferPayments>
    {
        ...
        public AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsProtections Protections { get; set; }
        ...
        public List<AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsStatusDetail> StatusDetails { get; set; }
    }
}
