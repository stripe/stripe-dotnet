...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesGrabpayPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesGrabpayPaymentsStatusDetail>
    {
        /// <summary>
