...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAchDebitPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesAchDebitPaymentsStatusDetail>
    {
        /// <summary>
