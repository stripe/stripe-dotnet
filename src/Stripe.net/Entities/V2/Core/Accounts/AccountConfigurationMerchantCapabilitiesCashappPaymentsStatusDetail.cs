...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesCashappPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesCashappPaymentsStatusDetail>
    {
        /// <summary>
