...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesReceivedDebitsBankAccountsStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesReceivedDebitsBankAccountsStatusDetail>
    {
        /// <summary>
