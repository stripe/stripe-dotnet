...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesEpsPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesEpsPaymentsProtectionsPspMigration>
    {
        /// <summary>
