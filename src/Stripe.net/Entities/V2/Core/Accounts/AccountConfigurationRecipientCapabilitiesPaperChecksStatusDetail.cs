...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesPaperChecksStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesPaperChecksStatusDetail>
    {
        /// <summary>
