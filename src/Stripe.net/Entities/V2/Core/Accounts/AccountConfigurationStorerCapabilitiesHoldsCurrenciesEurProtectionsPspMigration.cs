...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesHoldsCurrenciesEurProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesHoldsCurrenciesEurProtectionsPspMigration>
    {
        /// <summary>
