...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInbound : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInbound>
    {
        ...
        public AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundOusd Ousd { get; set; }
        ...
        public AccountConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdc Usdc { get; set; }
    }
}
