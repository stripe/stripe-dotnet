...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesLinkPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesLinkPaymentsStatusDetail>
    {
        /// <summary>
