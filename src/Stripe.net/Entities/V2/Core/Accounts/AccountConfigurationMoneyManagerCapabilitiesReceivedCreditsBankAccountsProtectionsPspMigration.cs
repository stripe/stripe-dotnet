...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsProtectionsPspMigration>
    {
        /// <summary>
