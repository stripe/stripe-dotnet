...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAcssDebitPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesAcssDebitPaymentsProtectionsPspMigration>
    {
        /// <summary>
