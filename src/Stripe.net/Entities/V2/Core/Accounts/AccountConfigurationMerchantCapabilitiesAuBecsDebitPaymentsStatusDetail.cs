...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAuBecsDebitPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesAuBecsDebitPaymentsStatusDetail>
    {
        /// <summary>
