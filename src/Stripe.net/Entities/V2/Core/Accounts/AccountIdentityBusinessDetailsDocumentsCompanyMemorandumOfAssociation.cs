...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsCompanyMemorandumOfAssociation : StripeEntity<AccountIdentityBusinessDetailsDocumentsCompanyMemorandumOfAssociation>
    {
        /// <summary>
