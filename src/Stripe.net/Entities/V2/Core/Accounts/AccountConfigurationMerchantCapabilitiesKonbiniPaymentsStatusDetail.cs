...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesKonbiniPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesKonbiniPaymentsStatusDetail>
    {
        /// <summary>
