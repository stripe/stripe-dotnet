...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerLeadPrepaidCardBankTerms : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerLeadPrepaidCardBankTerms>
    {
        /// <summary>
