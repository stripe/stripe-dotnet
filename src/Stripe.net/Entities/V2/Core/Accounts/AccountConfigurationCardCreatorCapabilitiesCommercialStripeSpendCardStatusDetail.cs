...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialStripeSpendCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialStripeSpendCardStatusDetail>
    {
        /// <summary>
