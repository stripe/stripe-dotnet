...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesJcbPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesJcbPaymentsStatusDetail>
    {
        /// <summary>
