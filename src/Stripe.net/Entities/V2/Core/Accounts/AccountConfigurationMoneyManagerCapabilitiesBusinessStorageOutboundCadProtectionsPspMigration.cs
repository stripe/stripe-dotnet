...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundCadProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundCadProtectionsPspMigration>
    {
        /// <summary>
