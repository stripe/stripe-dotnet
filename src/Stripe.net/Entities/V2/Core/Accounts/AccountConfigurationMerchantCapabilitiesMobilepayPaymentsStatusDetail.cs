...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesMobilepayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesMobilepayPaymentsStatusDetail>
    {
        /// <summary>
