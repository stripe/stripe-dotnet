...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesBlikRecurringPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesBlikRecurringPaymentsStatusDetail>
    {
        /// <summary>
