...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesConsumerCelticRevolvingCreditCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesConsumerCelticRevolvingCreditCardStatusDetail>
    {
        /// <summary>
