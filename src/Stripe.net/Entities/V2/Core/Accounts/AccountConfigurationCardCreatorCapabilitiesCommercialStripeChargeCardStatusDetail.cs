...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialStripeChargeCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialStripeChargeCardStatusDetail>
    {
        /// <summary>
