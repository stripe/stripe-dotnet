...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsCompanyRegistrationVerification : StripeEntity<AccountIdentityBusinessDetailsDocumentsCompanyRegistrationVerification>
    {
        /// <summary>
