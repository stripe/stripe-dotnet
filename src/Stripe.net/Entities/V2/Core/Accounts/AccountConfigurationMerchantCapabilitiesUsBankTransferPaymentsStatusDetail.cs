...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesUsBankTransferPaymentsStatusDetail>
    {
        /// <summary>
