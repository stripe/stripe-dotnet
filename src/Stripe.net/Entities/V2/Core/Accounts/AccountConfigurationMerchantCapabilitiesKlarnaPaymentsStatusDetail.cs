...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesKlarnaPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesKlarnaPaymentsStatusDetail>
    {
        /// <summary>
