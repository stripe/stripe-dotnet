...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersCryptoWalletsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundTransfersCryptoWalletsProtectionsPspMigration>
    {
        /// <summary>
