...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundOusdStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundOusdStatusDetail>
    {
        /// <summary>
