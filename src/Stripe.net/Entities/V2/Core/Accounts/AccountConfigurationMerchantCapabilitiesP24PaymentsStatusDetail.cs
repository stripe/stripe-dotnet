...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesP24PaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesP24PaymentsStatusDetail>
    {
        /// <summary>
