...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesPaynowPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesPaynowPaymentsStatusDetail>
    {
        /// <summary>
