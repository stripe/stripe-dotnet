...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesPaperChecksProtectionsPspMigration : StripeEntity<AccountConfigurationRecipientCapabilitiesPaperChecksProtectionsPspMigration>
    {
        /// <summary>
