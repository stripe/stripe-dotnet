...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardStatusDetail>
    {
        /// <summary>
