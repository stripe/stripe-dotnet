...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesFinancialAddressesBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationStorerCapabilitiesFinancialAddressesBankAccountsProtectionsPspMigration>
    {
        /// <summary>
