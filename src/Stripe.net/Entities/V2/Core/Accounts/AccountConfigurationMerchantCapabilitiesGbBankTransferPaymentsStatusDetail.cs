...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesGbBankTransferPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesGbBankTransferPaymentsStatusDetail>
    {
        /// <summary>
