...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsPrimaryVerificationFrontBack : StripeEntity<AccountIdentityBusinessDetailsDocumentsPrimaryVerificationFrontBack>
    {
        /// <summary>
