...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesAmazonPayPaymentsStatusDetail
        : StripeEntity<AccountConfigurationMerchantCapabilitiesAmazonPayPaymentsStatusDetail>
    {
        /// <summary>
