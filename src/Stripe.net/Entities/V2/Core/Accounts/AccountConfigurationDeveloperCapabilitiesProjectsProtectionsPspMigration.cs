...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationDeveloperCapabilitiesProjectsProtectionsPspMigration : StripeEntity<AccountConfigurationDeveloperCapabilitiesProjectsProtectionsPspMigration>
    {
        /// <summary>
