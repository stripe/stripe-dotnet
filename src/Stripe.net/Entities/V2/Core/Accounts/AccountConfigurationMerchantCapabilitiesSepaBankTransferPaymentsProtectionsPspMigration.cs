...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSepaBankTransferPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesSepaBankTransferPaymentsProtectionsPspMigration>
    {
        /// <summary>
