...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardStatusDetail>
    {
        /// <summary>
