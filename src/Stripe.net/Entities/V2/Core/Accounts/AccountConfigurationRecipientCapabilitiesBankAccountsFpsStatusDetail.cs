...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationRecipientCapabilitiesBankAccountsFpsStatusDetail : StripeEntity<AccountConfigurationRecipientCapabilitiesBankAccountsFpsStatusDetail>
    {
        /// <summary>
