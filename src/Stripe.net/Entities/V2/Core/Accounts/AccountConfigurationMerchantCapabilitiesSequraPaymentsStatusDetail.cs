...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesSequraPaymentsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesSequraPaymentsStatusDetail>
    {
        /// <summary>
