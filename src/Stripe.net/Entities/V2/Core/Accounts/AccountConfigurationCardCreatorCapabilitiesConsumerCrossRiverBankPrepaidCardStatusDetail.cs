...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardStatusDetail : StripeEntity<AccountConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardStatusDetail>
    {
        /// <summary>
