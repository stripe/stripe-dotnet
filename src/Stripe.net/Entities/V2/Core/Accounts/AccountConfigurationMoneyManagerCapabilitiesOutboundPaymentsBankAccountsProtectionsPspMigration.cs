...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsBankAccountsProtectionsPspMigration : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsBankAccountsProtectionsPspMigration>
    {
        /// <summary>
