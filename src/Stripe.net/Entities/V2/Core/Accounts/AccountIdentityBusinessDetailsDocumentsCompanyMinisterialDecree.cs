...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsCompanyMinisterialDecree : StripeEntity<AccountIdentityBusinessDetailsDocumentsCompanyMinisterialDecree>
    {
        /// <summary>
