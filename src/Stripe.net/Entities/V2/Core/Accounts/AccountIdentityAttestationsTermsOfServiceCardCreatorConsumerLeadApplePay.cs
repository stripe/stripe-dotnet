...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerLeadApplePay : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorConsumerLeadApplePay>
    {
        /// <summary>
