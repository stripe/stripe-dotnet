...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityAttestationsTermsOfServiceCardCreatorCommercialFifthThirdPlatform : StripeEntity<AccountIdentityAttestationsTermsOfServiceCardCreatorCommercialFifthThirdPlatform>
    {
        /// <summary>
