...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsStatusDetail : StripeEntity<AccountConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsStatusDetail>
    {
        /// <summary>
