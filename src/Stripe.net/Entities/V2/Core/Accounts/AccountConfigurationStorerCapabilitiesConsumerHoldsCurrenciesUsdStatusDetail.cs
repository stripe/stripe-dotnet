...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdStatusDetail : StripeEntity<AccountConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdStatusDetail>
    {
        /// <summary>
