...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesJcbPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesJcbPaymentsProtectionsPspMigration>
    {
        /// <summary>
