...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialLeadPrepaidCardProtectionsPspMigration : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialLeadPrepaidCardProtectionsPspMigration>
    {
        /// <summary>
