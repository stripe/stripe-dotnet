...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationCardCreatorCapabilitiesCommercialFifthThirdChargeCardProtectionsPspMigration : StripeEntity<AccountConfigurationCardCreatorCapabilitiesCommercialFifthThirdChargeCardProtectionsPspMigration>
    {
        /// <summary>
