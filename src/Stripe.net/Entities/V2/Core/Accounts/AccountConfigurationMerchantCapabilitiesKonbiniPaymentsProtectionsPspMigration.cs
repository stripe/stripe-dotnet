...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesKonbiniPaymentsProtectionsPspMigration : StripeEntity<AccountConfigurationMerchantCapabilitiesKonbiniPaymentsProtectionsPspMigration>
    {
        /// <summary>
