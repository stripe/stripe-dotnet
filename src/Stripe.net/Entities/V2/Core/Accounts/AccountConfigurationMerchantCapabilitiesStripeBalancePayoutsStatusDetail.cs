...
namespace Stripe.V2.Core
{
    ...
    public class AccountConfigurationMerchantCapabilitiesStripeBalancePayoutsStatusDetail : StripeEntity<AccountConfigurationMerchantCapabilitiesStripeBalancePayoutsStatusDetail>
    {
        /// <summary>
