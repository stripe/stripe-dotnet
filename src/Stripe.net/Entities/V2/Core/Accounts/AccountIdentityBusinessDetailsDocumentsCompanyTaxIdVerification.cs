...
namespace Stripe.V2.Core
{
    ...
    public class AccountIdentityBusinessDetailsDocumentsCompanyTaxIdVerification : StripeEntity<AccountIdentityBusinessDetailsDocumentsCompanyTaxIdVerification>
    {
        /// <summary>
