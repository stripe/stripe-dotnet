...
namespace Stripe.V2.Core
{
    ...
    public class BatchJobStatusDetailsValidationFailed : StripeEntity<BatchJobStatusDetailsValidationFailed>
    {
        /// <summary>
        ...
        public BatchJobStatusDetailsValidationFailedOutputFile OutputFile { get; set; }
