...
namespace Stripe.V2.Core
{
    ...
    public class BatchJobStatusDetailsComplete : StripeEntity<BatchJobStatusDetailsComplete>
    {
        /// <summary>
        ...
        public BatchJobStatusDetailsCompleteOutputFile OutputFile { get; set; }
