...
namespace Stripe.V2.Core
{
    ...
    {
        /// <summary>
        /// Additional details for the <c>BATCH_FAILED</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>CANCELED</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>COMPLETE</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>IN_PROGRESS</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>READY_FOR_UPLOAD</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>TIMEOUT</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>VALIDATING</c> status of the <c>batch_job</c>.
        /// </summary>
        ...
        /// <summary>
        /// Additional details for the <c>VALIDATION_FAILED</c> status of the <c>batch_job</c>.
        /// </summary>
