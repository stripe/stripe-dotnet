...
#nullable enable
        ...
        {
            throw new NotSupportedException("FetchEvent is not supported in custom object SDKs.");
        
        }

        protected Task<T> FetchEventAsync<T>(CancellationToken cancellationToken = default)
        where T : V2.Core.Event
        {
            return Task.FromException<T>(new NotSupportedException("FetchEventAsync is not supported in custom object SDKs."));
