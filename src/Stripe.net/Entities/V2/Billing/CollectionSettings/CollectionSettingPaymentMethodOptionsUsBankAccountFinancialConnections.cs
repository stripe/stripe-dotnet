...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingPaymentMethodOptionsUsBankAccountFinancialConnections : StripeEntity<CollectionSettingPaymentMethodOptionsUsBankAccountFinancialConnections>
    {
        /// <summary>
...
#endif
        public CollectionSettingPaymentMethodOptionsUsBankAccountFinancialConnectionsFilters Filters { get; set; }
