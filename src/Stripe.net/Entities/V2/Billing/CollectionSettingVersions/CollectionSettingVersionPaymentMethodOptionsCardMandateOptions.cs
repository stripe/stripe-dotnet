...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingVersionPaymentMethodOptionsCardMandateOptions : StripeEntity<CollectionSettingVersionPaymentMethodOptionsCardMandateOptions>
    {
        /// <summary>
