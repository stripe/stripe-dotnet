...
namespace Stripe.V2.Billing
{
    ...
    public class IntentActionModifyPricingPlanSubscriptionDetailsOverridesPartialPeriodBehaviorRecurringCreditGrant : StripeEntity<IntentActionModifyPricingPlanSubscriptionDetailsOverridesPartialPeriodBehaviorRecurringCreditGrant>
    {
        /// <summary>
