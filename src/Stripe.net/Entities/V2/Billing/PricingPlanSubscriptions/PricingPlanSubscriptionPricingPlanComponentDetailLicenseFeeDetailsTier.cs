...
namespace Stripe.V2.Billing
{
    ...
    public class PricingPlanSubscriptionPricingPlanComponentDetailLicenseFeeDetailsTier : StripeEntity<PricingPlanSubscriptionPricingPlanComponentDetailLicenseFeeDetailsTier>
    {
        /// <summary>
