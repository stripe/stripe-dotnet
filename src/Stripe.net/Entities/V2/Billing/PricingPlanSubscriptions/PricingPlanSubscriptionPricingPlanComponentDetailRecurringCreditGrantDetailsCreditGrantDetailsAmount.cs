...
namespace Stripe.V2.Billing
{
    ...
    public class PricingPlanSubscriptionPricingPlanComponentDetailRecurringCreditGrantDetailsCreditGrantDetailsAmount : StripeEntity<PricingPlanSubscriptionPricingPlanComponentDetailRecurringCreditGrantDetailsCreditGrantDetailsAmount>
    {
        /// <summary>
        ...
        public PricingPlanSubscriptionPricingPlanComponentDetailRecurringCreditGrantDetailsCreditGrantDetailsAmountCustomPricingUnit CustomPricingUnit { get; set; }
