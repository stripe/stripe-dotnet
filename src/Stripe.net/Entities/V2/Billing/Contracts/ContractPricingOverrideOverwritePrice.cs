...
namespace Stripe.V2.Billing
{
    ...
    public class ContractPricingOverrideOverwritePrice : StripeEntity<ContractPricingOverrideOverwritePrice>
    {
        /// <summary>
        ...
        public List<ContractPricingOverrideOverwritePriceTier> Tiers { get; set; }
