...
namespace Stripe.V2.Billing
{
    ...
    public class ContractContractLineDetailOverrideServiceActionReplaceCreditGrantAmount : StripeEntity<ContractContractLineDetailOverrideServiceActionReplaceCreditGrantAmount>
    {
        /// <summary>
