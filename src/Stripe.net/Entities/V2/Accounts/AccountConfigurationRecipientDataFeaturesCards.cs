...
namespace Stripe.V2
{
    ...
    public class AccountConfigurationRecipientDataFeaturesCards : StripeEntity<AccountConfigurationRecipientDataFeaturesCards>
    {
        /// <summary>
...
#endif
        public List<AccountConfigurationRecipientDataFeaturesCardsStatusDetail> StatusDetails { get; set; }
    }
}
