...
namespace Stripe.V2
{
    ...
    public class AccountLegalEntityDataRepresentative : StripeEntity<AccountLegalEntityDataRepresentative>
    {
        /// <summary>
...
#endif
        public AccountLegalEntityDataRepresentativeAddress Address { get; set; }
...
#endif
        public AccountLegalEntityDataRepresentativeDob Dob { get; set; }
