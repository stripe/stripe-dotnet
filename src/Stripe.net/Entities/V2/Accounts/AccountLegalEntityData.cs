...
namespace Stripe.V2
{
    ...
    public class AccountLegalEntityData : StripeEntity<AccountLegalEntityData>
    {
        /// <summary>
...
#endif
        public AccountLegalEntityDataAddress Address { get; set; }
...
#endif
        public AccountLegalEntityDataRepresentative Representative { get; set; }
    }
}
