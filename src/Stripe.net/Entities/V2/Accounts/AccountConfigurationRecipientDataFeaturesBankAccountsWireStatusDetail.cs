...
namespace Stripe.V2
{
    ...
    public class AccountConfigurationRecipientDataFeaturesBankAccountsWireStatusDetail : StripeEntity<AccountConfigurationRecipientDataFeaturesBankAccountsWireStatusDetail>
    {
        /// <summary>
