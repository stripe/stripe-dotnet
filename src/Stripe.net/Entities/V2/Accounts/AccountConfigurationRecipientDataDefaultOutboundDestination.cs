...
namespace Stripe.V2
{
    ...
    public class AccountConfigurationRecipientDataDefaultOutboundDestination : StripeEntity<AccountConfigurationRecipientDataDefaultOutboundDestination>, IHasId
    {
        /// <summary>
