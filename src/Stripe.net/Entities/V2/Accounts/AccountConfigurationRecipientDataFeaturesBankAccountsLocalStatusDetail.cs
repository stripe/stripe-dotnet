...
namespace Stripe.V2
{
    ...
    public class AccountConfigurationRecipientDataFeaturesBankAccountsLocalStatusDetail : StripeEntity<AccountConfigurationRecipientDataFeaturesBankAccountsLocalStatusDetail>
    {
        /// <summary>
