...
namespace Stripe.V2
{
    ...
    public class AccountConfigurationRecipientDataFeaturesBankAccountsLocal : StripeEntity<AccountConfigurationRecipientDataFeaturesBankAccountsLocal>
    {
        /// <summary>
...
#endif
        public List<AccountConfigurationRecipientDataFeaturesBankAccountsLocalStatusDetail> StatusDetails { get; set; }
    }
}
