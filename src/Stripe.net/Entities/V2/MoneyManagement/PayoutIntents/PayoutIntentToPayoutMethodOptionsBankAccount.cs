...
namespace Stripe.V2.MoneyManagement
{
    ...
    public class PayoutIntentToPayoutMethodOptionsBankAccount : StripeEntity<PayoutIntentToPayoutMethodOptionsBankAccount>
    {
        /// <summary>
        ...
        public PayoutIntentToPayoutMethodOptionsBankAccountPreferredNetworkOptions PreferredNetworkOptions { get; set; }
