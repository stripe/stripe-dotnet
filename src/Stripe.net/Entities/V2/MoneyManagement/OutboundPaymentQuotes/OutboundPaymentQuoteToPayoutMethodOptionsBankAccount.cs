...
namespace Stripe.V2.MoneyManagement
{
    ...
    public class OutboundPaymentQuoteToPayoutMethodOptionsBankAccount : StripeEntity<OutboundPaymentQuoteToPayoutMethodOptionsBankAccount>
    {
        /// <summary>
        ...
        public OutboundPaymentQuoteToPayoutMethodOptionsBankAccountPreferredNetworkOptions PreferredNetworkOptions { get; set; }
