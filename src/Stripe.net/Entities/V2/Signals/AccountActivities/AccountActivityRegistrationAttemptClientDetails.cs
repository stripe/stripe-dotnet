...
namespace Stripe.V2.Signals
{
    ...
    public class AccountActivityRegistrationAttemptClientDetails : StripeEntity<AccountActivityRegistrationAttemptClientDetails>
    {
        /// <summary>
        ...
        public AccountActivityRegistrationAttemptClientDetailsData Data { get; set; }
