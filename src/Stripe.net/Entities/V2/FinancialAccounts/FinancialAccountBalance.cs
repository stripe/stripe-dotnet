...
#endif
        public Dictionary<string, Amount> Available { get; set; }
...
#endif
        public Dictionary<string, Amount> InboundPending { get; set; }
...
#endif
        public Dictionary<string, Amount> OutboundPending { get; set; }
    }
}
