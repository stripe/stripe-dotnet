...
namespace Stripe
{
    ...
    public class OrderPaymentSettingsPaymentMethodOptionsAcssDebit : StripeEntity<OrderPaymentSettingsPaymentMethodOptionsAcssDebit>
    {
        [JsonProperty("mandate_options")]
#if NET6_0_OR_GREATER
        [STJS.JsonPropertyName("mandate_options")]
#endif
        public OrderPaymentSettingsPaymentMethodOptionsAcssDebitMandateOptions MandateOptions { get; set; }
