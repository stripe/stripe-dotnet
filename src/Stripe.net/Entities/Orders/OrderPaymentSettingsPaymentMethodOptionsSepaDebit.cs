...
namespace Stripe
{
    ...
    public class OrderPaymentSettingsPaymentMethodOptionsSepaDebit : StripeEntity<OrderPaymentSettingsPaymentMethodOptionsSepaDebit>
    {
        [JsonProperty("mandate_options")]
#if NET6_0_OR_GREATER
        [STJS.JsonPropertyName("mandate_options")]
#endif
        public OrderPaymentSettingsPaymentMethodOptionsSepaDebitMandateOptions MandateOptions { get; set; }
