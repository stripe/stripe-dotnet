...
namespace Stripe
{
    ...
    public class OrderPaymentSettingsPaymentMethodOptionsCustomerBalance : StripeEntity<OrderPaymentSettingsPaymentMethodOptionsCustomerBalance>
    {
        [JsonProperty("bank_transfer")]
        public OrderPaymentSettingsPaymentMethodOptionsCustomerBalanceBankTransfer BankTransfer { get; set; }
