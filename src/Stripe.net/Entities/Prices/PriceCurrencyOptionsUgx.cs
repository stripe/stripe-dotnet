...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUgx : StripeEntity<PriceCurrencyOptionsUgx>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUgxCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUgxTier> Tiers { get; set; }
