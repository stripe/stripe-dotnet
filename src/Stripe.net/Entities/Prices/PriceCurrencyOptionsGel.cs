...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGel : StripeEntity<PriceCurrencyOptionsGel>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGelCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGelTier> Tiers { get; set; }
