...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTnd : StripeEntity<PriceCurrencyOptionsTnd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTndCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTndTier> Tiers { get; set; }
