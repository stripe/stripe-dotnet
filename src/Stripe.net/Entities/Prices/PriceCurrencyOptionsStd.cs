...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsStd : StripeEntity<PriceCurrencyOptionsStd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsStdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsStdTier> Tiers { get; set; }
