...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTop : StripeEntity<PriceCurrencyOptionsTop>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTopCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTopTier> Tiers { get; set; }
