...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNio : StripeEntity<PriceCurrencyOptionsNio>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNioCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNioTier> Tiers { get; set; }
