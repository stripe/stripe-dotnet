...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUsd : StripeEntity<PriceCurrencyOptionsUsd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUsdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUsdTier> Tiers { get; set; }
