...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHkd : StripeEntity<PriceCurrencyOptionsHkd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHkdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHkdTier> Tiers { get; set; }
