...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGip : StripeEntity<PriceCurrencyOptionsGip>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGipCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGipTier> Tiers { get; set; }
