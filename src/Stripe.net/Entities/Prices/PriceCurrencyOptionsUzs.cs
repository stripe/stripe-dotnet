...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUzs : StripeEntity<PriceCurrencyOptionsUzs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUzsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUzsTier> Tiers { get; set; }
