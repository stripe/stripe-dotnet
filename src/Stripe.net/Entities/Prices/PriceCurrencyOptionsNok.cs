...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNok : StripeEntity<PriceCurrencyOptionsNok>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNokCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNokTier> Tiers { get; set; }
