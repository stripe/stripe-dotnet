...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsQar : StripeEntity<PriceCurrencyOptionsQar>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsQarCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsQarTier> Tiers { get; set; }
