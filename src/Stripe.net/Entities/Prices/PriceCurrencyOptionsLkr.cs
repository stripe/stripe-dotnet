...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLkr : StripeEntity<PriceCurrencyOptionsLkr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLkrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLkrTier> Tiers { get; set; }
