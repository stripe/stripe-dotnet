...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPln : StripeEntity<PriceCurrencyOptionsPln>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPlnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPlnTier> Tiers { get; set; }
