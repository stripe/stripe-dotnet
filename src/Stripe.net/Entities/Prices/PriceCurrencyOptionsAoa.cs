...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAoa : StripeEntity<PriceCurrencyOptionsAoa>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAoaCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAoaTier> Tiers { get; set; }
