...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsFkp : StripeEntity<PriceCurrencyOptionsFkp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsFkpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsFkpTier> Tiers { get; set; }
