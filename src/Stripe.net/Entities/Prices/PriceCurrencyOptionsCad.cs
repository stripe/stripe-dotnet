...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCad : StripeEntity<PriceCurrencyOptionsCad>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCadCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCadTier> Tiers { get; set; }
