...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMdl : StripeEntity<PriceCurrencyOptionsMdl>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMdlCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMdlTier> Tiers { get; set; }
