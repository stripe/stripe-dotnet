...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKwd : StripeEntity<PriceCurrencyOptionsKwd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKwdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKwdTier> Tiers { get; set; }
