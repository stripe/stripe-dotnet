...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGhs : StripeEntity<PriceCurrencyOptionsGhs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGhsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGhsTier> Tiers { get; set; }
