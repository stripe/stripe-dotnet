...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMop : StripeEntity<PriceCurrencyOptionsMop>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMopCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMopTier> Tiers { get; set; }
