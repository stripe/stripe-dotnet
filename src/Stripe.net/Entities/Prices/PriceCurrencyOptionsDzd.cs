...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDzd : StripeEntity<PriceCurrencyOptionsDzd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDzdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDzdTier> Tiers { get; set; }
