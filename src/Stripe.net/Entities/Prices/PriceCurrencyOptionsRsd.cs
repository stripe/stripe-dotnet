...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRsd : StripeEntity<PriceCurrencyOptionsRsd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRsdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRsdTier> Tiers { get; set; }
