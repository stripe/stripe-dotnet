...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHrk : StripeEntity<PriceCurrencyOptionsHrk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHrkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHrkTier> Tiers { get; set; }
