...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLsl : StripeEntity<PriceCurrencyOptionsLsl>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLslCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLslTier> Tiers { get; set; }
