...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXcd : StripeEntity<PriceCurrencyOptionsXcd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXcdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXcdTier> Tiers { get; set; }
