...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHuf : StripeEntity<PriceCurrencyOptionsHuf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHufCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHufTier> Tiers { get; set; }
