...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCop : StripeEntity<PriceCurrencyOptionsCop>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCopCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCopTier> Tiers { get; set; }
