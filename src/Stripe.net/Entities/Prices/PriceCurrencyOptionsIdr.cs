...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIdr : StripeEntity<PriceCurrencyOptionsIdr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIdrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIdrTier> Tiers { get; set; }
