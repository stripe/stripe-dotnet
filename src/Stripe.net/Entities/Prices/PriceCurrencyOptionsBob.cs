...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBob : StripeEntity<PriceCurrencyOptionsBob>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBobCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBobTier> Tiers { get; set; }
