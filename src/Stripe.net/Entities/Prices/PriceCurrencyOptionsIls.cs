...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIls : StripeEntity<PriceCurrencyOptionsIls>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIlsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIlsTier> Tiers { get; set; }
