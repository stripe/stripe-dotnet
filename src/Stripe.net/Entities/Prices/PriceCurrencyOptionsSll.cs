...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSll : StripeEntity<PriceCurrencyOptionsSll>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSllCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSllTier> Tiers { get; set; }
