...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBmd : StripeEntity<PriceCurrencyOptionsBmd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBmdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBmdTier> Tiers { get; set; }
