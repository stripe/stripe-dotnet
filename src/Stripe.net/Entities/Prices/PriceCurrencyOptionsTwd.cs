...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTwd : StripeEntity<PriceCurrencyOptionsTwd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTwdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTwdTier> Tiers { get; set; }
