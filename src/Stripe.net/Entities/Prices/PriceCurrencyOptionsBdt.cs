...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBdt : StripeEntity<PriceCurrencyOptionsBdt>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBdtCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBdtTier> Tiers { get; set; }
