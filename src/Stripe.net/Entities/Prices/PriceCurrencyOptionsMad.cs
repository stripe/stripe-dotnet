...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMad : StripeEntity<PriceCurrencyOptionsMad>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMadCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMadTier> Tiers { get; set; }
