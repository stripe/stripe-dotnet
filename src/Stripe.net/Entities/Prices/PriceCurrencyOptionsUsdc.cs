...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUsdc : StripeEntity<PriceCurrencyOptionsUsdc>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUsdcCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUsdcTier> Tiers { get; set; }
