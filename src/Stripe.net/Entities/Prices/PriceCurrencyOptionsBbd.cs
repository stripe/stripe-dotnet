...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBbd : StripeEntity<PriceCurrencyOptionsBbd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBbdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBbdTier> Tiers { get; set; }
