...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMzn : StripeEntity<PriceCurrencyOptionsMzn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMznCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMznTier> Tiers { get; set; }
