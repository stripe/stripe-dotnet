...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKmf : StripeEntity<PriceCurrencyOptionsKmf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKmfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKmfTier> Tiers { get; set; }
