...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHnl : StripeEntity<PriceCurrencyOptionsHnl>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHnlCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHnlTier> Tiers { get; set; }
