...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsOmr : StripeEntity<PriceCurrencyOptionsOmr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsOmrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsOmrTier> Tiers { get; set; }
