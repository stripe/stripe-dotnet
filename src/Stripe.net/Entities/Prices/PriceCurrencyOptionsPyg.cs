...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPyg : StripeEntity<PriceCurrencyOptionsPyg>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPygCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPygTier> Tiers { get; set; }
