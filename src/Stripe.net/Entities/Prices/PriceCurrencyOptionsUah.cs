...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUah : StripeEntity<PriceCurrencyOptionsUah>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUahCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUahTier> Tiers { get; set; }
