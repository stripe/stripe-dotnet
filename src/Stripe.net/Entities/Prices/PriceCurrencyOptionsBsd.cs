...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBsd : StripeEntity<PriceCurrencyOptionsBsd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBsdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBsdTier> Tiers { get; set; }
