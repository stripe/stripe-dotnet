...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNpr : StripeEntity<PriceCurrencyOptionsNpr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNprCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNprTier> Tiers { get; set; }
