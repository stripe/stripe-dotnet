...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMga : StripeEntity<PriceCurrencyOptionsMga>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMgaCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMgaTier> Tiers { get; set; }
