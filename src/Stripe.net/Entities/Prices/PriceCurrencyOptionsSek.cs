...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSek : StripeEntity<PriceCurrencyOptionsSek>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSekCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSekTier> Tiers { get; set; }
