...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsThb : StripeEntity<PriceCurrencyOptionsThb>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsThbCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsThbTier> Tiers { get; set; }
