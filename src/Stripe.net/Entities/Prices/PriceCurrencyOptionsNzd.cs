...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNzd : StripeEntity<PriceCurrencyOptionsNzd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNzdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNzdTier> Tiers { get; set; }
