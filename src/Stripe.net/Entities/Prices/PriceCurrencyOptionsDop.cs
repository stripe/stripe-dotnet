...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDop : StripeEntity<PriceCurrencyOptionsDop>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDopCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDopTier> Tiers { get; set; }
