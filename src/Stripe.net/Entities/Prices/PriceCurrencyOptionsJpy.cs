...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJpy : StripeEntity<PriceCurrencyOptionsJpy>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJpyCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJpyTier> Tiers { get; set; }
