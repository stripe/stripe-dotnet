...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTry : StripeEntity<PriceCurrencyOptionsTry>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTryCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTryTier> Tiers { get; set; }
