...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTzs : StripeEntity<PriceCurrencyOptionsTzs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTzsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTzsTier> Tiers { get; set; }
