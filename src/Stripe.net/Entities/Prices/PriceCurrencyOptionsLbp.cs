...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLbp : StripeEntity<PriceCurrencyOptionsLbp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLbpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLbpTier> Tiers { get; set; }
