...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPkr : StripeEntity<PriceCurrencyOptionsPkr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPkrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPkrTier> Tiers { get; set; }
