...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEur : StripeEntity<PriceCurrencyOptionsEur>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEurCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEurTier> Tiers { get; set; }
