...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsInr : StripeEntity<PriceCurrencyOptionsInr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsInrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsInrTier> Tiers { get; set; }
