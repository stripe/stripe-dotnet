...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKhr : StripeEntity<PriceCurrencyOptionsKhr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKhrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKhrTier> Tiers { get; set; }
