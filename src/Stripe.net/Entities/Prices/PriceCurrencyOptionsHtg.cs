...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHtg : StripeEntity<PriceCurrencyOptionsHtg>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHtgCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHtgTier> Tiers { get; set; }
