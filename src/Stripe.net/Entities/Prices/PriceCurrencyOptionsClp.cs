...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsClp : StripeEntity<PriceCurrencyOptionsClp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsClpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsClpTier> Tiers { get; set; }
