...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGyd : StripeEntity<PriceCurrencyOptionsGyd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGydCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGydTier> Tiers { get; set; }
