...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKzt : StripeEntity<PriceCurrencyOptionsKzt>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKztCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKztTier> Tiers { get; set; }
