...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRon : StripeEntity<PriceCurrencyOptionsRon>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRonCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRonTier> Tiers { get; set; }
