...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBtn : StripeEntity<PriceCurrencyOptionsBtn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBtnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBtnTier> Tiers { get; set; }
