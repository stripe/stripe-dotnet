...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsYer : StripeEntity<PriceCurrencyOptionsYer>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsYerCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsYerTier> Tiers { get; set; }
