...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPen : StripeEntity<PriceCurrencyOptionsPen>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPenCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPenTier> Tiers { get; set; }
