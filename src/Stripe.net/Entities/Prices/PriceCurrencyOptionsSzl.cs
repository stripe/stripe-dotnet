...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSzl : StripeEntity<PriceCurrencyOptionsSzl>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSzlCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSzlTier> Tiers { get; set; }
