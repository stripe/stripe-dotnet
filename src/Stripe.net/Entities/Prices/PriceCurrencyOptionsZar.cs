...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsZar : StripeEntity<PriceCurrencyOptionsZar>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsZarCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsZarTier> Tiers { get; set; }
