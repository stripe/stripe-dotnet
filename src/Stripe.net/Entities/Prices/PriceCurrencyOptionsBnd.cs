...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBnd : StripeEntity<PriceCurrencyOptionsBnd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBndCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBndTier> Tiers { get; set; }
