...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsByn : StripeEntity<PriceCurrencyOptionsByn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBynCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBynTier> Tiers { get; set; }
