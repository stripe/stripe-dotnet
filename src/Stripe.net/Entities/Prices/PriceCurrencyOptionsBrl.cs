...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBrl : StripeEntity<PriceCurrencyOptionsBrl>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBrlCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBrlTier> Tiers { get; set; }
