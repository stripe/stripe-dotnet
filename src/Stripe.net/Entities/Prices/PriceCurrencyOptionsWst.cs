...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsWst : StripeEntity<PriceCurrencyOptionsWst>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsWstCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsWstTier> Tiers { get; set; }
