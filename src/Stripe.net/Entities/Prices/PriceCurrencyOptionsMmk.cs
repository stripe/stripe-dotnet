...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMmk : StripeEntity<PriceCurrencyOptionsMmk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMmkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMmkTier> Tiers { get; set; }
