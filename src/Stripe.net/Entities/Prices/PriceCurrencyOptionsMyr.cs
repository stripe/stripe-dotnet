...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMyr : StripeEntity<PriceCurrencyOptionsMyr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMyrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMyrTier> Tiers { get; set; }
