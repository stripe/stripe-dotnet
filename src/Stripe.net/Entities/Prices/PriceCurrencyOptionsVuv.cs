...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsVuv : StripeEntity<PriceCurrencyOptionsVuv>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsVuvCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsVuvTier> Tiers { get; set; }
