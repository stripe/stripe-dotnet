...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBif : StripeEntity<PriceCurrencyOptionsBif>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBifCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBifTier> Tiers { get; set; }
