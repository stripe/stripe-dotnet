...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMkd : StripeEntity<PriceCurrencyOptionsMkd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMkdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMkdTier> Tiers { get; set; }
