...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGmd : StripeEntity<PriceCurrencyOptionsGmd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGmdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGmdTier> Tiers { get; set; }
