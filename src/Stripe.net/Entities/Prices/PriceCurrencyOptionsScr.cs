...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsScr : StripeEntity<PriceCurrencyOptionsScr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsScrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsScrTier> Tiers { get; set; }
