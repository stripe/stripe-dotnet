...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSos : StripeEntity<PriceCurrencyOptionsSos>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSosCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSosTier> Tiers { get; set; }
