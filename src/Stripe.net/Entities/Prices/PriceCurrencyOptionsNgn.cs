...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNgn : StripeEntity<PriceCurrencyOptionsNgn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNgnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNgnTier> Tiers { get; set; }
