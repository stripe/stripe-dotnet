...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTtd : StripeEntity<PriceCurrencyOptionsTtd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTtdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTtdTier> Tiers { get; set; }
