...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEtb : StripeEntity<PriceCurrencyOptionsEtb>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEtbCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEtbTier> Tiers { get; set; }
