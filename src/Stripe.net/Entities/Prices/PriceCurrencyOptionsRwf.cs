...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRwf : StripeEntity<PriceCurrencyOptionsRwf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRwfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRwfTier> Tiers { get; set; }
