...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXpf : StripeEntity<PriceCurrencyOptionsXpf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXpfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXpfTier> Tiers { get; set; }
