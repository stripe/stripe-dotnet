...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTjs : StripeEntity<PriceCurrencyOptionsTjs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTjsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTjsTier> Tiers { get; set; }
