...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGnf : StripeEntity<PriceCurrencyOptionsGnf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGnfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGnfTier> Tiers { get; set; }
