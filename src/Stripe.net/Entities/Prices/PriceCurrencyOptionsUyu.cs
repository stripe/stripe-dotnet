...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUyu : StripeEntity<PriceCurrencyOptionsUyu>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUyuCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUyuTier> Tiers { get; set; }
