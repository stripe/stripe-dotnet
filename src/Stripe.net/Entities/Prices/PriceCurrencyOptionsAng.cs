...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAng : StripeEntity<PriceCurrencyOptionsAng>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAngCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAngTier> Tiers { get; set; }
