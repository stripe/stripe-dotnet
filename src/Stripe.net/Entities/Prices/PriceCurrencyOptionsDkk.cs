...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDkk : StripeEntity<PriceCurrencyOptionsDkk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDkkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDkkTier> Tiers { get; set; }
