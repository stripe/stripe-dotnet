...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAwg : StripeEntity<PriceCurrencyOptionsAwg>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAwgCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAwgTier> Tiers { get; set; }
