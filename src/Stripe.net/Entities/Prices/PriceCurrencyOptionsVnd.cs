...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsVnd : StripeEntity<PriceCurrencyOptionsVnd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsVndCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsVndTier> Tiers { get; set; }
