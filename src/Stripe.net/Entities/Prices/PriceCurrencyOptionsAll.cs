...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAll : StripeEntity<PriceCurrencyOptionsAll>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAllCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAllTier> Tiers { get; set; }
