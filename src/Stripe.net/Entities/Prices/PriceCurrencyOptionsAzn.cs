...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAzn : StripeEntity<PriceCurrencyOptionsAzn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAznCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAznTier> Tiers { get; set; }
