...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKrw : StripeEntity<PriceCurrencyOptionsKrw>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKrwCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKrwTier> Tiers { get; set; }
