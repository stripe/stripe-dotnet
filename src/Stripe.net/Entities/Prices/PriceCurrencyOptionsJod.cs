...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJod : StripeEntity<PriceCurrencyOptionsJod>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJodCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJodTier> Tiers { get; set; }
