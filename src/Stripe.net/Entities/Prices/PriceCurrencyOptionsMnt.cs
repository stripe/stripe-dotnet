...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMnt : StripeEntity<PriceCurrencyOptionsMnt>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMntCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMntTier> Tiers { get; set; }
