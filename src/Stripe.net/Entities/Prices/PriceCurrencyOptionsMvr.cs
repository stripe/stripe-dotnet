...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMvr : StripeEntity<PriceCurrencyOptionsMvr>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMvrCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMvrTier> Tiers { get; set; }
