...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLak : StripeEntity<PriceCurrencyOptionsLak>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLakCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLakTier> Tiers { get; set; }
