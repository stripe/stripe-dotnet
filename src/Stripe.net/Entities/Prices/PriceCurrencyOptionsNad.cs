...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNad : StripeEntity<PriceCurrencyOptionsNad>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNadCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNadTier> Tiers { get; set; }
