...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAud : StripeEntity<PriceCurrencyOptionsAud>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAudCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAudTier> Tiers { get; set; }
