...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDjf : StripeEntity<PriceCurrencyOptionsDjf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDjfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDjfTier> Tiers { get; set; }
