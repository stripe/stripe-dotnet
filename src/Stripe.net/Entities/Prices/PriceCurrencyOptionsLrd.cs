...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLrd : StripeEntity<PriceCurrencyOptionsLrd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLrdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLrdTier> Tiers { get; set; }
