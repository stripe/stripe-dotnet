...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBzd : StripeEntity<PriceCurrencyOptionsBzd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBzdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBzdTier> Tiers { get; set; }
