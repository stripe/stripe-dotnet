...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsChf : StripeEntity<PriceCurrencyOptionsChf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsChfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsChfTier> Tiers { get; set; }
