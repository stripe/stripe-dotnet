...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBhd : StripeEntity<PriceCurrencyOptionsBhd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBhdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBhdTier> Tiers { get; set; }
