...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRub : StripeEntity<PriceCurrencyOptionsRub>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRubCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRubTier> Tiers { get; set; }
