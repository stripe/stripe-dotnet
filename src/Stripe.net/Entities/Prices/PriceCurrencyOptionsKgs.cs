...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKgs : StripeEntity<PriceCurrencyOptionsKgs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKgsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKgsTier> Tiers { get; set; }
