...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAfn : StripeEntity<PriceCurrencyOptionsAfn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAfnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAfnTier> Tiers { get; set; }
