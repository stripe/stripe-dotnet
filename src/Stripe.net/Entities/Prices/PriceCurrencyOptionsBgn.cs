...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBgn : StripeEntity<PriceCurrencyOptionsBgn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBgnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBgnTier> Tiers { get; set; }
