...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSrd : StripeEntity<PriceCurrencyOptionsSrd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSrdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSrdTier> Tiers { get; set; }
