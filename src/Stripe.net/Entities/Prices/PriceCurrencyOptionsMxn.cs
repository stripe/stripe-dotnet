...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMxn : StripeEntity<PriceCurrencyOptionsMxn>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMxnCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMxnTier> Tiers { get; set; }
