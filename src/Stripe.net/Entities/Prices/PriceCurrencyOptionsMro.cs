...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMro : StripeEntity<PriceCurrencyOptionsMro>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMroCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMroTier> Tiers { get; set; }
