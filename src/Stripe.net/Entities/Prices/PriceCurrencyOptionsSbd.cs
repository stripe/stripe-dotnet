...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSbd : StripeEntity<PriceCurrencyOptionsSbd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSbdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSbdTier> Tiers { get; set; }
