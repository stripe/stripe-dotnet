...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPhp : StripeEntity<PriceCurrencyOptionsPhp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPhpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPhpTier> Tiers { get; set; }
