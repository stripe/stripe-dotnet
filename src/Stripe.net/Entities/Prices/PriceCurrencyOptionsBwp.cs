...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBwp : StripeEntity<PriceCurrencyOptionsBwp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBwpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBwpTier> Tiers { get; set; }
