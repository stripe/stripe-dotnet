...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSar : StripeEntity<PriceCurrencyOptionsSar>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSarCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSarTier> Tiers { get; set; }
