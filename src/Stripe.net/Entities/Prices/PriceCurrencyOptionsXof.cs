...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXof : StripeEntity<PriceCurrencyOptionsXof>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXofCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXofTier> Tiers { get; set; }
