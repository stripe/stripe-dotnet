...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGtq : StripeEntity<PriceCurrencyOptionsGtq>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGtqCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGtqTier> Tiers { get; set; }
