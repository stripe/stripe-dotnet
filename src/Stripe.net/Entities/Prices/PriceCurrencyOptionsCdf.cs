...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCdf : StripeEntity<PriceCurrencyOptionsCdf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCdfCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCdfTier> Tiers { get; set; }
