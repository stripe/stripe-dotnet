...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCzk : StripeEntity<PriceCurrencyOptionsCzk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCzkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCzkTier> Tiers { get; set; }
