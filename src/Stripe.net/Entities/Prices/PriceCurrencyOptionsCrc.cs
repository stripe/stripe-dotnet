...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCrc : StripeEntity<PriceCurrencyOptionsCrc>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCrcCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCrcTier> Tiers { get; set; }
