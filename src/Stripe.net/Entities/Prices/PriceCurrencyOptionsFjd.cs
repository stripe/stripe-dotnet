...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsFjd : StripeEntity<PriceCurrencyOptionsFjd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsFjdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsFjdTier> Tiers { get; set; }
