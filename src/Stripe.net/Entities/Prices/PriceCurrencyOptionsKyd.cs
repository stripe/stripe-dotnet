...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKyd : StripeEntity<PriceCurrencyOptionsKyd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKydCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKydTier> Tiers { get; set; }
