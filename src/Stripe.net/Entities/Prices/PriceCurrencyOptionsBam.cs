...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBam : StripeEntity<PriceCurrencyOptionsBam>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBamCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBamTier> Tiers { get; set; }
