...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGbp : StripeEntity<PriceCurrencyOptionsGbp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGbpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGbpTier> Tiers { get; set; }
