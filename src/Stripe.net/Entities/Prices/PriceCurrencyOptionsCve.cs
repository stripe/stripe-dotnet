...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCve : StripeEntity<PriceCurrencyOptionsCve>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCveCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCveTier> Tiers { get; set; }
