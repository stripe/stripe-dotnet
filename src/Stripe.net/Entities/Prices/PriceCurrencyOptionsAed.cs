...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAed : StripeEntity<PriceCurrencyOptionsAed>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAedCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAedTier> Tiers { get; set; }
