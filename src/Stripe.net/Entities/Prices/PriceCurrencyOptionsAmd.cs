...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAmd : StripeEntity<PriceCurrencyOptionsAmd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAmdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAmdTier> Tiers { get; set; }
