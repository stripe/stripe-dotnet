...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsShp : StripeEntity<PriceCurrencyOptionsShp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsShpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsShpTier> Tiers { get; set; }
