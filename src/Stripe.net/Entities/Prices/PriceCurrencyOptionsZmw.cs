...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsZmw : StripeEntity<PriceCurrencyOptionsZmw>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsZmwCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsZmwTier> Tiers { get; set; }
