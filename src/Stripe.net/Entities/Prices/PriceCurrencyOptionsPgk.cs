...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPgk : StripeEntity<PriceCurrencyOptionsPgk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPgkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPgkTier> Tiers { get; set; }
