...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSgd : StripeEntity<PriceCurrencyOptionsSgd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSgdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSgdTier> Tiers { get; set; }
