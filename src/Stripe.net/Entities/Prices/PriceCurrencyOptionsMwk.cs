...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMwk : StripeEntity<PriceCurrencyOptionsMwk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMwkCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMwkTier> Tiers { get; set; }
