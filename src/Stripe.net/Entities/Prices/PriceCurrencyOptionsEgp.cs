...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEgp : StripeEntity<PriceCurrencyOptionsEgp>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEgpCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEgpTier> Tiers { get; set; }
