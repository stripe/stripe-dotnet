...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXaf : StripeEntity<PriceCurrencyOptionsXaf>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXafCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXafTier> Tiers { get; set; }
