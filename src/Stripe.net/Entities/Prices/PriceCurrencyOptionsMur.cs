...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMur : StripeEntity<PriceCurrencyOptionsMur>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMurCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMurTier> Tiers { get; set; }
