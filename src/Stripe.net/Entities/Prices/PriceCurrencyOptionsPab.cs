...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPab : StripeEntity<PriceCurrencyOptionsPab>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPabCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPabTier> Tiers { get; set; }
