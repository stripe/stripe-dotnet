...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKes : StripeEntity<PriceCurrencyOptionsKes>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKesCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKesTier> Tiers { get; set; }
