...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIsk : StripeEntity<PriceCurrencyOptionsIsk>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIskCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIskTier> Tiers { get; set; }
