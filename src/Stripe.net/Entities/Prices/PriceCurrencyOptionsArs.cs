...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsArs : StripeEntity<PriceCurrencyOptionsArs>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsArsCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsArsTier> Tiers { get; set; }
