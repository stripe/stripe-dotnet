...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJmd : StripeEntity<PriceCurrencyOptionsJmd>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJmdCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJmdTier> Tiers { get; set; }
