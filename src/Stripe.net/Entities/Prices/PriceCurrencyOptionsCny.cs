...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCny : StripeEntity<PriceCurrencyOptionsCny>
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCnyCustomUnitAmount CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCnyTier> Tiers { get; set; }
