...
#endif
    public class BalanceTransferSourceBalancePayments : StripeEntity<BalanceTransferSourceBalancePayments>
    {
        ...
        /// <summary>
        /// The payments balance type that this BalanceTransfer pulled funds from. One of
