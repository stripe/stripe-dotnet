...
namespace Stripe
{
    ...
    public class QuotePreviewSchedulePhaseAddInvoiceItem : StripeEntity<QuotePreviewSchedulePhaseAddInvoiceItem>
    {
        /// <summary>
        /// The stackable discounts that will be applied to the item.
        /// </summary>
        [JsonProperty("discounts")]
        public List<QuotePreviewSchedulePhaseAddInvoiceItemDiscount> Discounts { get; set; }
