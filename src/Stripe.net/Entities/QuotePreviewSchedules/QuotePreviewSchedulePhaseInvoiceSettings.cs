...
namespace Stripe
{
    ...
    public class QuotePreviewSchedulePhaseInvoiceSettings : StripeEntity<QuotePreviewSchedulePhaseInvoiceSettings>
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("issuer")]
        public QuotePreviewSchedulePhaseInvoiceSettingsIssuer Issuer { get; set; }
    }
}
