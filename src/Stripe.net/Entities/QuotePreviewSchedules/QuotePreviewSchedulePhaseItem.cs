...
namespace Stripe
{
    ...
    public class QuotePreviewSchedulePhaseItem : StripeEntity<QuotePreviewSchedulePhaseItem>, IHasMetadata
    {
        /// <summary>
        ...
        public QuotePreviewSchedulePhaseItemBillingThresholds BillingThresholds { get; set; }
        ...
        public List<QuotePreviewSchedulePhaseItemDiscount> Discounts { get; set; }
        ...
        /// </summary>
        [JsonProperty("trial")]
        public QuotePreviewSchedulePhaseItemTrial Trial { get; set; }
    }
}
