...
namespace Stripe
{
    ...
    public class QuotePreviewSchedulePhaseDiscount : StripeEntity<QuotePreviewSchedulePhaseDiscount>
    {
        ...
        public QuotePreviewSchedulePhaseDiscountDiscountEnd DiscountEnd { get; set; }
    }
}
