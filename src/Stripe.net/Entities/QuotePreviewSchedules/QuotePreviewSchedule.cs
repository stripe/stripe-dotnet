...
namespace Stripe
{
    ...
    public class QuotePreviewSchedule : StripeEntity<QuotePreviewSchedule>, IHasId, IHasMetadata, IHasObject
    {
        /// <summary>
        ...
        public QuotePreviewScheduleAppliesTo AppliesTo { get; set; }
        ...
        public QuotePreviewScheduleCurrentPhase CurrentPhase { get; set; }
        ...
        public QuotePreviewScheduleDefaultSettings DefaultSettings { get; set; }
        ...
        /// </summary>
        [JsonProperty("phases")]
        public List<QuotePreviewSchedulePhase> Phases { get; set; }

        /// <summary>
        /// Time period and invoice for a Subscription billed in advance.
        /// </summary>
        [JsonProperty("prebilling")]
        public QuotePreviewSchedulePrebilling Prebilling { get; set; }
