...
namespace Stripe
{
    ...
    public class QuotePreviewSubscriptionSchedulePhaseDiscountSettings : StripeEntity<QuotePreviewSubscriptionSchedulePhaseDiscountSettings>
    {
        [JsonProperty("service_period_anchor_config")]
        [STJS.JsonPropertyName("service_period_anchor_config")]
        public QuotePreviewSubscriptionSchedulePhaseDiscountSettingsServicePeriodAnchorConfig ServicePeriodAnchorConfig { get; set; }
