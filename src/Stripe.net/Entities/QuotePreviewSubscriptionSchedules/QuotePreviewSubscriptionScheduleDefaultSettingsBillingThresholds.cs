...
namespace Stripe
{
    ...
    public class QuotePreviewSubscriptionScheduleDefaultSettingsBillingThresholds : StripeEntity<QuotePreviewSubscriptionScheduleDefaultSettingsBillingThresholds>
    {
        /// <summary>
