...
namespace Stripe
{
    ...
    public class QuotePreviewSubscriptionSchedulePhaseAddInvoiceItemPeriodStart : StripeEntity<QuotePreviewSubscriptionSchedulePhaseAddInvoiceItemPeriodStart>
    {
        /// <summary>
