...
namespace Stripe.Identity
{
    ...
    public class VerificationReportSignalsFraudulentEmail : StripeEntity<VerificationReportSignalsFraudulentEmail>
    {
        /// <summary>
        ...
        public List<VerificationReportSignalsFraudulentEmailIndicator> Indicators { get; set; }
