...
namespace Stripe.Identity
{
    ...
    public class VerificationReportSignalsFraudulentPerson : StripeEntity<VerificationReportSignalsFraudulentPerson>
    {
        /// <summary>
        ...
        public List<VerificationReportSignalsFraudulentPersonIndicator> Indicators { get; set; }
