...
namespace Stripe
{
    ...
    /// href="https://stripe.com/docs/api/credit_notes">Credit Notes</a>, which reduce overall
    /// tax liability because tax is correctly recalculated and apportioned to the related
    /// invoice.
    ///
