...
namespace Stripe
{
    ...
    public class QuotePreviewInvoicePaymentSettingsPaymentMethodOptions : StripeEntity<QuotePreviewInvoicePaymentSettingsPaymentMethodOptions>
    {
        ...
        public QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsBillie Billie { get; set; }
        ...
        public QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsCheckScan CheckScan { get; set; }
