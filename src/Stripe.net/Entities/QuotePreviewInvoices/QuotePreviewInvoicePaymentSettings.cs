...
namespace Stripe
{
    ...
    public class QuotePreviewInvoicePaymentSettings : StripeEntity<QuotePreviewInvoicePaymentSettings>
    {
        ...
        /// <c>jp_credit_transfer</c>, <c>kakao_pay</c>, <c>konbini</c>, <c>kr_card</c>,
        /// <c>link</c>, <c>multibanco</c>, <c>naver_pay</c>, <c>p24</c>, <c>payco</c>,
        /// <c>paynow</c>, <c>paypal</c>, <c>promptpay</c>, <c>revolut_pay</c>,
