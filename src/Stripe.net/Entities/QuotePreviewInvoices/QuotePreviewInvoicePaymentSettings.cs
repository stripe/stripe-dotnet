...
namespace Stripe
{
    ...
    public class QuotePreviewInvoicePaymentSettings : StripeEntity<QuotePreviewInvoicePaymentSettings>
    {
        ...
        /// <c>blik</c>, <c>boleto</c>, <c>card</c>, <c>cashapp</c>, <c>crypto</c>, <c>custom</c>,
        ...
        /// <c>revolut_pay</c>, <c>satispay</c>, <c>sepa_credit_transfer</c>, <c>sepa_debit</c>,
        /// <c>sofort</c>, <c>stripe_balance</c>, <c>swish</c>, <c>twint</c>, <c>upi</c>,
