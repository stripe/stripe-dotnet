...
namespace Stripe
{
    ...
    public class QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsPaytoMandateOptions : StripeEntity<QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsPaytoMandateOptions>
    {
        /// <summary>
