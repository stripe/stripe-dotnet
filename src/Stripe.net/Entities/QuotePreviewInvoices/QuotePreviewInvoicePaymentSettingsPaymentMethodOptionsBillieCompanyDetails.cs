...
namespace Stripe
{
    ...
    public class QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetails : StripeEntity<QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetails>
    {
        [JsonProperty("registered_address")]
        [STJS.JsonPropertyName("registered_address")]
        public QuotePreviewInvoicePaymentSettingsPaymentMethodOptionsBillieCompanyDetailsRegisteredAddress RegisteredAddress { get; set; }
