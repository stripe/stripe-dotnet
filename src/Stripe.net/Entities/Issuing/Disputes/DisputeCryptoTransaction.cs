...
namespace Stripe.Issuing
{
    ...
    public class DisputeCryptoTransaction : StripeEntity<DisputeCryptoTransaction>
    {
        /// <summary>
        ...
        public DisputeCryptoTransactionCryptoTransactionConfirmed CryptoTransactionConfirmed { get; set; }
        ...
        public DisputeCryptoTransactionCryptoTransactionFailed CryptoTransactionFailed { get; set; }
