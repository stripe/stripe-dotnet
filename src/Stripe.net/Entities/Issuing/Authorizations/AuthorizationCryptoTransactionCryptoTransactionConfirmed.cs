...
namespace Stripe.Issuing
{
    ...
    public class AuthorizationCryptoTransactionCryptoTransactionConfirmed : StripeEntity<AuthorizationCryptoTransactionCryptoTransactionConfirmed>
    {
        /// <summary>
        ...
        public List<AuthorizationCryptoTransactionCryptoTransactionConfirmedFee> Fees { get; set; }
