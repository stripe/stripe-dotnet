...
namespace Stripe.Issuing
{
    ...
    public class AuthorizationCryptoTransactionCryptoTransactionFailed : StripeEntity<AuthorizationCryptoTransactionCryptoTransactionFailed>
    {
        /// <summary>
        ...
        public List<AuthorizationCryptoTransactionCryptoTransactionFailedFee> Fees { get; set; }
