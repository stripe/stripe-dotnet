...
namespace Stripe.Issuing
{
    ...
    public class TransactionCryptoTransactionCryptoTransactionConfirmed : StripeEntity<TransactionCryptoTransactionCryptoTransactionConfirmed>
    {
        /// <summary>
        ...
        public List<TransactionCryptoTransactionCryptoTransactionConfirmedFee> Fees { get; set; }
