...
namespace Stripe.Issuing
{
    ...
    public class TransactionCryptoTransactionCryptoTransactionFailed : StripeEntity<TransactionCryptoTransactionCryptoTransactionFailed>
    {
        /// <summary>
        ...
        public List<TransactionCryptoTransactionCryptoTransactionFailedFee> Fees { get; set; }
