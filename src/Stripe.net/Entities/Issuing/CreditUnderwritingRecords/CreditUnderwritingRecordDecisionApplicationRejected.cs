...
namespace Stripe.Issuing
{
    ...
    public class CreditUnderwritingRecordDecisionApplicationRejected : StripeEntity<CreditUnderwritingRecordDecisionApplicationRejected>
    {
        ...
        /// <c>high_risk_industry</c>, <c>incomplete_application</c>,
        /// <c>inconsistent_monthly_revenues</c>, <c>insufficient_account_history_with_platform</c>,
        ...
        /// <c>insufficient_income</c>, <c>insufficient_margin_ratio</c>,
        /// <c>insufficient_operating_profit</c>, <c>insufficient_period_in_operation</c>,
        /// <c>insufficient_reserves</c>, <c>insufficient_revenue</c>,
        /// <c>insufficient_social_media_performance</c>, <c>insufficient_time_in_network</c>,
