...
namespace Stripe
{
    ...
    public class InvoiceLineItemPricingRateCardCustomPricingUnitOverageRateDetails : StripeEntity<InvoiceLineItemPricingRateCardCustomPricingUnitOverageRateDetails>
    {
        /// <summary>
