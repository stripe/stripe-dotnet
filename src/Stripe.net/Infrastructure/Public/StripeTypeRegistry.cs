    ...
    public static class StripeTypeRegistry
    {
        ...
        public static readonly IReadOnlyDictionary<string, Type> ObjectsToTypes = new ReadOnlyDictionary<string, Type>(
            new Dictionary<string, Type>
            {
                ...
                { "billing.alert_notification", typeof(Billing.AlertNotification) },
                ...
                { "crypto.consumer_wallet", typeof(Crypto.CustomerConsumerWallet) },
                { "crypto.customer", typeof(Crypto.Customer) },
                { "crypto.deposit_address", typeof(Crypto.DepositAddress) },
                { "crypto.onramp_session", typeof(Crypto.OnrampSession) },
                { "crypto.onramp_transaction_limits", typeof(Crypto.OnrampTransactionLimits) },
                { "crypto.payment_token", typeof(Crypto.CustomerPaymentToken) },
                ...
                { "gift_card_operation", typeof(GiftCardOperation) },
        ...
        internal static readonly IReadOnlyDictionary<string, Type> V2ObjectsToTypes = new ReadOnlyDictionary<string, Type>(
            new Dictionary<string, Type>
            {
                ...
                { "v2.core.health.alert", typeof(V2.Core.Health.Alert) },
                {
                    "v2.core.health.alert_history_entry", typeof(
                ...
                { "v2.money_management.payout_intent", typeof(V2.MoneyManagement.PayoutIntent) },
        ...
        internal static readonly IReadOnlyDictionary<string, Type> V2EventsToTypes = new ReadOnlyDictionary<string, Type>(
            new Dictionary<string, Type>
            {
                ...
                {
                    "v2.core.claimable_sandbox.updated", typeof(
                ...
                {
                    "v2.core.health.meter_event_summaries_delayed.firing", typeof(
                    Events.V2CoreHealthMeterEventSummariesDelayedFiringEvent)
                },
                {
                    "v2.core.health.meter_event_summaries_delayed.resolved", typeof(
                ...
                {
                    "v2.money_management.debit_dispute.failed", typeof(
                    Events.V2MoneyManagementDebitDisputeFailedEvent)
                },
                {
                    "v2.money_management.debit_dispute.submitted", typeof(
