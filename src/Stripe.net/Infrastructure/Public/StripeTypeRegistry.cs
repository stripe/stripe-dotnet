namespace Stripe
{
    ...
    public static class StripeTypeRegistry
    {
        ...
        /// </summary>
        public static readonly IReadOnlyDictionary<string, Type> ObjectsToTypes =
            new ReadOnlyDictionary<string, Type>(
                new Dictionary<string, Type>
                {
                    ...
                    { "billing.credit_balance_summary", typeof(Billing.CreditBalanceSummary) },
                    {
                        ...
                        typeof(Billing.CreditBalanceTransaction)
                    },
                    ...
                    { "entitlements.active_entitlement", typeof(Entitlements.ActiveEntitlement) },
                    {
                        ...
                        typeof(Entitlements.ActiveEntitlementSummary)
                    },
                    ...
                    { "financial_connections.account", typeof(FinancialConnections.Account) },
                    {
                        ...
                        typeof(FinancialConnections.AccountOwner)
                    },
                    {
                        "financial_connections.account_ownership",
                        typeof(FinancialConnections.AccountOwnership)
                    },
                    { "financial_connections.session", typeof(FinancialConnections.Session) },
                    {
                        "financial_connections.transaction",
                        typeof(FinancialConnections.Transaction)
                    },
                    ...
                    { "payment_intent", typeof(PaymentIntent) },
                    {
                        ...
                        typeof(PaymentIntentAmountDetailsLineItem)
                    },
                    ...
                    { "treasury.financial_account", typeof(Treasury.FinancialAccount) },
                    {
                        ...
                        typeof(Treasury.FinancialAccountFeatures)
                    },
        ...
        internal static readonly IReadOnlyDictionary<string, Type> V2ObjectsToTypes =
            new ReadOnlyDictionary<string, Type>(
                new Dictionary<string, Type>
                {
                    ...
                    { "v2.billing.meter_event", typeof(V2.Billing.MeterEvent) },
                    {
                        ...
                        typeof(V2.Billing.MeterEventAdjustment)
                    },
        ...
        internal static readonly IReadOnlyDictionary<string, Type> V2EventsToTypes =
            new ReadOnlyDictionary<string, Type>(
                new Dictionary<string, Type>
                {
                    // V2EventsToTypes: The beginning of the section generated from our OpenAPI spec
                    {
                        ...
                        typeof(Events.V1BillingMeterErrorReportTriggeredEvent)
                    },
                    {
                        "v1.billing.meter.no_meter_found",
                        typeof(Events.V1BillingMeterNoMeterFoundEvent)
                    },
                    ...
                    { "v2.core.account.updated", typeof(Events.V2CoreAccountUpdatedEvent) },
                    {
                        ...
                        typeof(Events.V2CoreAccountIncludingConfigurationCustomerCapabilityStatusUpdatedEvent)
                    },
                    {
                        "v2.core.account[configuration.customer].updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationCustomerUpdatedEvent)
                    },
                    {
                    ...
                    },
                    {
                        ...
                        typeof(Events.V2CoreAccountIncludingConfigurationMerchantUpdatedEvent)
                    },
                    {
                        "v2.core.account[configuration.recipient].capability_status_updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationRecipientCapabilityStatusUpdatedEvent)
                    },
                    {
                        "v2.core.account[configuration.recipient].updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationRecipientUpdatedEvent)
                    },
                    {
                        "v2.core.account[defaults].updated",
                        typeof(Events.V2CoreAccountIncludingDefaultsUpdatedEvent)
                    },
                    {
                        "v2.core.account[future_requirements].updated",
                        typeof(Events.V2CoreAccountIncludingFutureRequirementsUpdatedEvent)
                    },
                    {
                        "v2.core.account[identity].updated",
                        typeof(Events.V2CoreAccountIncludingIdentityUpdatedEvent)
                    },
                    {
                        "v2.core.account[requirements].updated",
                        typeof(Events.V2CoreAccountIncludingRequirementsUpdatedEvent)
                    },
                    {
                        "v2.core.account_link.returned",
                        typeof(Events.V2CoreAccountLinkReturnedEvent)
                    },
                    {
                        "v2.core.account_person.created",
                        typeof(Events.V2CoreAccountPersonCreatedEvent)
                    },
                    {
                        "v2.core.account_person.deleted",
                        typeof(Events.V2CoreAccountPersonDeletedEvent)
                    },
                    {
                        "v2.core.account_person.updated",
                        typeof(Events.V2CoreAccountPersonUpdatedEvent)
                    },
                    {
                        "v2.core.event_destination.ping",
                        typeof(Events.V2CoreEventDestinationPingEvent)
                    },
        ...
        internal static readonly IReadOnlyDictionary<string, Type> V2EventNotificationsToTypes =
            new ReadOnlyDictionary<string, Type>(
                new Dictionary<string, Type>
                {
                    ...
                    {
                        "v1.billing.meter.error_report_triggered",
                        typeof(Events.V1BillingMeterErrorReportTriggeredEventNotification)
                    },
                    {
                        "v1.billing.meter.no_meter_found",
                        typeof(Events.V1BillingMeterNoMeterFoundEventNotification)
                    },
                    {
                        "v2.core.account.closed",
                        typeof(Events.V2CoreAccountClosedEventNotification)
                    },
                    {
                        "v2.core.account.created",
                        typeof(Events.V2CoreAccountCreatedEventNotification)
                    },
                    {
                        "v2.core.account.updated",
                        typeof(Events.V2CoreAccountUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[configuration.customer].capability_status_updated",
                    ...
                    {
                        "v2.core.account[configuration.customer].updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationCustomerUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[configuration.merchant].capability_status_updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationMerchantCapabilityStatusUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[configuration.merchant].updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationMerchantUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[configuration.recipient].capability_status_updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationRecipientCapabilityStatusUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[configuration.recipient].updated",
                        typeof(Events.V2CoreAccountIncludingConfigurationRecipientUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[defaults].updated",
                        typeof(Events.V2CoreAccountIncludingDefaultsUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[future_requirements].updated",
                        typeof(Events.V2CoreAccountIncludingFutureRequirementsUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[identity].updated",
                        typeof(Events.V2CoreAccountIncludingIdentityUpdatedEventNotification)
                    },
                    {
                        "v2.core.account[requirements].updated",
                        typeof(Events.V2CoreAccountIncludingRequirementsUpdatedEventNotification)
                    },
                    {
                        "v2.core.account_link.returned",
                        typeof(Events.V2CoreAccountLinkReturnedEventNotification)
                    },
                    {
                        "v2.core.account_person.created",
                        typeof(Events.V2CoreAccountPersonCreatedEventNotification)
                    },
                    {
                        "v2.core.account_person.deleted",
                        typeof(Events.V2CoreAccountPersonDeletedEventNotification)
                    },
                    {
                        "v2.core.account_person.updated",
                        typeof(Events.V2CoreAccountPersonUpdatedEventNotification)
                    },
                    {
                        "v2.core.event_destination.ping",
                        typeof(Events.V2CoreEventDestinationPingEventNotification)
                    },
        ...
        public static Type GetConcreteType(Type potentialType, string objectValue)
        {
            ...
            if (
                !string.IsNullOrEmpty(objectValue)
