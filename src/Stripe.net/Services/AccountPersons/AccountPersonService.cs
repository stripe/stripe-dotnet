...
namespace Stripe
{
            ...
            INestedUpdatable<Person, AccountPersonUpdateOptions>
    {
        ...
        public virtual Person Create(
            string parentId,
            AccountPersonCreateOptions options = null,
        ...
        )
        {
            return this.Request<Person>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
                requestOptions
            );
        }
        ...
        /// <p>Creates a new person.</p>.
        /// </summary>
        public virtual Task<Person> CreateAsync(
            string parentId,
            AccountPersonCreateOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<Person>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
        ...
        /// </summary>
        public virtual Person Delete(
            string parentId,
            string id,
            AccountPersonDeleteOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Person>(
                BaseAddress.Api,
                HttpMethod.Delete,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// parameter, you cannot delete the only verified <c>executive</c> on file.</p>.
        /// </summary>
        public virtual Task<Person> DeleteAsync(
            string parentId,
            string id,
            AccountPersonDeleteOptions options = null,
            RequestOptions requestOptions = null,
        ...
        public virtual Person Get(
            string parentId,
            string id,
            AccountPersonGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Person>(
        ...
        /// <p>Retrieves an existing person.</p>.
        /// </summary>
        public virtual Task<Person> GetAsync(
            string parentId,
            string id,
            AccountPersonGetOptions options = null,
            RequestOptions requestOptions = null,
        ...
        /// </summary>
        public virtual StripeList<Person> List(
            string parentId,
            AccountPersonListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Person>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
        ...
        /// returned sorted by creation date, with the most recent people appearing first.</p>.
        /// </summary>
        public virtual Task<StripeList<Person>> ListAsync(
            string parentId,
            AccountPersonListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.RequestAsync<StripeList<Person>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
        ...
        /// returned sorted by creation date, with the most recent people appearing first.</p>.
        /// </summary>
        public virtual IEnumerable<Person> ListAutoPaging(
            string parentId,
            AccountPersonListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<Person>(
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
                requestOptions
            );
        ...
        /// returned sorted by creation date, with the most recent people appearing first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Person> ListAutoPagingAsync(
            string parentId,
            AccountPersonListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.ListRequestAutoPagingAsync<Person>(
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/persons",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual Person Update(
            string parentId,
            string id,
            AccountPersonUpdateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Person>(
        ...
        /// <p>Updates an existing person.</p>.
        /// </summary>
        public virtual Task<Person> UpdateAsync(
            string parentId,
            string id,
            AccountPersonUpdateOptions options,
            RequestOptions requestOptions = null,
