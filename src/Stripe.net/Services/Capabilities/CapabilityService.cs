...
namespace Stripe
{
        ...
        INestedUpdatable<Capability, CapabilityUpdateOptions>
    {
        ...
        {
            return this.Request<Capability>(HttpMethod.Get, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities/{WebUtility.UrlEncode(id)}", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<Capability>(HttpMethod.Get, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities/{WebUtility.UrlEncode(id)}", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Capability>>(HttpMethod.Get, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<StripeList<Capability>>(HttpMethod.Get, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<Capability>(HttpMethod.Post, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities/{WebUtility.UrlEncode(id)}", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<Capability>(HttpMethod.Post, $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/capabilities/{WebUtility.UrlEncode(id)}", options, requestOptions, cancellationToken);
        }
    }
}
