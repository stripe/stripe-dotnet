...
namespace Stripe
{
        ...
        INestedUpdatable<Capability, CapabilityUpdateOptions>
    {
        ...
        {
            return this.Request<Capability>(BaseAddress.Api, HttpMethod.Get, $"/v1/accounts/{parentId}/capabilities/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Capability>(BaseAddress.Api, HttpMethod.Get, $"/v1/accounts/{parentId}/capabilities/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Capability>>(BaseAddress.Api, HttpMethod.Get, $"/v1/accounts/{parentId}/capabilities", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Capability>>(BaseAddress.Api, HttpMethod.Get, $"/v1/accounts/{parentId}/capabilities", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Capability>($"/v1/accounts/{parentId}/capabilities", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Capability>($"/v1/accounts/{parentId}/capabilities", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Capability>(BaseAddress.Api, HttpMethod.Post, $"/v1/accounts/{parentId}/capabilities/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Capability>(BaseAddress.Api, HttpMethod.Post, $"/v1/accounts/{parentId}/capabilities/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
