namespace Stripe
{
    ...
    /// <summary>
    /// <see cref="AnyOf{T1, T2, T3, T4}"/> is a generic class that can hold a value of one of three
    /// different types. It uses implicit conversion operators to seamlessly accept or return any
    /// of the possible types.
    /// This is used to represent polymorphic request parameters, i.e. parameters that can
    /// be different types (typically a string or an options class).
    ...
    public class AnyOf<T1, T2, T3, T4> : AnyOf
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AnyOf{T1, T2, T3, T4}"/> class with type
        /// <c>T1</c>.
        /// </summary>
        /// <param name="value">The value to hold.</param>
        public AnyOf(T1 value)
        ...
        /// <summary>Gets the value of the current <see cref="AnyOf{T1, T2, T3, T4}"/> object.</summary>
        /// <returns>The value of the current <see cref="AnyOf{T1, T2, T3, T4}"/> object.</returns>
        public override object Value
        {
            get
            {
        ...
        /// <summary>Gets the type of the current <see cref="AnyOf{T1, T2, T3, T4}"/> object.</summary>
        /// <returns>The type of the current <see cref="AnyOf{T1, T2, T3, T4}"/> object.</returns>
        public override Type Type
        {
            get
            {
        ...
        /// <summary>
        /// Converts a value of type <c>T1</c> to an <see cref="AnyOf{T1, T2, T3, T4}"/> object.
        /// </summary>
        /// <param name="value">The value to convert.</param>
        ...
        /// </summary>
        /// <param name="anyOf">The <see cref="AnyOf{T1, T2, T3, T4}"/> object to convert.</param>
        /// <returns>
        /// A value of type <c>T1</c>. If the <see cref="AnyOf{T1, T2, T3, T4}"/> object currently
        /// holds a value of a different type, the default value for type <c>T3</c> is returned.
        /// </returns>
        public static implicit operator T1(AnyOf<T1, T2, T3, T4> anyOf) => anyOf.value1;

        /// <summary>
        /// Converts an <see cref="AnyOf{T1, T2, T3, T4}"/> object to a value of type <c>T2</c>.
        /// </summary>
        /// <param name="anyOf">The <see cref="AnyOf{T1, T2, T3, T4}"/> object to convert.</param>
        /// <returns>
        /// A value of type <c>T2</c>. If the <see cref="AnyOf{T1, T2, T3, T4}"/> object currently
        /// holds a value of a different type, the default value for type <c>T3</c> is returned.
        /// </returns>
        public static implicit operator T2(AnyOf<T1, T2, T3, T4> anyOf) => anyOf.value2;

        /// <summary>
        /// Converts an <see cref="AnyOf{T1, T2, T3, T4}"/> object to a value of type <c>T3</c>.
        /// </summary>
        /// <param name="anyOf">The <see cref="AnyOf{T1, T2, T3, T4}"/> object to convert.</param>
        /// <returns>
        /// A value of type <c>T3</c>. If the <see cref="AnyOf{T1, T2, T3, T4}"/> object currently
        /// holds a value of a different type, the default value for type <c>T3</c> is returned.
        /// </returns>
        public static implicit operator T3(AnyOf<T1, T2, T3, T4> anyOf) => anyOf.value3;
        ...
        /// holds a value of a different type, the default value for type <c>T3</c> is returned.
        /// </returns>
        public static implicit operator T4(AnyOf<T1, T2, T3, T4> anyOf) => anyOf.value4;
    }
}
