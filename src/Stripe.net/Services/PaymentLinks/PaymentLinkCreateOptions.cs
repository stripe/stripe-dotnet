...
namespace Stripe
{
    ...
    public class PaymentLinkCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// href="https://stripe.com/docs/api/prices">Prices</a>. There is a maximum of 10 optional
        ...
        /// <c>pay_by_bank</c>, <c>paynow</c>, <c>paypal</c>, <c>payto</c>, <c>pix</c>,
        /// <c>promptpay</c>, <c>qris</c>, <c>rechnung</c>, <c>satispay</c>, <c>sepa_debit</c>,
