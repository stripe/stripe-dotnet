...
namespace Stripe
{
    ...
    public class PaymentLinkLineItemPriceDataOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PaymentLinkLineItemPriceDataProductDataOptions ProductData { get; set; }
...
#endif
        public PaymentLinkLineItemPriceDataRecurringOptions Recurring { get; set; }
