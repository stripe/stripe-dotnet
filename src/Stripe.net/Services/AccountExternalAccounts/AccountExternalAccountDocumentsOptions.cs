...
namespace Stripe
{
    ...
    public class AccountExternalAccountDocumentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountExternalAccountDocumentsBankAccountOwnershipVerificationOptions BankAccountOwnershipVerification { get; set; }
    }
}
