...
namespace Stripe
{
            ...
            INestedUpdatable<TransferReversal, TransferReversalUpdateOptions>
    {
        ...
        /// </summary>
        public virtual TransferReversal Create(
            string parentId,
            TransferReversalCreateOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<TransferReversal>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
                requestOptions
            );
        }
        ...
        /// money than is left on a transfer.</p>.
        /// </summary>
        public virtual Task<TransferReversal> CreateAsync(
            string parentId,
            TransferReversalCreateOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<TransferReversal>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
        ...
        /// transfer.</p>.
        /// </summary>
        public virtual TransferReversal Get(
            string parentId,
            string id,
            TransferReversalGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<TransferReversal>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// transfer.</p>.
        /// </summary>
        public virtual Task<TransferReversal> GetAsync(
            string parentId,
            string id,
            TransferReversalGetOptions options = null,
            RequestOptions requestOptions = null,
        ...
        /// </summary>
        public virtual StripeList<TransferReversal> List(
            string parentId,
            TransferReversalListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<TransferReversal>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
        ...
        /// <c>starting_after</c> parameters to page through additional reversals.</p>.
        /// </summary>
        public virtual Task<StripeList<TransferReversal>> ListAsync(
            string parentId,
            TransferReversalListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.RequestAsync<StripeList<TransferReversal>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
        ...
        /// <c>starting_after</c> parameters to page through additional reversals.</p>.
        /// </summary>
        public virtual IEnumerable<TransferReversal> ListAutoPaging(
            string parentId,
            TransferReversalListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<TransferReversal>(
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
                requestOptions
            );
        ...
        /// <c>starting_after</c> parameters to page through additional reversals.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<TransferReversal> ListAutoPagingAsync(
            string parentId,
            TransferReversalListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.ListRequestAutoPagingAsync<TransferReversal>(
                $"/v1/transfers/{WebUtility.UrlEncode(parentId)}/reversals",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual TransferReversal Update(
            string parentId,
            string id,
        ...
        /// <p>This request only accepts metadata and description as arguments.</p>.
        /// </summary>
        public virtual Task<TransferReversal> UpdateAsync(
            string parentId,
            string id,
            TransferReversalUpdateOptions options,
            RequestOptions requestOptions = null,
