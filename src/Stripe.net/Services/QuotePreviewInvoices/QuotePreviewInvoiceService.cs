...
namespace Stripe
{
    ...
    public class QuotePreviewInvoiceService : Service,
        INestedListable<QuotePreviewInvoice, QuotePreviewInvoiceListOptions>
    {
        ...
        internal QuotePreviewInvoiceService(ApiRequestor requestor)
            : base(requestor)
        {
        }
        ...
        {
            return this.Request<StripeList<QuotePreviewInvoice>>(BaseAddress.Api, HttpMethod.Get, $"/v1/quotes/{WebUtility.UrlEncode(parentId)}/preview_invoices", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<StripeList<QuotePreviewInvoice>>(BaseAddress.Api, HttpMethod.Get, $"/v1/quotes/{WebUtility.UrlEncode(parentId)}/preview_invoices", options, requestOptions, cancellationToken);
        }
