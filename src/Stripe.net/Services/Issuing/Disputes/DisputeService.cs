...
namespace Stripe.Issuing
{
            ...
            IUpdatable<Dispute, DisputeUpdateOptions>
    {
        ...
        /// </summary>
        public virtual Dispute Create(
            DisputeCreateOptions options,
        ...
        /// reasons and evidence</a> for more details about evidence requirements.</p>.
        /// </summary>
        public virtual Task<Dispute> CreateAsync(
            DisputeCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<Dispute>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/issuing/disputes",
                options,
        ...
        /// </summary>
        public virtual Dispute Get(
            string id,
            DisputeGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Dispute>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/issuing/disputes/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// <p>Retrieves an Issuing <c>Dispute</c> object.</p>.
        /// </summary>
        public virtual Task<Dispute> GetAsync(
            string id,
            DisputeGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// first.</p>.
        /// </summary>
        public virtual StripeList<Dispute> List(
            DisputeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Dispute>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/issuing/disputes",
                options,
        ...
        /// first.</p>.
        /// </summary>
        public virtual Task<StripeList<Dispute>> ListAsync(
            DisputeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<Dispute>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/issuing/disputes",
                options,
        ...
        /// first.</p>.
        /// </summary>
        public virtual IEnumerable<Dispute> ListAutoPaging(
            DisputeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<Dispute>(
                $"/v1/issuing/disputes",
                options,
                requestOptions
            );
        ...
        /// first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Dispute> ListAutoPagingAsync(
            DisputeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<Dispute>(
                $"/v1/issuing/disputes",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual Dispute Submit(
            string id,
            DisputeSubmitOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Dispute>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/issuing/disputes/{WebUtility.UrlEncode(id)}/submit",
                options,
                requestOptions
            );
        }
        ...
        /// reasons and evidence</a>.</p>.
        /// </summary>
        public virtual Task<Dispute> SubmitAsync(
            string id,
            DisputeSubmitOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// <c>evidence</c> object can be unset by passing in an empty string.</p>.
        /// </summary>
        public virtual Task<Dispute> UpdateAsync(
            string id,
            DisputeUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
