...
namespace Stripe.Issuing
{
            ...
            IUpdatable<Authorization, AuthorizationUpdateOptions>
    {
        ...
        public virtual Authorization Approve(
            string id,
            AuthorizationApproveOptions options = null,
        ...
        )
        {
            return this.Request<Authorization>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/issuing/authorizations/{WebUtility.UrlEncode(id)}/approve",
                options,
                requestOptions
            );
        }
        ...
        /// </summary>
        [Obsolete("This method is deprecated, please refer to the description for details.")]
        public virtual Task<Authorization> ApproveAsync(
            string id,
            AuthorizationApproveOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<Authorization>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/issuing/authorizations/{WebUtility.UrlEncode(id)}/approve",
                options,
        ...
        /// </summary>
        [Obsolete("This method is deprecated, please refer to the description for details.")]
        public virtual Authorization Decline(
            string id,
            AuthorizationDeclineOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Authorization>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/issuing/authorizations/{WebUtility.UrlEncode(id)}/decline",
                options,
                requestOptions
            );
        }
        ...
        /// </summary>
        [Obsolete("This method is deprecated, please refer to the description for details.")]
        public virtual Task<Authorization> DeclineAsync(
            string id,
            AuthorizationDeclineOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual Authorization Get(
            string id,
            AuthorizationGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Authorization>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/issuing/authorizations/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// <p>Retrieves an Issuing <c>Authorization</c> object.</p>.
        /// </summary>
        public virtual Task<Authorization> GetAsync(
            string id,
            AuthorizationGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// first.</p>.
        /// </summary>
        public virtual StripeList<Authorization> List(
            AuthorizationListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Authorization>>(
                BaseAddress.Api,
                HttpMethod.Get,
        ...
        /// first.</p>.
        /// </summary>
        public virtual Task<StripeList<Authorization>> ListAsync(
            AuthorizationListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<Authorization>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/issuing/authorizations",
                options,
        ...
        /// first.</p>.
        /// </summary>
        public virtual IEnumerable<Authorization> ListAutoPaging(
            AuthorizationListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<Authorization>(
                $"/v1/issuing/authorizations",
                options,
                requestOptions
            );
        ...
        /// first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Authorization> ListAutoPagingAsync(
            AuthorizationListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<Authorization>(
                $"/v1/issuing/authorizations",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual Authorization Update(
            string id,
            AuthorizationUpdateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Authorization>(
        ...
        /// the parameters passed. Any parameters not provided will be left unchanged.</p>.
        /// </summary>
        public virtual Task<Authorization> UpdateAsync(
            string id,
            AuthorizationUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
