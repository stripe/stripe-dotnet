...
namespace Stripe.Issuing
{
        ...
        IUpdatable<Cardholder, CardholderUpdateOptions>
    {
        ...
        public virtual Cardholder Update(string id, CardholderUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.UpdateEntity(id, options, requestOptions);
        }

        public virtual Task<Cardholder> UpdateAsync(string id, CardholderUpdateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
