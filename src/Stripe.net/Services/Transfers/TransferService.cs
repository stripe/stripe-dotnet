...
namespace Stripe
{
        ...
        IUpdatable<Transfer, TransferUpdateOptions>
    {
        ...
        public virtual Transfer Update(string id, TransferUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.UpdateEntity(id, options, requestOptions);
        }

        public virtual Task<Transfer> UpdateAsync(string id, TransferUpdateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
