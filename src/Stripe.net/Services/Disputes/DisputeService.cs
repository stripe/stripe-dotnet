...
namespace Stripe
{
        ...
        IUpdatable<Dispute, DisputeUpdateOptions>
    {
        ...
        {
            return this.Request<Dispute>(BaseAddress.Api, HttpMethod.Post, $"/v1/disputes/{id}/close", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Dispute>(BaseAddress.Api, HttpMethod.Post, $"/v1/disputes/{id}/close", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Dispute>(BaseAddress.Api, HttpMethod.Get, $"/v1/disputes/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Dispute>(BaseAddress.Api, HttpMethod.Get, $"/v1/disputes/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Dispute>>(BaseAddress.Api, HttpMethod.Get, $"/v1/disputes", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Dispute>>(BaseAddress.Api, HttpMethod.Get, $"/v1/disputes", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Dispute>($"/v1/disputes", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Dispute>($"/v1/disputes", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Dispute>(BaseAddress.Api, HttpMethod.Post, $"/v1/disputes/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Dispute>(BaseAddress.Api, HttpMethod.Post, $"/v1/disputes/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
