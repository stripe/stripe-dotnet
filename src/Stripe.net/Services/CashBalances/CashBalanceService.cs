...
namespace Stripe
{
    ...
    public class CashBalanceService : ServiceNested<CashBalance>
    {
        ...
        {
            return this.Request<CashBalance>(HttpMethod.Get, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/cash_balance", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<CashBalance>(HttpMethod.Get, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/cash_balance", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<CashBalance>(HttpMethod.Post, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/cash_balance", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<CashBalance>(HttpMethod.Post, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/cash_balance", options, requestOptions, cancellationToken);
        }
