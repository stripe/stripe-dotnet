namespace Stripe
{
    ...
    public static class EventUtility
    {
        ...
        public static Event ConstructEvent(
            ...
            string secret,
            long? tolerance = AppSignature.DefaultTimeTolerance,
        ...
        public static void ValidateSignature(string json, string stripeSignatureHeader, string secret, long? tolerance = AppSignature.DefaultTimeTolerance)
        ...
        public static void ValidateSignature(string json, string stripeSignatureHeader, string secret, long? tolerance, long utcNow)
            => AppSignature.ValidateSignature(json, stripeSignatureHeader, secret, tolerance, utcNow);
    }
}
