...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesCustomerDetailsTaxIdOptions : INestedOptions
    {
        ...
        /// <c>br_cpf</c>, <c>by_tin</c>, <c>ca_bn</c>, <c>ca_gst_hst</c>, <c>ca_pst_bc</c>,
        /// <c>ca_pst_mb</c>, <c>ca_pst_sk</c>, <c>ca_qst</c>, <c>ch_uid</c>, <c>ch_vat</c>,
        /// <c>cl_tin</c>, <c>cn_tin</c>, <c>co_nit</c>, <c>cr_tin</c>, <c>de_stn</c>,
        /// <c>do_rcn</c>, <c>ec_ruc</c>, <c>eg_tin</c>, <c>es_cif</c>, <c>eu_oss_vat</c>,
        /// <c>eu_vat</c>, <c>gb_vat</c>, <c>ge_vat</c>, <c>hk_br</c>, <c>hr_oib</c>, <c>hu_tin</c>,
        ...
        /// <c>tz_vat</c>, <c>ua_vat</c>, <c>us_ein</c>, <c>uy_ruc</c>, <c>uz_tin</c>,
        /// <c>uz_vat</c>, <c>ve_rif</c>, <c>vn_tin</c>, or <c>za_vat</c>.
