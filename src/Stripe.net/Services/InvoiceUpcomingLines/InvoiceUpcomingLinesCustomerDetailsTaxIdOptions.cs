...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesCustomerDetailsTaxIdOptions : INestedOptions
    {
        ...
        /// <c>ao_tin</c>, <c>ar_cuit</c>, <c>au_abn</c>, <c>au_arn</c>, <c>ba_tin</c>,
        /// <c>bb_tin</c>, <c>bg_uic</c>, <c>bh_vat</c>, <c>bo_tin</c>, <c>br_cnpj</c>,
        /// <c>br_cpf</c>, <c>bs_tin</c>, <c>by_tin</c>, <c>ca_bn</c>, <c>ca_gst_hst</c>,
        /// <c>ca_pst_bc</c>, <c>ca_pst_mb</c>, <c>ca_pst_sk</c>, <c>ca_qst</c>, <c>cd_nif</c>,
        /// <c>ch_uid</c>, <c>ch_vat</c>, <c>cl_tin</c>, <c>cn_tin</c>, <c>co_nit</c>,
        /// <c>cr_tin</c>, <c>de_stn</c>, <c>do_rcn</c>, <c>ec_ruc</c>, <c>eg_tin</c>,
        /// <c>es_cif</c>, <c>eu_oss_vat</c>, <c>eu_vat</c>, <c>gb_vat</c>, <c>ge_vat</c>,
        /// <c>gn_nif</c>, <c>hk_br</c>, <c>hr_oib</c>, <c>hu_tin</c>, <c>id_npwp</c>,
        /// <c>il_vat</c>, <c>in_gst</c>, <c>is_vat</c>, <c>jp_cn</c>, <c>jp_rn</c>, <c>jp_trn</c>,
        /// <c>ke_pin</c>, <c>kh_tin</c>, <c>kr_brn</c>, <c>kz_bin</c>, <c>li_uid</c>,
        /// <c>li_vat</c>, <c>ma_vat</c>, <c>md_vat</c>, <c>me_pib</c>, <c>mk_vat</c>,
