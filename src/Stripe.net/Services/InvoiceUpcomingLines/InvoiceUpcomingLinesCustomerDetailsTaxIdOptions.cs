...
namespace Stripe
{
    ...
    {
        /// <summary>
        /// Type of the tax ID, one of <c>ad_nrt</c>, <c>ae_trn</c>, <c>am_tin</c>, <c>ao_tin</c>,
        ...
        /// <c>tz_vat</c>, <c>ua_vat</c>, <c>ug_tin</c>, <c>us_ein</c>, <c>uy_ruc</c>,
        /// <c>uz_tin</c>, <c>uz_vat</c>, <c>ve_rif</c>, <c>vn_tin</c>, <c>za_vat</c>,
        /// <c>zm_tin</c>, or <c>zw_tin</c>.
        /// </summary>
        [JsonProperty("type")]
#if NET6_0_OR_GREATER
