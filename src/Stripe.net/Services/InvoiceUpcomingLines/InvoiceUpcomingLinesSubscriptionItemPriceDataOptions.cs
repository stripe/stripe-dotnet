...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesSubscriptionItemPriceDataOptions : INestedOptions
    {
        /// <summary>
        ...
        public InvoiceUpcomingLinesSubscriptionItemPriceDataRecurringOptions Recurring { get; set; }
