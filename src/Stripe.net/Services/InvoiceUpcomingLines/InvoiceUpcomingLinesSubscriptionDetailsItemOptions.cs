...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesSubscriptionDetailsItemOptions : INestedOptions, IHasId, IHasMetadata
    {
        /// <summary>
        ...
        public List<InvoiceUpcomingLinesSubscriptionDetailsItemDiscountOptions> Discounts { get; set; }
        ...
        public InvoiceUpcomingLinesSubscriptionDetailsItemPriceDataOptions PriceData { get; set; }
