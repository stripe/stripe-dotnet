...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesScheduleDetailsPhaseItemPriceDataOptions : INestedOptions
    {
        /// <summary>
        ...
        public InvoiceUpcomingLinesScheduleDetailsPhaseItemPriceDataRecurringOptions Recurring { get; set; }
