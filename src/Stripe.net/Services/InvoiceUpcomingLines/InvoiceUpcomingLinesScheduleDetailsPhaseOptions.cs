...
namespace Stripe
{
    ...
    public class InvoiceUpcomingLinesScheduleDetailsPhaseOptions : INestedOptions, IHasMetadata
    {
        ...
        public InvoiceUpcomingLinesScheduleDetailsPhasePauseCollectionOptions PauseCollection { get; set; }
        ...
        public InvoiceUpcomingLinesScheduleDetailsPhaseTrialSettingsOptions TrialSettings { get; set; }
    }
}
