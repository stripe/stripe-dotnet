namespace Stripe
{
            ...
            IDeletable<EphemeralKey, EphemeralKeyDeleteOptions>
    {
        ...
        public virtual EphemeralKey Create(
            EphemeralKeyCreateOptions options,
        ...
        )
        {
            if (options.StripeVersion == null)
            {
                throw new System.ArgumentException(
                    "The StripeVersion parameter has to be set when creating an Ephemeral Key",
                    "StripeVersion"
                );
            }
            ...
            return this.Request<EphemeralKey>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/ephemeral_keys",
                options,
        ...
        public virtual Task<EphemeralKey> CreateAsync(
            EphemeralKeyCreateOptions options,
            RequestOptions requestOptions = null,
        ...
        )
        {
            ...
            return this.RequestAsync<EphemeralKey>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/ephemeral_keys",
                options,
        ...
        public virtual EphemeralKey Delete(
            string id,
            EphemeralKeyDeleteOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<EphemeralKey>(
                BaseAddress.Api,
                HttpMethod.Delete,
                $"/v1/ephemeral_keys/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }

        public virtual Task<EphemeralKey> DeleteAsync(
            string id,
            EphemeralKeyDeleteOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
