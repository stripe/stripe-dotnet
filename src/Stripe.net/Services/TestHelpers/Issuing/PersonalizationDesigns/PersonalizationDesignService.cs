...
namespace Stripe.TestHelpers.Issuing
{
    ...
    public class PersonalizationDesignService : Service<Stripe.Issuing.PersonalizationDesign>
    {
        ...
        {
            return this.Request<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/activate", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/activate", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/deactivate", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/deactivate", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/reject", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Issuing.PersonalizationDesign>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/issuing/personalization_designs/{id}/reject", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
