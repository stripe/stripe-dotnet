...
namespace Stripe.TestHelpers.Treasury
{
    ...
    public class ReceivedCreditService : Service
    {
        ...
        /// </summary>
        public virtual Stripe.Treasury.ReceivedCredit Create(
            ReceivedCreditCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Stripe.Treasury.ReceivedCredit>(
                BaseAddress.Api,
                HttpMethod.Post,
        ...
        /// In live mode, you can’t directly create ReceivedCredits initiated by third parties.</p>.
        /// </summary>
        public virtual Task<Stripe.Treasury.ReceivedCredit> CreateAsync(
            ReceivedCreditCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<Stripe.Treasury.ReceivedCredit>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/test_helpers/treasury/received_credits",
                options,
