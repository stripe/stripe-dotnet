...
namespace Stripe.TestHelpers.Treasury
{
    ...
    public class OutboundPaymentService : Service<Stripe.Treasury.OutboundPayment>
    {
        ...
        {
            return this.Request<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/fail", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/fail", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/post", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/post", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/return", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Stripe.Treasury.OutboundPayment>(BaseAddress.Api, HttpMethod.Post, $"/v1/test_helpers/treasury/outbound_payments/{id}/return", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
