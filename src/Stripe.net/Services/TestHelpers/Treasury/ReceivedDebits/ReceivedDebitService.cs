...
namespace Stripe.TestHelpers.Treasury
{
    ...
    public class ReceivedDebitService : Service
    {
        ...
        /// </summary>
        public virtual Stripe.Treasury.ReceivedDebit Create(
            ReceivedDebitCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Stripe.Treasury.ReceivedDebit>(
                BaseAddress.Api,
                HttpMethod.Post,
        ...
        /// In live mode, you can’t directly create ReceivedDebits initiated by third parties.</p>.
        /// </summary>
        public virtual Task<Stripe.Treasury.ReceivedDebit> CreateAsync(
            ReceivedDebitCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<Stripe.Treasury.ReceivedDebit>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/test_helpers/treasury/received_debits",
                options,
