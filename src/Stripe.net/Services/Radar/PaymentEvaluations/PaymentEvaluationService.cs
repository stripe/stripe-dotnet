...
namespace Stripe.Radar
{
    ...
    public class PaymentEvaluationService
        : Service,
            ICreatable<PaymentEvaluation, PaymentEvaluationCreateOptions>
    {
        ...
        /// </summary>
        public virtual PaymentEvaluation Create(
            PaymentEvaluationCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<PaymentEvaluation>(
                BaseAddress.Api,
                HttpMethod.Post,
        ...
        /// external processor authorization.</p>.
        /// </summary>
        public virtual Task<PaymentEvaluation> CreateAsync(
            PaymentEvaluationCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<PaymentEvaluation>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/radar/payment_evaluations",
                options,
