...
namespace Stripe.Climate
{
            ...
            IUpdatable<Order, OrderUpdateOptions>
    {
        ...
        /// </summary>
        public virtual Order Cancel(
            string id,
            OrderCancelOptions options = null,
        ...
        )
        {
            return this.Request<Order>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/climate/orders/{WebUtility.UrlEncode(id)}/cancel",
                options,
                requestOptions
            );
        }
        ...
        /// refunds the <c>amount_total</c>.</p>.
        /// </summary>
        public virtual Task<Order> CancelAsync(
            string id,
            OrderCancelOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<Order>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/climate/orders/{WebUtility.UrlEncode(id)}/cancel",
                options,
        ...
        /// balance.</p>.
        /// </summary>
        public virtual Task<Order> CreateAsync(
            OrderCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        ...
        )
        {
            return this.Request<Order>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/climate/orders/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// <p>Retrieves the details of a Climate order object with the given ID.</p>.
        /// </summary>
        public virtual Task<Order> GetAsync(
            string id,
            OrderGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual StripeList<Order> List(
            OrderListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Order>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/climate/orders",
                options,
        ...
        /// with the most recently created orders appearing first.</p>.
        /// </summary>
        public virtual Task<StripeList<Order>> ListAsync(
            OrderListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<Order>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/climate/orders",
                options,
        ...
        /// with the most recently created orders appearing first.</p>.
        /// </summary>
        public virtual IEnumerable<Order> ListAutoPaging(
            OrderListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<Order>(
                $"/v1/climate/orders",
                options,
                requestOptions
            );
        ...
        /// with the most recently created orders appearing first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Order> ListAutoPagingAsync(
            OrderListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<Order>(
                $"/v1/climate/orders",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual Order Update(
            string id,
            OrderUpdateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Order>(
        ...
        /// <p>Updates the specified order by setting the values of the parameters passed.</p>.
        /// </summary>
        public virtual Task<Order> UpdateAsync(
            string id,
            OrderUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
