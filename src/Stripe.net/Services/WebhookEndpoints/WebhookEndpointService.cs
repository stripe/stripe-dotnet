...
namespace Stripe
{
        ...
        IUpdatable<WebhookEndpoint, WebhookEndpointUpdateOptions>
    {
        ...
        {
            return this.Request<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Post, $"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Post, $"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Delete, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Delete, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Get, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Get, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<WebhookEndpoint>>(BaseAddress.Api, HttpMethod.Get, $"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<WebhookEndpoint>>(BaseAddress.Api, HttpMethod.Get, $"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<WebhookEndpoint>($"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<WebhookEndpoint>($"/v1/webhook_endpoints", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Post, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<WebhookEndpoint>(BaseAddress.Api, HttpMethod.Post, $"/v1/webhook_endpoints/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
