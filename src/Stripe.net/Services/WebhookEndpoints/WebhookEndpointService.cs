...
namespace Stripe
{
        ...
        IUpdatable<WebhookEndpoint, WebhookEndpointUpdateOptions>
    {
        ...
        public virtual WebhookEndpoint Update(string id, WebhookEndpointUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.UpdateEntity(id, options, requestOptions);
        }

        public virtual Task<WebhookEndpoint> UpdateAsync(string id, WebhookEndpointUpdateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
