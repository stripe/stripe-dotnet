namespace Stripe
{
    ...
    public class BankAccountService : StripeService
    {
        ...
        public virtual BankAccount Delete(string customerId, string bankAccountId, StripeRequestOptions requestOptions = null)
        {
            return Mapper<BankAccount>.MapFromJson(
                Requestor.Delete(
                    this.ApplyAllParameters(null, $"{Urls.BaseUrl}/customers/{customerId}/sources/{bankAccountId}"),
        ...
        public virtual async Task<BankAccount> DeleteAsync(string customerId, string bankAccountId, StripeRequestOptions requestOptions = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return Mapper<BankAccount>.MapFromJson(
