...
namespace Stripe
{
        ...
        IUpdatable<FileLink, FileLinkUpdateOptions>
    {
        ...
        {
            return this.Request<FileLink>(BaseAddress.Api, HttpMethod.Post, $"/v1/file_links", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FileLink>(BaseAddress.Api, HttpMethod.Post, $"/v1/file_links", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FileLink>(BaseAddress.Api, HttpMethod.Get, $"/v1/file_links/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FileLink>(BaseAddress.Api, HttpMethod.Get, $"/v1/file_links/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<FileLink>>(BaseAddress.Api, HttpMethod.Get, $"/v1/file_links", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<FileLink>>(BaseAddress.Api, HttpMethod.Get, $"/v1/file_links", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<FileLink>($"/v1/file_links", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<FileLink>($"/v1/file_links", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FileLink>(BaseAddress.Api, HttpMethod.Post, $"/v1/file_links/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FileLink>(BaseAddress.Api, HttpMethod.Post, $"/v1/file_links/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
