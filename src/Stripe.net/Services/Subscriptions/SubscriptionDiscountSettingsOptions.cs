...
namespace Stripe
{
    ...
    public class SubscriptionDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
