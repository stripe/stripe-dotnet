namespace Stripe
{
    ...
    public class SubscriptionCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// does not create a subscription and returns an error instead. This
        /// was the default behavior for API versions prior to 2019-03-14.
        /// See the <a href="https://stripe.com/docs/upgrades#2019-03-14">changelog</a>
        /// to learn more.
        /// </para>
        /// </summary>
