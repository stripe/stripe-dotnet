...
namespace Stripe
{
    ...
    public class SubscriptionItemDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionItemDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
