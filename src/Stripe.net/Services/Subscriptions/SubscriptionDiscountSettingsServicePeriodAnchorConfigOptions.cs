...
namespace Stripe
{
    ...
    public class SubscriptionDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
