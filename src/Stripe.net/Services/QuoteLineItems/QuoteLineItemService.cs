...
namespace Stripe
{
    ...
    public class QuoteLineItemService : Service, INestedListable<LineItem, QuoteLineItemListOptions>
    {
        ...
        /// </summary>
        public virtual StripeList<LineItem> List(
            string parentId,
        ...
        )
        {
            return this.Request<StripeList<LineItem>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/quotes/{WebUtility.UrlEncode(parentId)}/line_items",
                options,
                requestOptions
            );
        }
        ...
        /// the full (paginated) list of line items.</p>.
        /// </summary>
        public virtual Task<StripeList<LineItem>> ListAsync(
            string parentId,
            QuoteLineItemListOptions options = null,
            RequestOptions requestOptions = null,
        ...
        /// the full (paginated) list of line items.</p>.
        /// </summary>
        public virtual IEnumerable<LineItem> ListAutoPaging(
            string parentId,
            QuoteLineItemListOptions options = null,
            RequestOptions requestOptions = null
        )
        ...
        /// the full (paginated) list of line items.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<LineItem> ListAutoPagingAsync(
            string parentId,
            QuoteLineItemListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
