...
namespace Stripe
{
    ...
    public class CustomerFundingInstructionsService : Service
    {
        ...
        /// </summary>
        public virtual FundingInstructions Create(
            string parentId,
        ...
        )
        {
            return this.Request<FundingInstructions>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/funding_instructions",
                options,
                requestOptions
            );
        }
        ...
        /// instructions each time.</p>.
        /// </summary>
        public virtual Task<FundingInstructions> CreateAsync(
            string parentId,
            CustomerFundingInstructionsCreateOptions options = null,
            RequestOptions requestOptions = null,
