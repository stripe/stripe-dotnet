...
namespace Stripe
{
            ...
            IUpdatable<Charge, ChargeUpdateOptions>
    {
        ...
        /// PaymentIntent</a>.</p>.
        /// </summary>
        public virtual Charge Capture(
            string id,
            ChargeCaptureOptions options = null,
        ...
        )
        {
            return this.Request<Charge>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/charges/{WebUtility.UrlEncode(id)}/capture",
                options,
                requestOptions
            );
        }
        ...
        /// PaymentIntent</a>.</p>.
        /// </summary>
        public virtual Task<Charge> CaptureAsync(
            string id,
            ChargeCaptureOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<Charge>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/charges/{WebUtility.UrlEncode(id)}/capture",
                options,
        ...
        /// used to request payment.</p>.
        /// </summary>
        public virtual Task<Charge> CreateAsync(
            ChargeCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        ...
        )
        {
            return this.Request<Charge>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/charges/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// refunding the charge.</p>.
        /// </summary>
        public virtual Task<Charge> GetAsync(
            string id,
            ChargeGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual StripeList<Charge> List(
            ChargeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Charge>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/charges",
                options,
        ...
        /// sorted order, with the most recent charges appearing first.</p>.
        /// </summary>
        public virtual Task<StripeList<Charge>> ListAsync(
            ChargeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<Charge>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/charges",
                options,
        ...
        /// sorted order, with the most recent charges appearing first.</p>.
        /// </summary>
        public virtual IEnumerable<Charge> ListAutoPaging(
            ChargeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
        ...
        /// sorted order, with the most recent charges appearing first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Charge> ListAutoPagingAsync(
            ChargeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<Charge>(
                $"/v1/charges",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual StripeSearchResult<Charge> Search(
            ChargeSearchOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeSearchResult<Charge>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/charges/search",
                options,
        ...
        /// functionality is not available to merchants in India.</p>.
        /// </summary>
        public virtual Task<StripeSearchResult<Charge>> SearchAsync(
            ChargeSearchOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeSearchResult<Charge>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/charges/search",
                options,
        ...
        /// functionality is not available to merchants in India.</p>.
        /// </summary>
        public virtual IEnumerable<Charge> SearchAutoPaging(
            ChargeSearchOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.SearchRequestAutoPaging<Charge>(
                $"/v1/charges/search",
                options,
                requestOptions
            );
        ...
        /// functionality is not available to merchants in India.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Charge> SearchAutoPagingAsync(
            ChargeSearchOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.SearchRequestAutoPagingAsync<Charge>(
                $"/v1/charges/search",
                options,
                requestOptions,
                cancellationToken
        ...
        /// parameters not provided will be left unchanged.</p>.
        /// </summary>
        public virtual Task<Charge> UpdateAsync(
            string id,
            ChargeUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
