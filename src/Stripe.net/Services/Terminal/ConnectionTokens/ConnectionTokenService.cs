...
namespace Stripe.Terminal
{
            ...
            ICreatable<ConnectionToken, ConnectionTokenCreateOptions>
    {
        ...
        /// </summary>
        public virtual ConnectionToken Create(
            ConnectionTokenCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<ConnectionToken>(
                BaseAddress.Api,
                HttpMethod.Post,
        ...
        /// endpoint that creates and returns a connection token.</p>.
        /// </summary>
        public virtual Task<ConnectionToken> CreateAsync(
            ConnectionTokenCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<ConnectionToken>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/terminal/connection_tokens",
                options,
