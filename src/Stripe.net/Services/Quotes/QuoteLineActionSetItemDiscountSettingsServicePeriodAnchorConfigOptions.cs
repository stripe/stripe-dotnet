...
namespace Stripe
{
    ...
    public class QuoteLineActionSetItemDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteLineActionSetItemDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
