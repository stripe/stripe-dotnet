...
namespace Stripe
{
    ...
    public class QuoteLineActionAddDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteLineActionAddDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
