...
namespace Stripe
{
    ...
    public class QuoteSubscriptionDataBillingScheduleBillFromOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteSubscriptionDataBillingScheduleBillFromLineStartsAtOptions LineStartsAt { get; set; }
