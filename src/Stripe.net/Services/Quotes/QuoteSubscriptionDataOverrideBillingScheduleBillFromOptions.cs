...
namespace Stripe
{
    ...
    public class QuoteSubscriptionDataOverrideBillingScheduleBillFromOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteSubscriptionDataOverrideBillingScheduleBillFromLineStartsAtOptions LineStartsAt { get; set; }
