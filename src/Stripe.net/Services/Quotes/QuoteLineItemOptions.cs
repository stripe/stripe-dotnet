...
namespace Stripe
{
    ...
    public class QuoteLineItemOptions : INestedOptions, IHasId, IHasSetTracking
    {
        private List<QuoteLineItemDiscountOptions> discounts;
        ...
        public List<QuoteLineItemDiscountOptions> Discounts
        {
            get => this.discounts;
            set
            {
