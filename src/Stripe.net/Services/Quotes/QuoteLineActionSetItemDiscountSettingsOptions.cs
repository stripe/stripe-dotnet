...
namespace Stripe
{
    ...
    public class QuoteLineActionSetItemDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteLineActionSetItemDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
