...
namespace Stripe
{
    ...
    public class QuoteLineActionAddDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteLineActionAddDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
