...
namespace Stripe
{
    ...
    public class QuoteLineActionSetDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public QuoteLineActionSetDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
