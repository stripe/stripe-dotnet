...
namespace Stripe
{
    ...
    public class QuoteLineActionAddItemOptions : INestedOptions, IHasMetadata
    {
        /// <summary>
...
#endif
        public List<QuoteLineActionAddItemDiscountOptions> Discounts { get; set; }
...
#endif
        public QuoteLineActionAddItemTrialOptions Trial { get; set; }
    }
}
