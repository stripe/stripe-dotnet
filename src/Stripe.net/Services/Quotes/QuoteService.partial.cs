namespace Stripe
{
    ...
    public partial class QuoteService
    {
        ...
        public virtual StripeList<LineItem> ListComputedUpfrontLineItems(
            string id,
            QuoteComputedUpfrontLineItemsListOptions options = null,
        ...
        )
        {
            return this.Request<StripeList<LineItem>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/quotes/{WebUtility.UrlEncode(id)}/computed_upfront_line_items",
                options,
                requestOptions
            );
        }
        ...
        public virtual Task<StripeList<LineItem>> ListComputedUpfrontLineItemsAsync(
            string id,
            QuoteComputedUpfrontLineItemsListOptions options = null,
            RequestOptions requestOptions = null,
        ...
        public virtual IEnumerable<LineItem> ListComputedUpfrontLineItemsAutoPaging(
            string id,
            QuoteComputedUpfrontLineItemsListOptions options = null,
            RequestOptions requestOptions = null
        )
        ...
        public virtual IAsyncEnumerable<LineItem> ListComputedUpfrontLineItemsAutoPagingAsync(
            string id,
            QuoteComputedUpfrontLineItemsListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        public virtual StripeList<LineItem> ListLineItems(
            string id,
            QuoteLineItemListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<LineItem>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/quotes/{WebUtility.UrlEncode(id)}/line_items",
                options,
                requestOptions
            );
        }
