...
namespace Stripe
{
            ...
            IRetrievable<TaxCode, TaxCodeGetOptions>
    {
        ...
        /// </summary>
        public virtual TaxCode Get(
            string id,
            TaxCodeGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<TaxCode>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/tax_codes/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// Stripe will return the corresponding tax code information.</p>.
        /// </summary>
        public virtual Task<TaxCode> GetAsync(
            string id,
            TaxCodeGetOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<TaxCode>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/tax_codes/{WebUtility.UrlEncode(id)}",
                options,
        ...
        /// </summary>
        public virtual StripeList<TaxCode> List(
            TaxCodeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<TaxCode>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/tax_codes",
                options,
        ...
        /// available</a> to add to Products in order to allow specific tax calculations.</p>.
        /// </summary>
        public virtual Task<StripeList<TaxCode>> ListAsync(
            TaxCodeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<TaxCode>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/tax_codes",
                options,
        ...
        /// available</a> to add to Products in order to allow specific tax calculations.</p>.
        /// </summary>
        public virtual IEnumerable<TaxCode> ListAutoPaging(
            TaxCodeListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
        ...
        /// available</a> to add to Products in order to allow specific tax calculations.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<TaxCode> ListAutoPagingAsync(
            TaxCodeListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<TaxCode>(
                $"/v1/tax_codes",
                options,
                requestOptions,
                cancellationToken
