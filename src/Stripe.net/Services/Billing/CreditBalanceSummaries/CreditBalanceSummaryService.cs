...
namespace Stripe.Billing
{
    ...
    public class CreditBalanceSummaryService : Service, ISingletonRetrievable<CreditBalanceSummary>
    {
        ...
        {
            return this.Request<CreditBalanceSummary>(
                BaseAddress.Api,
                HttpMethod.Get,
        ...
        /// <p>Retrieves the credit balance summary for a customer.</p>.
        /// </summary>
        public virtual Task<CreditBalanceSummary> GetAsync(
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<CreditBalanceSummary>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/billing/credit_balance_summary",
                null,
        ...
        /// <p>Retrieves the credit balance summary for a customer.</p>.
        /// </summary>
        public virtual CreditBalanceSummary Get(
            CreditBalanceSummaryGetOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<CreditBalanceSummary>(
