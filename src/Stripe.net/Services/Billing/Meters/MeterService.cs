...
namespace Stripe.Billing
{
        ...
        IUpdatable<Meter, MeterUpdateOptions>
    {
        ...
        {
            return this.Request<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}/deactivate", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}/deactivate", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Meter>(BaseAddress.Api, HttpMethod.Get, $"/v1/billing/meters/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Meter>(BaseAddress.Api, HttpMethod.Get, $"/v1/billing/meters/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Meter>>(BaseAddress.Api, HttpMethod.Get, $"/v1/billing/meters", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Meter>>(BaseAddress.Api, HttpMethod.Get, $"/v1/billing/meters", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Meter>($"/v1/billing/meters", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Meter>($"/v1/billing/meters", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}/reactivate", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}/reactivate", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Meter>(BaseAddress.Api, HttpMethod.Post, $"/v1/billing/meters/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
