...
namespace Stripe
{
    ...
    public class OrderPaymentSettingsPaymentMethodOptionsKlarnaSubscriptionOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public OrderPaymentSettingsPaymentMethodOptionsKlarnaSubscriptionNextBillingOptions NextBilling { get; set; }
