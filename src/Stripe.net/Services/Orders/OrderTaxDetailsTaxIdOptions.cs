...
namespace Stripe
{
    ...
    public class OrderTaxDetailsTaxIdOptions : INestedOptions
    {
        ...
        /// <c>ca_pst_sk</c>, <c>ca_qst</c>, <c>ch_vat</c>, <c>cl_tin</c>, <c>cn_tin</c>,
        /// <c>co_nit</c>, <c>cr_tin</c>, <c>do_rcn</c>, <c>ec_ruc</c>, <c>eg_tin</c>,
        ...
        /// <c>kz_bin</c>, <c>li_uid</c>, <c>mx_rfc</c>, <c>my_frp</c>, <c>my_itn</c>,
        ...
        /// <c>jp_cn</c>, <c>jp_rn</c>, <c>jp_trn</c>, <c>ke_pin</c>, <c>kr_brn</c>, <c>kz_bin</c>,
        /// <c>li_uid</c>, <c>mx_rfc</c>, <c>my_frp</c>, <c>my_itn</c>, <c>my_sst</c>,
        /// <c>ng_tin</c>, <c>no_vat</c>, <c>no_voec</c>, <c>nz_gst</c>, <c>om_vat</c>,
