...
namespace Stripe
{
    ...
    public class OrderPaymentSettingsPaymentMethodOptionsPaypalOptions : INestedOptions, IHasSetTracking
    {
        ...
        public List<OrderPaymentSettingsPaymentMethodOptionsPaypalLineItemOptions> LineItems { get; set; }
