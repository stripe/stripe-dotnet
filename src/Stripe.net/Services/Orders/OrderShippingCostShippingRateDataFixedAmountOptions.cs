...
namespace Stripe
{
    ...
    public class OrderShippingCostShippingRateDataFixedAmountOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public Dictionary<string, OrderShippingCostShippingRateDataFixedAmountCurrencyOptionsOptions> CurrencyOptions { get; set; }
    }
}
