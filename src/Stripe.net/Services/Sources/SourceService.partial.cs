namespace Stripe
{
        ...
        INestedListable<Source, SourceListOptions>
    {
        ...
        {
            return this.Request<Source>(BaseAddress.Api, HttpMethod.Post, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<Source>(BaseAddress.Api, HttpMethod.Post, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<Source>(BaseAddress.Api, HttpMethod.Delete, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources/{WebUtility.UrlEncode(id)}", null, requestOptions);
        }
        ...
        {
            return this.RequestAsync<Source>(BaseAddress.Api, HttpMethod.Delete, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources/{WebUtility.UrlEncode(id)}", null, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Source>>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options ?? new SourceListOptions(), requestOptions);
        }
        ...
        {
            return this.RequestAsync<StripeList<Source>>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options ?? new SourceListOptions(), requestOptions, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Source>($"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options ?? new SourceListOptions(), requestOptions);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Source>($"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources", options ?? new SourceListOptions(), requestOptions, cancellationToken);
        }
    }
}
