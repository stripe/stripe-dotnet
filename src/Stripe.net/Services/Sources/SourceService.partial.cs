namespace Stripe
{
            ...
            INestedListable<Source, SourceListOptions>
    {
        ...
        public virtual Source Attach(
            string parentId,
            SourceAttachOptions options = null,
        ...
        public virtual Task<Source> AttachAsync(
            string parentId,
            SourceAttachOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<Source>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources",
                options,
        ...
        public virtual Source Detach(
            string parentId,
            string id,
            SourceDetachOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Source>(
        ...
        public virtual Task<Source> DetachAsync(
            string parentId,
            string id,
            SourceDetachOptions options = null,
            RequestOptions requestOptions = null,
        ...
        public virtual StripeList<Source> List(
            string parentId,
            SourceListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Source>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources",
                options ?? new SourceListOptions(),
                requestOptions
            );
        }

        [Obsolete("Use CustomerPaymentSourceService.ListAsync instead.")]
        public virtual Task<StripeList<Source>> ListAsync(
            string parentId,
            SourceListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.RequestAsync<StripeList<Source>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources",
                options ?? new SourceListOptions(),
        ...
        public virtual IEnumerable<Source> ListAutoPaging(
            string parentId,
            SourceListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<Source>(
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources",
                options ?? new SourceListOptions(),
                requestOptions
            );
        ...
        public virtual IAsyncEnumerable<Source> ListAutoPagingAsync(
            string parentId,
            SourceListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        {
            return this.ListRequestAutoPagingAsync<Source>(
                $"/v1/customers/{WebUtility.UrlEncode(parentId)}/sources",
                options ?? new SourceListOptions(),
                requestOptions,
                cancellationToken
