...
namespace Stripe
{
        ...
        IUpdatable<SubscriptionItem, SubscriptionItemUpdateOptions>
    {
        ...
        {
            return this.Request<SubscriptionItem>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionItem>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionItem>(BaseAddress.Api, HttpMethod.Delete, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionItem>(BaseAddress.Api, HttpMethod.Delete, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionItem>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionItem>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<SubscriptionItem>>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_items", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<SubscriptionItem>>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_items", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<SubscriptionItem>($"/v1/subscription_items", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<SubscriptionItem>($"/v1/subscription_items", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionItem>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionItem>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
