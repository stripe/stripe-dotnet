...
namespace Stripe
{
        ...
        INestedRetrievable<TaxId, TaxIdGetOptions>
    {
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Post, $"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Post, $"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Post, $"/v1/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Post, $"/v1/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Delete, $"/v1/customers/{parentId}/tax_ids/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Delete, $"/v1/customers/{parentId}/tax_ids/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Delete, $"/v1/tax_ids/{parentId}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Delete, $"/v1/tax_ids/{parentId}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{parentId}/tax_ids/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{parentId}/tax_ids/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<TaxId>(BaseAddress.Api, HttpMethod.Get, $"/v1/tax_ids/{parentId}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<TaxId>(BaseAddress.Api, HttpMethod.Get, $"/v1/tax_ids/{parentId}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<TaxId>>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<TaxId>>(BaseAddress.Api, HttpMethod.Get, $"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<TaxId>($"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<TaxId>($"/v1/customers/{parentId}/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<TaxId>>(BaseAddress.Api, HttpMethod.Get, $"/v1/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<TaxId>>(BaseAddress.Api, HttpMethod.Get, $"/v1/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<TaxId>($"/v1/tax_ids", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<TaxId>($"/v1/tax_ids", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
