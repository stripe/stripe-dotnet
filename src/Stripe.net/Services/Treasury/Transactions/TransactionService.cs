...
namespace Stripe.Treasury
{
        ...
        IRetrievable<Transaction, TransactionGetOptions>
    {
        ...
        {
            return this.Request<Transaction>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/transactions/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Transaction>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/transactions/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Transaction>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/transactions", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Transaction>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/transactions", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Transaction>($"/v1/treasury/transactions", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Transaction>($"/v1/treasury/transactions", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
