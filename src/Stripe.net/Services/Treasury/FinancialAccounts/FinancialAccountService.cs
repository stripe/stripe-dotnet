...
namespace Stripe.Treasury
{
        ...
        IUpdatable<FinancialAccount, FinancialAccountUpdateOptions>
    {
        ...
        {
            return this.Request<FinancialAccount>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FinancialAccount>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FinancialAccount>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FinancialAccount>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<FinancialAccount>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<FinancialAccount>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<FinancialAccount>($"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<FinancialAccount>($"/v1/treasury/financial_accounts", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FinancialAccountFeatures>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts/{id}/features", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FinancialAccountFeatures>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/financial_accounts/{id}/features", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FinancialAccount>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FinancialAccount>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<FinancialAccountFeatures>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts/{id}/features", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<FinancialAccountFeatures>(BaseAddress.Api, HttpMethod.Post, $"/v1/treasury/financial_accounts/{id}/features", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
