...
namespace Stripe.Treasury
{
        ...
        IRetrievable<ReceivedDebit, ReceivedDebitGetOptions>
    {
        ...
        {
            return this.Request<ReceivedDebit>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/received_debits/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<ReceivedDebit>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/received_debits/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<ReceivedDebit>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/received_debits", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<ReceivedDebit>>(BaseAddress.Api, HttpMethod.Get, $"/v1/treasury/received_debits", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<ReceivedDebit>($"/v1/treasury/received_debits", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<ReceivedDebit>($"/v1/treasury/received_debits", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
