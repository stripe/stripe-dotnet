...
namespace Stripe.V2.MoneyManagement
{
    ...
    public class PayoutIntentUpdateToPayoutMethodOptionsBankAccountOptions : INestedOptions
    {
        /// <summary>
        ...
        public PayoutIntentUpdateToPayoutMethodOptionsBankAccountPreferredNetworkOptionsOptions PreferredNetworkOptions { get; set; }
