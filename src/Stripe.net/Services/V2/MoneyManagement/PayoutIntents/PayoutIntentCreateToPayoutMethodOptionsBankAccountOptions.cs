...
namespace Stripe.V2.MoneyManagement
{
    ...
    public class PayoutIntentCreateToPayoutMethodOptionsBankAccountOptions : INestedOptions
    {
        /// <summary>
        ...
        public PayoutIntentCreateToPayoutMethodOptionsBankAccountPreferredNetworkOptionsOptions PreferredNetworkOptions { get; set; }
