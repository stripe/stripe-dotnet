...
namespace Stripe.V2.MoneyManagement
{
    ...
    public class OutboundPaymentCreateToPayoutMethodOptionsBankAccountOptions : INestedOptions
    {
        /// <summary>
        ...
        public OutboundPaymentCreateToPayoutMethodOptionsBankAccountPreferredNetworkOptionsOptions PreferredNetworkOptions { get; set; }
