...
namespace Stripe.V2.Signals
{
    ...
    public class AccountActivityCreateLoginAttemptClientDetailsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountActivityCreateLoginAttemptClientDetailsDataOptions Data { get; set; }
