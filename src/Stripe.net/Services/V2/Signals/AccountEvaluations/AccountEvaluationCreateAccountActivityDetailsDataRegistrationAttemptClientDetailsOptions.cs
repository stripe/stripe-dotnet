...
namespace Stripe.V2.Signals
{
    ...
    public class AccountEvaluationCreateAccountActivityDetailsDataRegistrationAttemptClientDetailsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountEvaluationCreateAccountActivityDetailsDataRegistrationAttemptClientDetailsDataOptions Data { get; set; }
