...
namespace Stripe.V2.Payments
{
    ...
    public class OffSessionPaymentCaptureAmountDetailsLineItemOptions : INestedOptions
    {
        /// <summary>
        ...
        public OffSessionPaymentCaptureAmountDetailsLineItemTaxOptions Tax { get; set; }
