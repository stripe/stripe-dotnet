...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardProtectionsOptions Protections { get; set; }
