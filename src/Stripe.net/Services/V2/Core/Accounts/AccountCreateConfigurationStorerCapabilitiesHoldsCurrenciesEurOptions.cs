...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationStorerCapabilitiesHoldsCurrenciesEurOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationStorerCapabilitiesHoldsCurrenciesEurProtectionsOptions Protections { get; set; }
