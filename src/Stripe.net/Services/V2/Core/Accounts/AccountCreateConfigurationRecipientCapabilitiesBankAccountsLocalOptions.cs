...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationRecipientCapabilitiesBankAccountsLocalOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationRecipientCapabilitiesBankAccountsLocalProtectionsOptions Protections { get; set; }
