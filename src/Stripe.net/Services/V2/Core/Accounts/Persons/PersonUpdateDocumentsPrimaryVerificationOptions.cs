...
namespace Stripe.V2.Core.Accounts
{
    ...
    public class PersonUpdateDocumentsPrimaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PersonUpdateDocumentsPrimaryVerificationFrontBackOptions FrontBack { get; set; }
