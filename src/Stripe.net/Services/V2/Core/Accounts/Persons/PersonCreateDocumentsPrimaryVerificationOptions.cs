...
namespace Stripe.V2.Core.Accounts
{
    ...
    public class PersonCreateDocumentsPrimaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PersonCreateDocumentsPrimaryVerificationFrontBackOptions FrontBack { get; set; }
