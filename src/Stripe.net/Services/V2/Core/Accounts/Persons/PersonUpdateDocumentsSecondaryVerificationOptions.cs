...
namespace Stripe.V2.Core.Accounts
{
    ...
    public class PersonUpdateDocumentsSecondaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PersonUpdateDocumentsSecondaryVerificationFrontBackOptions FrontBack { get; set; }
