...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesConsumerLeadPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesConsumerLeadPrepaidCardProtectionsOptions Protections { get; set; }
