...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankPrepaidCardProtectionsOptions Protections { get; set; }
