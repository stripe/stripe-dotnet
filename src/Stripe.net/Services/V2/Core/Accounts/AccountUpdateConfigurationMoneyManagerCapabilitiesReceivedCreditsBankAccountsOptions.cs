...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsProtectionsOptions Protections { get; set; }
