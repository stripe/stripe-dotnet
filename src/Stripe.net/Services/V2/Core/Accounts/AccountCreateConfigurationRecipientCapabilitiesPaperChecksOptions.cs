...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationRecipientCapabilitiesPaperChecksOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationRecipientCapabilitiesPaperChecksProtectionsOptions Protections { get; set; }
