...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesCommercialLeadPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesCommercialLeadPrepaidCardProtectionsOptions Protections { get; set; }
