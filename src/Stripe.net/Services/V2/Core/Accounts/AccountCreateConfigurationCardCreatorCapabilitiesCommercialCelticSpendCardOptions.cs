...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardProtectionsOptions Protections { get; set; }
