...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantCapabilitiesP24PaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMerchantCapabilitiesP24PaymentsProtectionsOptions Protections { get; set; }
