...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardProtectionsOptions Protections { get; set; }
