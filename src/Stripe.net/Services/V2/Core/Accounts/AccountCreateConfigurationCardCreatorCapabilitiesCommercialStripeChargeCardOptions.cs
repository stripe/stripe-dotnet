...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesCommercialStripeChargeCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesCommercialStripeChargeCardProtectionsOptions Protections { get; set; }
