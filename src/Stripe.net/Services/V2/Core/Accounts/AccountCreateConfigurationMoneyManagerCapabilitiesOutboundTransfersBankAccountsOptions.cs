...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsProtectionsOptions Protections { get; set; }
