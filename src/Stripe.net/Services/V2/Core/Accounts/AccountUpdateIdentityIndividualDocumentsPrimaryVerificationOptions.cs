...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateIdentityIndividualDocumentsPrimaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountUpdateIdentityIndividualDocumentsPrimaryVerificationFrontBackOptions FrontBack { get; set; }
