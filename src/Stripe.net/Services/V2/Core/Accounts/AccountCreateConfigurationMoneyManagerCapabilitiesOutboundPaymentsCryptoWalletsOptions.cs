...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsProtectionsOptions Protections { get; set; }
