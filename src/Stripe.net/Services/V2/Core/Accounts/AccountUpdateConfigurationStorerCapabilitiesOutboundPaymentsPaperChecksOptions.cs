...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksProtectionsOptions Protections { get; set; }
