...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundTransfersFinancialAccountsProtectionsOptions Protections { get; set; }
