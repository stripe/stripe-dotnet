...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMerchantCapabilitiesBancontactPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMerchantCapabilitiesBancontactPaymentsProtectionsOptions Protections { get; set; }
