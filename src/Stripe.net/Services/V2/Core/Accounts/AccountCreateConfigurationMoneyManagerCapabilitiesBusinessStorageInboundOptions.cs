...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundOptions : INestedOptions
    {
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundOusdOptions Ousd { get; set; }
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdcOptions Usdc { get; set; }
    }
}
