...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesCommercialCelticSpendCardProtectionsOptions Protections { get; set; }
