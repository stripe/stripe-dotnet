...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationDeveloperCapabilitiesProjectsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationDeveloperCapabilitiesProjectsProtectionsOptions Protections { get; set; }
