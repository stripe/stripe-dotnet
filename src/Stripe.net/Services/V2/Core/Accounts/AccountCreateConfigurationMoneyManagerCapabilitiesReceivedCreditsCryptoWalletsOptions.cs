...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesReceivedCreditsCryptoWalletsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesReceivedCreditsCryptoWalletsProtectionsOptions Protections { get; set; }
