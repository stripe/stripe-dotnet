...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesReceivedCreditsBankAccountsProtectionsOptions Protections { get; set; }
