...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdProtectionsOptions Protections { get; set; }
