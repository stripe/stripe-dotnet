...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationRecipientCapabilitiesBankAccountsSepaInstantOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationRecipientCapabilitiesBankAccountsSepaInstantProtectionsOptions Protections { get; set; }
