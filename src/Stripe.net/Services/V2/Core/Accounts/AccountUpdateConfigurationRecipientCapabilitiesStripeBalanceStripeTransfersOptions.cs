...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationRecipientCapabilitiesStripeBalanceStripeTransfersOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationRecipientCapabilitiesStripeBalanceStripeTransfersProtectionsOptions Protections { get; set; }
