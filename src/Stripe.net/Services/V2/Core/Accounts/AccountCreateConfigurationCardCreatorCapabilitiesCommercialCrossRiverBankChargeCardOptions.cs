...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankChargeCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesCommercialCrossRiverBankChargeCardProtectionsOptions Protections { get; set; }
