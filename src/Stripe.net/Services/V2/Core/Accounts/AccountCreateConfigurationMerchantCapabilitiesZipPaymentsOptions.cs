...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMerchantCapabilitiesZipPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMerchantCapabilitiesZipPaymentsProtectionsOptions Protections { get; set; }
