...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMerchantCapabilitiesIdealPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMerchantCapabilitiesIdealPaymentsProtectionsOptions Protections { get; set; }
