...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationCardCreatorCapabilitiesCommercialFifthThirdChargeCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationCardCreatorCapabilitiesCommercialFifthThirdChargeCardProtectionsOptions Protections { get; set; }
