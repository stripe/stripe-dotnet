...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundUsdcProtectionsOptions Protections { get; set; }
