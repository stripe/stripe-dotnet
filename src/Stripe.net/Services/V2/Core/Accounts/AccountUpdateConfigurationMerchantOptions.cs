...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantOptions : INestedOptions
    {
        ...
        public AccountUpdateConfigurationMerchantGrossSettlementOptions GrossSettlement { get; set; }
        ...
        public AccountUpdateConfigurationMerchantSepaDebitPaymentsOptions SepaDebitPayments { get; set; }
