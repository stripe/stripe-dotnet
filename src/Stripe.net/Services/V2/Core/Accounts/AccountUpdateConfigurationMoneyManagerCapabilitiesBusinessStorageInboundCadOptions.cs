...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundCadOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesBusinessStorageInboundCadProtectionsOptions Protections { get; set; }
