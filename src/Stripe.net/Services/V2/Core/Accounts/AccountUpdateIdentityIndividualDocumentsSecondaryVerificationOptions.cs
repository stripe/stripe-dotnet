...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateIdentityIndividualDocumentsSecondaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountUpdateIdentityIndividualDocumentsSecondaryVerificationFrontBackOptions FrontBack { get; set; }
