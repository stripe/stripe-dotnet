...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsProtectionsOptions Protections { get; set; }
