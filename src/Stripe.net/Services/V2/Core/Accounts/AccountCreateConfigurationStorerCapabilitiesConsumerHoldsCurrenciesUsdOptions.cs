...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdProtectionsOptions Protections { get; set; }
