...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcProtectionsOptions Protections { get; set; }
