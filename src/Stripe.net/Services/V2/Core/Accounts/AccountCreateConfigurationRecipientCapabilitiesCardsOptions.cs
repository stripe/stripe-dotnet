...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationRecipientCapabilitiesCardsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationRecipientCapabilitiesCardsProtectionsOptions Protections { get; set; }
