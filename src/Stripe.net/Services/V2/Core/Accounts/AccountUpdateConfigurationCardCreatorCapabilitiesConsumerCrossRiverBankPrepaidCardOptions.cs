...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesConsumerCrossRiverBankPrepaidCardProtectionsOptions Protections { get; set; }
