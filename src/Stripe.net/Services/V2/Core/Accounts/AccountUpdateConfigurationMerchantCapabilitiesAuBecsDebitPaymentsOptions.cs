...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantCapabilitiesAuBecsDebitPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMerchantCapabilitiesAuBecsDebitPaymentsProtectionsOptions Protections { get; set; }
