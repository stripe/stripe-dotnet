...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageInboundUsdcProtectionsOptions Protections { get; set; }
