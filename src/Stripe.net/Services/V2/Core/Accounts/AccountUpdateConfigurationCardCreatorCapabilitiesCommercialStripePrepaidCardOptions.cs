...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCardCreatorCapabilitiesCommercialStripePrepaidCardOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCardCreatorCapabilitiesCommercialStripePrepaidCardProtectionsOptions Protections { get; set; }
