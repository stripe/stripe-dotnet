...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMerchantCapabilitiesFpxPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMerchantCapabilitiesFpxPaymentsProtectionsOptions Protections { get; set; }
