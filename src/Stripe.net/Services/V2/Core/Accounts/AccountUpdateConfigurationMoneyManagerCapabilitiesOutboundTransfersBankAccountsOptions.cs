...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesOutboundTransfersBankAccountsProtectionsOptions Protections { get; set; }
