...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationCustomerCapabilitiesAutomaticIndirectTaxOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationCustomerCapabilitiesAutomaticIndirectTaxProtectionsOptions Protections { get; set; }
