...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundOusdOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesBusinessStorageOutboundOusdProtectionsOptions Protections { get; set; }
