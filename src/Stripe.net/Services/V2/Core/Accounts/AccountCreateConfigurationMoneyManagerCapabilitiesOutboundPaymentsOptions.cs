...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsOptions : INestedOptions
    {
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsCryptoWalletsOptions CryptoWallets { get; set; }
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsPaperChecksOptions PaperChecks { get; set; }
    }
}
