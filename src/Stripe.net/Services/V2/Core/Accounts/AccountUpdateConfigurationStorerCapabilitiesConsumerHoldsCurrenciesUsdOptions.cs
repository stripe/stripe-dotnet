...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationStorerCapabilitiesConsumerHoldsCurrenciesUsdProtectionsOptions Protections { get; set; }
