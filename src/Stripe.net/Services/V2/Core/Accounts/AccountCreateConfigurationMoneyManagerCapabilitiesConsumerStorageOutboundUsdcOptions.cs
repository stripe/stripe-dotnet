...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcProtectionsOptions Protections { get; set; }
