...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateIdentityBusinessDetailsDocumentsPrimaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountCreateIdentityBusinessDetailsDocumentsPrimaryVerificationFrontBackOptions FrontBack { get; set; }
