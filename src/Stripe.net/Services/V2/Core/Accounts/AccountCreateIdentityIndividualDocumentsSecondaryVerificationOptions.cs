...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateIdentityIndividualDocumentsSecondaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountCreateIdentityIndividualDocumentsSecondaryVerificationFrontBackOptions FrontBack { get; set; }
