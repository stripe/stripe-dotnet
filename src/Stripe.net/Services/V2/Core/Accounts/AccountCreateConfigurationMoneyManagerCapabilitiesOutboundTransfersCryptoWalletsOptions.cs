...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesOutboundTransfersCryptoWalletsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundTransfersCryptoWalletsProtectionsOptions Protections { get; set; }
