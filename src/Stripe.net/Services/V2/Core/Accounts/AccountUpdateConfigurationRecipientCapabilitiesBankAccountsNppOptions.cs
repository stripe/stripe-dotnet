...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationRecipientCapabilitiesBankAccountsNppOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationRecipientCapabilitiesBankAccountsNppProtectionsOptions Protections { get; set; }
