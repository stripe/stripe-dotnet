...
namespace Stripe.V2.Core.Accounts
{
    ...
    public class PersonTokenCreateDocumentsSecondaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PersonTokenCreateDocumentsSecondaryVerificationFrontBackOptions FrontBack { get; set; }
