...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationRecipientCapabilitiesBankAccountsInstantOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationRecipientCapabilitiesBankAccountsInstantProtectionsOptions Protections { get; set; }
