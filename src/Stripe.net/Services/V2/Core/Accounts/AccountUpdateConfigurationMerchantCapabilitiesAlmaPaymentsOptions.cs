...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantCapabilitiesAlmaPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMerchantCapabilitiesAlmaPaymentsProtectionsOptions Protections { get; set; }
