...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdProtectionsOptions Protections { get; set; }
