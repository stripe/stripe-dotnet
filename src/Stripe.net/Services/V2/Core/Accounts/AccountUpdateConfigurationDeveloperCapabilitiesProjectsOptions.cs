...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationDeveloperCapabilitiesProjectsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationDeveloperCapabilitiesProjectsProtectionsOptions Protections { get; set; }
