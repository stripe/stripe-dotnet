...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantCapabilitiesEpsPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMerchantCapabilitiesEpsPaymentsProtectionsOptions Protections { get; set; }
