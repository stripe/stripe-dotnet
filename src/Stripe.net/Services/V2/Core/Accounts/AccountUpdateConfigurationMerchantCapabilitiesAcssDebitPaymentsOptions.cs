...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMerchantCapabilitiesAcssDebitPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMerchantCapabilitiesAcssDebitPaymentsProtectionsOptions Protections { get; set; }
