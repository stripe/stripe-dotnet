...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationMoneyManagerCapabilitiesConsumerStorageOutboundUsdcProtectionsOptions Protections { get; set; }
