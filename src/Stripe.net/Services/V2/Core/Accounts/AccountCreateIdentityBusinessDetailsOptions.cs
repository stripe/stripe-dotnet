...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateIdentityBusinessDetailsOptions : INestedOptions
    {
        ...
        public List<AccountCreateIdentityBusinessDetailsAdditionalAddressOptions> AdditionalAddresses { get; set; }
        ...
        public AccountCreateIdentityBusinessDetailsAddressOptions Address { get; set; }
        ...
        public AccountCreateIdentityBusinessDetailsRegistrationDateOptions RegistrationDate { get; set; }
