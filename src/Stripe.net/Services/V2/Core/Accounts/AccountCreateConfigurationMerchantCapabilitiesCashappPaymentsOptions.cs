...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMerchantCapabilitiesCashappPaymentsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMerchantCapabilitiesCashappPaymentsProtectionsOptions Protections { get; set; }
