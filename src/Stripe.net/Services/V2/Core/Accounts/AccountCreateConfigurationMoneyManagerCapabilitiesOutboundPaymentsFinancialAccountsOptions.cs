...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsFinancialAccountsOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationMoneyManagerCapabilitiesOutboundPaymentsFinancialAccountsProtectionsOptions Protections { get; set; }
