...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationRecipientCapabilitiesBankAccountsSepaCreditOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationRecipientCapabilitiesBankAccountsSepaCreditProtectionsOptions Protections { get; set; }
