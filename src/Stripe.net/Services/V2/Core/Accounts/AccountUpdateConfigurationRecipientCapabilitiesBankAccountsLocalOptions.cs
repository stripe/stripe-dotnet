...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationRecipientCapabilitiesBankAccountsLocalOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationRecipientCapabilitiesBankAccountsLocalProtectionsOptions Protections { get; set; }
