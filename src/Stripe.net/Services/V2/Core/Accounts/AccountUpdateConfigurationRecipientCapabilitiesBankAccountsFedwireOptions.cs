...
namespace Stripe.V2.Core
{
    ...
    public class AccountUpdateConfigurationRecipientCapabilitiesBankAccountsFedwireOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountUpdateConfigurationRecipientCapabilitiesBankAccountsFedwireProtectionsOptions Protections { get; set; }
