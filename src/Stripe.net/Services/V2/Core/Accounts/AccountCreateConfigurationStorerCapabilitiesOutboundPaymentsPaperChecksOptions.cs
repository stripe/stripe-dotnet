...
namespace Stripe.V2.Core
{
    ...
    public class AccountCreateConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountCreateConfigurationStorerCapabilitiesOutboundPaymentsPaperChecksProtectionsOptions Protections { get; set; }
