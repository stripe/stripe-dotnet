...
namespace Stripe.V2.Core
{
    ...
    public class AccountTokenCreateIdentityAttestationsTermsOfServiceCardCreatorCommercialCrossRiverBankSpendCardFinancingDisclosuresOptions : INestedOptions
    {
        /// <summary>
