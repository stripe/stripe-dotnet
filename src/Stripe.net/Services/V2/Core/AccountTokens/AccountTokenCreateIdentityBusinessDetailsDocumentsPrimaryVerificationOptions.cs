...
namespace Stripe.V2.Core
{
    ...
    public class AccountTokenCreateIdentityBusinessDetailsDocumentsPrimaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountTokenCreateIdentityBusinessDetailsDocumentsPrimaryVerificationFrontBackOptions FrontBack { get; set; }
