...
namespace Stripe.V2.Core
{
    ...
    public class AccountTokenCreateIdentityBusinessDetailsOptions : INestedOptions
    {
        ...
        public AccountTokenCreateIdentityBusinessDetailsAddressOptions Address { get; set; }
        ...
        public AccountTokenCreateIdentityBusinessDetailsRegistrationDateOptions RegistrationDate { get; set; }
