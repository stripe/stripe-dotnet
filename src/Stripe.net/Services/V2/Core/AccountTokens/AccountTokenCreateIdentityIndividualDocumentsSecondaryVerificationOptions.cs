...
namespace Stripe.V2.Core
{
    ...
    public class AccountTokenCreateIdentityIndividualDocumentsSecondaryVerificationOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public AccountTokenCreateIdentityIndividualDocumentsSecondaryVerificationFrontBackOptions FrontBack { get; set; }
