...
namespace Stripe.V2.Core
{
    ...
    public class EventDestinationService : Service
    {
        ...
        /// </summary>
        public virtual EventDestination Delete(string id, EventDestinationDeleteOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<EventDestination>(BaseAddress.Api, HttpMethod.Delete, $"/v2/core/event_destinations/{WebUtility.UrlEncode(id)}", options, requestOptions);
        }

        /// <summary>
        /// Delete an event destination.
        /// </summary>
        public virtual Task<EventDestination> DeleteAsync(string id, EventDestinationDeleteOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
            return this.RequestAsync<EventDestination>(BaseAddress.Api, HttpMethod.Delete, $"/v2/core/event_destinations/{WebUtility.UrlEncode(id)}", options, requestOptions, cancellationToken);
        }
