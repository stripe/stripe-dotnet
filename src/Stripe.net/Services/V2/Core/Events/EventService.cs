    ...
    public class EventService : Service
    {
        ...
        )
        {
            return this.Request<Event>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v2/core/events/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// </summary>
        public virtual V2.StripeList<Event> List(
            EventListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<V2.StripeList<Event>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v2/core/events",
                options,
        ...
        /// List events, going back up to 30 days.
        /// </summary>
        public virtual Task<V2.StripeList<Event>> ListAsync(
            EventListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<V2.StripeList<Event>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v2/core/events",
                options,
