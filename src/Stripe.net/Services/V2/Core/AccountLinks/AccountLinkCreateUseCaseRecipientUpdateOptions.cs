...
namespace Stripe.V2.Core
{
    ...
    public class AccountLinkCreateUseCaseRecipientUpdateOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountLinkCreateUseCaseRecipientUpdateCollectionOptionsOptions CollectionOptions { get; set; }
