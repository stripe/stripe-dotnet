...
namespace Stripe.V2.Core
{
    ...
    public class AccountLinkCreateUseCaseRecipientOnboardingOptions : INestedOptions
    {
        /// <summary>
        ...
        public AccountLinkCreateUseCaseRecipientOnboardingCollectionOptionsOptions CollectionOptions { get; set; }
