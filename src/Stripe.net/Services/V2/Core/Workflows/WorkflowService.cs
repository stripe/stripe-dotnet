...
namespace Stripe.V2.Core
{
    ...
    public class WorkflowService : Service
    {
        ...
        {
            return this.Request<Workflow>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflows/{WebUtility.UrlEncode(id)}", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<Workflow>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflows/{WebUtility.UrlEncode(id)}", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<WorkflowRun>(BaseAddress.Api, HttpMethod.Post, $"/v2/core/workflows/{WebUtility.UrlEncode(id)}/invoke", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<WorkflowRun>(BaseAddress.Api, HttpMethod.Post, $"/v2/core/workflows/{WebUtility.UrlEncode(id)}/invoke", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<V2.StripeList<Workflow>>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflows", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<V2.StripeList<Workflow>>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflows", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Workflow>($"/v2/core/workflows", options, requestOptions);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Workflow>($"/v2/core/workflows", options, requestOptions, cancellationToken);
        }
    }
}
