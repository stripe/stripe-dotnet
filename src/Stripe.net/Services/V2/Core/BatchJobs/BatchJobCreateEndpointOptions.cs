...
namespace Stripe.V2.Core
{
    ...
    public class BatchJobCreateEndpointOptions : INestedOptions
    {
        ...
        /// One of: <c>/v1/accounts/:account</c>, <c>/v1/coupons</c>,
        /// <c>/v1/customers/:customer</c>, <c>/v1/promotion_codes</c>,
        /// <c>/v1/promotion_codes/:promotion_code</c>,
        /// <c>/v1/subscriptions/:subscription_exposed_id</c>,
        /// <c>/v1/subscriptions/:subscription_exposed_id</c>, or
        /// <c>/v1/subscriptions/:subscription/migrate</c>.
        /// </summary>
        [JsonProperty("path")]
