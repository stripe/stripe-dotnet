...
namespace Stripe.V2.Core
{
    ...
    public class WorkflowRunService : Service
    {
        ...
        {
            return this.Request<WorkflowRun>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflow_runs/{WebUtility.UrlEncode(id)}", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<WorkflowRun>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflow_runs/{WebUtility.UrlEncode(id)}", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.Request<V2.StripeList<WorkflowRun>>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflow_runs", options, requestOptions);
        }
        ...
        {
            return this.RequestAsync<V2.StripeList<WorkflowRun>>(BaseAddress.Api, HttpMethod.Get, $"/v2/core/workflow_runs", options, requestOptions, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<WorkflowRun>($"/v2/core/workflow_runs", options, requestOptions);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<WorkflowRun>($"/v2/core/workflow_runs", options, requestOptions, cancellationToken);
        }
    }
}
