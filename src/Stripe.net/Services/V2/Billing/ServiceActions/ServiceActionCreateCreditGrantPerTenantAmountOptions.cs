...
namespace Stripe.V2.Billing
{
    ...
    public class ServiceActionCreateCreditGrantPerTenantAmountOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public ServiceActionCreateCreditGrantPerTenantAmountCustomPricingUnitOptions CustomPricingUnit { get; set; }
...
#endif
        public ServiceActionCreateCreditGrantPerTenantAmountMonetaryOptions Monetary { get; set; }
    }
}
