...
namespace Stripe.V2.Billing
{
    ...
    public class MeterEventSessionService : Service
    {
        ...
        /// </summary>
        public virtual MeterEventSession Create(
            MeterEventSessionCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<MeterEventSession>(
                BaseAddress.Api,
                HttpMethod.Post,
        ...
        /// meter event session when your token expires.
        /// </summary>
        public virtual Task<MeterEventSession> CreateAsync(
            MeterEventSessionCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<MeterEventSession>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v2/billing/meter_event_session",
                options,
