...
namespace Stripe.V2.Billing
{
    ...
    public class ContractUpdatePricingLineActionAddPricingPriceDetailsPricingOverrideOptions : INestedOptions, IHasMetadata
    {
        /// <summary>
        ...
        public ContractUpdatePricingLineActionAddPricingPriceDetailsPricingOverrideEndsAtOptions EndsAt { get; set; }
        ...
        public ContractUpdatePricingLineActionAddPricingPriceDetailsPricingOverrideOverwritePriceOptions OverwritePrice { get; set; }
