...
namespace Stripe.V2.Billing
{
    ...
    public class ContractCreatePricingOverrideMultiplierCriterionOptions : INestedOptions
    {
        /// <summary>
        ...
        public List<ContractCreatePricingOverrideMultiplierCriterionMetadataConditionOptions> MetadataConditions { get; set; }
