...
namespace Stripe.V2.Billing
{
    ...
    public class ContractCreateContractLineOverrideServiceActionReplaceOptions : INestedOptions, IHasId
    {
        /// <summary>
        ...
        public ContractCreateContractLineOverrideServiceActionReplaceCreditGrantOptions CreditGrant { get; set; }
