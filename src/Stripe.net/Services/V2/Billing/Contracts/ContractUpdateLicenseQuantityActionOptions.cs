...
namespace Stripe.V2.Billing
{
    ...
    public class ContractUpdateLicenseQuantityActionOptions : INestedOptions
    {
        /// <summary>
        ...
        public ContractUpdateLicenseQuantityActionEffectiveAtOptions EffectiveAt { get; set; }
        ...
        /// </summary>
        [JsonProperty("pricing_line_lookup_key")]
        [STJS.JsonPropertyName("pricing_line_lookup_key")]
        public string PricingLineLookupKey { get; set; }
        ...
        public ContractUpdateLicenseQuantityActionSetOptions Set { get; set; }
