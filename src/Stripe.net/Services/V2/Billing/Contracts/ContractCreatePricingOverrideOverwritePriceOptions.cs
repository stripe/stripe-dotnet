...
namespace Stripe.V2.Billing
{
    ...
    public class ContractCreatePricingOverrideOverwritePriceOptions : INestedOptions
    {
        /// <summary>
        ...
        public List<ContractCreatePricingOverrideOverwritePriceTierOptions> Tiers { get; set; }
