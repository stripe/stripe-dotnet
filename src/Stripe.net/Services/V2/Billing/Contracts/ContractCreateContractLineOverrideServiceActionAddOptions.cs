...
namespace Stripe.V2.Billing
{
    ...
    public class ContractCreateContractLineOverrideServiceActionAddOptions : INestedOptions
    {
        /// <summary>
        ...
        public ContractCreateContractLineOverrideServiceActionAddCreditGrantOptions CreditGrant { get; set; }
