...
namespace Stripe.V2.Billing
{
    ...
    public class IntentCreateCadenceDataPayerOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public IntentCreateCadenceDataPayerBillingProfileDataOptions BillingProfileData { get; set; }
    }
}
