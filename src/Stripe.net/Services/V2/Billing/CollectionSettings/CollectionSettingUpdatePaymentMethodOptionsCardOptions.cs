...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingUpdatePaymentMethodOptionsCardOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public CollectionSettingUpdatePaymentMethodOptionsCardMandateOptionsOptions MandateOptions { get; set; }
