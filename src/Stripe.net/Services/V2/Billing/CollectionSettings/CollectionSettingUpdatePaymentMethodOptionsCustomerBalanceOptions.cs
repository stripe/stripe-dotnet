...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingUpdatePaymentMethodOptionsCustomerBalanceOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public CollectionSettingUpdatePaymentMethodOptionsCustomerBalanceBankTransferOptions BankTransfer { get; set; }
