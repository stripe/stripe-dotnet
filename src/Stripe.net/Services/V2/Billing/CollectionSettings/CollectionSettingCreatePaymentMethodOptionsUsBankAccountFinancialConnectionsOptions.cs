...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingCreatePaymentMethodOptionsUsBankAccountFinancialConnectionsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public CollectionSettingCreatePaymentMethodOptionsUsBankAccountFinancialConnectionsFiltersOptions Filters { get; set; }
