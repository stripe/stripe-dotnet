...
namespace Stripe.V2.Billing
{
    ...
    public class CollectionSettingUpdatePaymentMethodOptionsCustomerBalanceBankTransferOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public CollectionSettingUpdatePaymentMethodOptionsCustomerBalanceBankTransferEuBankTransferOptions EuBankTransfer { get; set; }
