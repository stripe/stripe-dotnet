...
namespace Stripe
{
    ...
    public class PaymentMethodCreateOptions : BaseOptions, IHasMetadata
    {
        ...
        public PaymentMethodGiftCardOptions GiftCard { get; set; }
        ...
        public PaymentMethodTamaraOptions Tamara { get; set; }
        ...
        /// <c>fpx</c>, <c>gift_card</c>, <c>giropay</c>, <c>gopay</c>, <c>grabpay</c>,
        ...
        /// <c>satispay</c>, <c>scalapay</c>, <c>sepa_debit</c>, <c>sequra</c>, <c>shopeepay</c>,
