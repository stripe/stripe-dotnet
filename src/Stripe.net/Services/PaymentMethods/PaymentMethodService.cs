...
namespace Stripe
{
            ...
            IUpdatable<PaymentMethod, PaymentMethodUpdateOptions>
    {
        ...
        /// </summary>
        public virtual PaymentMethod Attach(
            string id,
            PaymentMethodAttachOptions options = null,
        ...
        )
        {
            return this.Request<PaymentMethod>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/payment_methods/{WebUtility.UrlEncode(id)}/attach",
                options,
                requestOptions
            );
        }
        ...
        /// on the Customer to the PaymentMethod’s ID.</p>.
        /// </summary>
        public virtual Task<PaymentMethod> AttachAsync(
            string id,
            PaymentMethodAttachOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<PaymentMethod>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/payment_methods/{WebUtility.UrlEncode(id)}/attach",
                options,
        ...
        /// </summary>
        public virtual PaymentMethod Create(
            PaymentMethodCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<PaymentMethod>(
        ...
        /// payment method details ahead of a future payment.</p>.
        /// </summary>
        public virtual Task<PaymentMethod> CreateAsync(
            PaymentMethodCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        ...
        /// </summary>
        public virtual PaymentMethod Detach(
            string id,
            PaymentMethodDetachOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<PaymentMethod>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/payment_methods/{WebUtility.UrlEncode(id)}/detach",
                options,
                requestOptions
            );
        }
        ...
        /// it can no longer be used for a payment or re-attached to a Customer.</p>.
        /// </summary>
        public virtual Task<PaymentMethod> DetachAsync(
            string id,
            PaymentMethodDetachOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// PaymentMethods</a></p>.
        /// </summary>
        public virtual PaymentMethod Get(
            string id,
            PaymentMethodGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<PaymentMethod>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/payment_methods/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// PaymentMethods</a></p>.
        /// </summary>
        public virtual Task<PaymentMethod> GetAsync(
            string id,
            PaymentMethodGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual StripeList<PaymentMethod> List(
            PaymentMethodListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<PaymentMethod>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/payment_methods",
                options,
        ...
        /// <p>Returns a list of all PaymentMethods.</p>.
        /// </summary>
        public virtual Task<StripeList<PaymentMethod>> ListAsync(
            PaymentMethodListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<PaymentMethod>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/payment_methods",
                options,
        ...
        /// <p>Returns a list of all PaymentMethods.</p>.
        /// </summary>
        public virtual IEnumerable<PaymentMethod> ListAutoPaging(
            PaymentMethodListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<PaymentMethod>(
                $"/v1/payment_methods",
                options,
                requestOptions
            );
        ...
        /// <p>Returns a list of all PaymentMethods.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<PaymentMethod> ListAutoPagingAsync(
            PaymentMethodListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<PaymentMethod>(
                $"/v1/payment_methods",
                options,
                requestOptions,
                cancellationToken
        ...
        /// updated.</p>.
        /// </summary>
        public virtual PaymentMethod Update(
            string id,
        ...
        /// updated.</p>.
        /// </summary>
        public virtual Task<PaymentMethod> UpdateAsync(
            string id,
            PaymentMethodUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
