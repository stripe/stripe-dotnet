...
namespace Stripe
{
        ...
        IUpdatable<PaymentMethod, PaymentMethodUpdateOptions>
    {
        ...
        {
            return this.Request<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}/attach", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}/attach", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}/detach", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}/detach", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<PaymentMethod>(BaseAddress.Api, HttpMethod.Get, $"/v1/payment_methods/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<PaymentMethod>(BaseAddress.Api, HttpMethod.Get, $"/v1/payment_methods/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<PaymentMethod>>(BaseAddress.Api, HttpMethod.Get, $"/v1/payment_methods", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<PaymentMethod>>(BaseAddress.Api, HttpMethod.Get, $"/v1/payment_methods", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<PaymentMethod>($"/v1/payment_methods", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<PaymentMethod>($"/v1/payment_methods", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<PaymentMethod>(BaseAddress.Api, HttpMethod.Post, $"/v1/payment_methods/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
