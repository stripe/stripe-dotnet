...
namespace Stripe
{
    ...
    public class AccountLinkService : Service, ICreatable<AccountLink, AccountLinkCreateOptions>
    {
        ...
        /// flow.</p>.
        /// </summary>
        public virtual AccountLink Create(
            AccountLinkCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<AccountLink>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/account_links",
                options,
        ...
        /// flow.</p>.
        /// </summary>
        public virtual Task<AccountLink> CreateAsync(
            AccountLinkCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<AccountLink>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/account_links",
                options,
