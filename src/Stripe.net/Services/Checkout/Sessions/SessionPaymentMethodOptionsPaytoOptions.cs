...
namespace Stripe.Checkout
{
    ...
    public class SessionPaymentMethodOptionsPaytoOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SessionPaymentMethodOptionsPaytoMandateOptionsOptions MandateOptions { get; set; }
