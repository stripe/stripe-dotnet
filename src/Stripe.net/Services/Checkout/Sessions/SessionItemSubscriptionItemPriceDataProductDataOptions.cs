...
namespace Stripe.Checkout
{
    ...
    public class SessionItemSubscriptionItemPriceDataProductDataOptions : INestedOptions, IHasMetadata
    {
        /// <summary>
        ...
        public SessionItemSubscriptionItemPriceDataProductDataTaxDetailsOptions TaxDetails { get; set; }
