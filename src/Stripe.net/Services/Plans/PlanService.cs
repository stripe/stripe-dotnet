...
namespace Stripe
{
            ...
            IUpdatable<Plan, PlanUpdateOptions>
    {
        ...
        /// is backwards compatible to simplify your migration.</p>.
        /// </summary>
        public virtual Task<Plan> CreateAsync(
            PlanCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<Plan>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/plans",
                options,
        ...
        /// affected.</p>.
        /// </summary>
        public virtual Plan Delete(
            string id,
            PlanDeleteOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Plan>(
                BaseAddress.Api,
                HttpMethod.Delete,
                $"/v1/plans/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// affected.</p>.
        /// </summary>
        public virtual Task<Plan> DeleteAsync(
            string id,
            PlanDeleteOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual Plan Get(
            string id,
            PlanGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<Plan>(
        ...
        /// <p>Retrieves the plan with the given ID.</p>.
        /// </summary>
        public virtual Task<Plan> GetAsync(
            string id,
            PlanGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual StripeList<Plan> List(
            PlanListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<Plan>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/plans",
                options,
        ...
        /// <p>Returns a list of your plans.</p>.
        /// </summary>
        public virtual Task<StripeList<Plan>> ListAsync(
            PlanListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<Plan>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/plans",
                options,
        ...
        /// <p>Returns a list of your plans.</p>.
        /// </summary>
        public virtual IEnumerable<Plan> ListAutoPaging(
            PlanListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
        ...
        /// <p>Returns a list of your plans.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<Plan> ListAutoPagingAsync(
            PlanListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<Plan>(
                $"/v1/plans",
                options,
                requestOptions,
                cancellationToken
        ...
        /// amount, currency, or billing cycle.</p>.
        /// </summary>
        public virtual Task<Plan> UpdateAsync(
            string id,
            PlanUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
