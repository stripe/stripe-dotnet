...
namespace Stripe
{
            ...
            IRetrievable<ConfirmationToken, ConfirmationTokenGetOptions>
    {
        ...
        /// </summary>
        public virtual ConfirmationToken Get(
            string id,
            ConfirmationTokenGetOptions options = null,
        ...
        )
        {
            return this.Request<ConfirmationToken>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/confirmation_tokens/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// <p>Retrieves an existing ConfirmationToken object</p>.
        /// </summary>
        public virtual Task<ConfirmationToken> GetAsync(
            string id,
            ConfirmationTokenGetOptions options = null,
            RequestOptions requestOptions = null,
