...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsIdBankTransferOptions : INestedOptions
    {
        /// <summary>
        /// The UNIX timestamp until which the virtual bank account is valid. Permitted range is
        /// from 5 minutes from now until 31 days from now. If unset, it defaults to 3 days from
        /// now.
        /// </summary>
        ...
        /// <summary>
        /// The UNIX timestamp until which the virtual bank account is valid. Permitted range is
        /// from now until 30 days from now. If unset, it defaults to 1 days from now.
        /// </summary>
