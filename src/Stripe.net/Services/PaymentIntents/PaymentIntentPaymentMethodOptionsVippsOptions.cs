...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsVippsOptions : INestedOptions, IHasSetTracking
    {
        ...
        public PaymentIntentPaymentMethodOptionsVippsPaymentDetailsOptions PaymentDetails { get; set; }
