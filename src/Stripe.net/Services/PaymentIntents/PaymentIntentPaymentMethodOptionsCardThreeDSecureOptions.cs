...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsCardThreeDSecureOptions : INestedOptions
    {
        /// <summary>
        ...
        public PaymentIntentPaymentMethodOptionsCardThreeDSecureNetworkOptionsOptions NetworkOptions { get; set; }
