...
namespace Stripe
{
    ...
    public class PaymentIntentPaymentMethodOptionsPaypalLineItemOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public PaymentIntentPaymentMethodOptionsPaypalLineItemTaxOptions Tax { get; set; }
