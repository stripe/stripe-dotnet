...
namespace Stripe.Reporting
{
        ...
        IRetrievable<ReportRun, ReportRunGetOptions>
    {
        ...
        {
            return this.Request<ReportRun>(BaseAddress.Api, HttpMethod.Post, $"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<ReportRun>(BaseAddress.Api, HttpMethod.Post, $"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<ReportRun>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_runs/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<ReportRun>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_runs/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<ReportRun>>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<ReportRun>>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<ReportRun>($"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<ReportRun>($"/v1/reporting/report_runs", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
