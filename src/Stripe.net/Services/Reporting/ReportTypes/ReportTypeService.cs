...
namespace Stripe.Reporting
{
        ...
        IRetrievable<ReportType, ReportTypeGetOptions>
    {
        ...
        {
            return this.Request<ReportType>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_types/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<ReportType>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_types/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<ReportType>>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_types", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<ReportType>>(BaseAddress.Api, HttpMethod.Get, $"/v1/reporting/report_types", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<ReportType>($"/v1/reporting/report_types", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<ReportType>($"/v1/reporting/report_types", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
