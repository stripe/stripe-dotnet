...
namespace Stripe
{
    ...
    public class AccountLoginLinkService
        : Service,
            INestedCreatable<LoginLink, AccountLoginLinkCreateOptions>
    {
        ...
        /// </summary>
        public virtual LoginLink Create(
            string parentId,
            AccountLoginLinkCreateOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<LoginLink>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/login_links",
                options,
                requestOptions
            );
        }
        ...
        /// connected to your platform</strong>.</p>.
        /// </summary>
        public virtual Task<LoginLink> CreateAsync(
            string parentId,
            AccountLoginLinkCreateOptions options = null,
            RequestOptions requestOptions = null,
        ...
        {
            return this.RequestAsync<LoginLink>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/accounts/{WebUtility.UrlEncode(parentId)}/login_links",
                options,
