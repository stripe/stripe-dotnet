...
namespace Stripe
{
    ...
    public class InvoiceSubscriptionDetailsPauseBillForOptions : INestedOptions
    {
        /// <summary>
        ...
        public InvoiceSubscriptionDetailsPauseBillForOutstandingUsageThroughOptions OutstandingUsageThrough { get; set; }
        ...
        public InvoiceSubscriptionDetailsPauseBillForUnusedTimeFromOptions UnusedTimeFrom { get; set; }
    }
}
