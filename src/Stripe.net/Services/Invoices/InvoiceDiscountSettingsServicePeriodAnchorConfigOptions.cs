...
namespace Stripe
{
    ...
    public class InvoiceDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
