...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsPhaseInvoiceSettingsOptions : INestedOptions, IHasSetTracking
    {
        ...
        public InvoiceScheduleDetailsPhaseInvoiceSettingsIssuerOptions Issuer { get; set; }
