...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsAmendmentItemActionAddDiscountOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsAmendmentItemActionAddDiscountSettingsOptions Settings { get; set; }
    }
}
