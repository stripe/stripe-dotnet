...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsPhaseItemDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsPhaseItemDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
