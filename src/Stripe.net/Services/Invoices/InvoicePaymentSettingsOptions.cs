...
namespace Stripe
{
    ...
    public class InvoicePaymentSettingsOptions : INestedOptions, IHasSetTracking
    {
        ...
        /// <c>bancontact</c>, <c>billie</c>, <c>boleto</c>, <c>card</c>, <c>cashapp</c>,
        /// <c>crypto</c>, <c>custom</c>, <c>customer_balance</c>, <c>eps</c>, <c>fpx</c>,
        /// <c>giropay</c>, <c>grabpay</c>, <c>ideal</c>, <c>jp_credit_transfer</c>,
        /// <c>kakao_pay</c>, <c>klarna</c>, <c>konbini</c>, <c>kr_card</c>, <c>link</c>,
        /// <c>mb_way</c>, <c>multibanco</c>, <c>naver_pay</c>, <c>nz_bank_account</c>, <c>p24</c>,
