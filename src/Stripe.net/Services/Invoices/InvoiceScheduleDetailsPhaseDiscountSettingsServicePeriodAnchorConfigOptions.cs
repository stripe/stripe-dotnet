...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsPhaseDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsPhaseDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
