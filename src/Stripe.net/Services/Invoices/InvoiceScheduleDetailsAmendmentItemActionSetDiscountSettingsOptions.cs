...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsAmendmentItemActionSetDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsAmendmentItemActionSetDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
