...
namespace Stripe
{
    ...
    public class InvoiceDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
