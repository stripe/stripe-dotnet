...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsPhaseDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsPhaseDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
