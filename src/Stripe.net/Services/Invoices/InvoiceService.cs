...
namespace Stripe
{
        ...
        IUpdatable<Invoice, InvoiceUpdateOptions>
    {
        ...
        /// draft until you <a href="https://stripe.com/api/invoices/finalize">finalize</a> the
        ...
        /// <summary>
        /// <p>At any time, you can preview the upcoming invoice for a subscription or subscription
        ...
        /// </summary>
        public virtual string SerializeBatchCreate(InvoiceCreateOptions options = null, RequestOptions requestOptions = null)
        {
            var requestId = Guid.NewGuid().ToString();
            var stripeVersion = StripeConfiguration.ApiVersion;
            var stripeContext = requestOptions?.StripeContext;
        ...
        /// </summary>
        public virtual string SerializeBatchCreatePreview(InvoiceCreatePreviewOptions options = null, RequestOptions requestOptions = null)
        {
            var requestId = Guid.NewGuid().ToString();
            var stripeVersion = StripeConfiguration.ApiVersion;
            var stripeContext = requestOptions?.StripeContext;
        ...
        /// similar to <a href="https://stripe.com/api/invoices/delete">deletion</a>, however it
        ...
        /// need to <a href="https://stripe.com/api/invoices/create">issue another invoice</a> or <a
        /// href="https://stripe.com/api/credit_notes/create">credit note</a> instead. Stripe
