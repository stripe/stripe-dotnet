...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsAmendmentDiscountActionSetSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsAmendmentDiscountActionSetSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
