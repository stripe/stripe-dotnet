...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsAmendmentItemActionAddDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsAmendmentItemActionAddDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
