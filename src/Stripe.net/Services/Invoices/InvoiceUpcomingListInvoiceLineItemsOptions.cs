namespace Stripe
{
    ...
    public class InvoiceUpcomingListInvoiceLineItemsOptions : ListOptions
    {
        [JsonProperty("coupon")]
        ...
        public List<InvoiceLineItemInvoiceItemOptions> InvoiceItems { get; set; }
        ...
        public List<InvoiceLineItemSubscriptionItemOptions> SubscriptionItems { get; set; }
