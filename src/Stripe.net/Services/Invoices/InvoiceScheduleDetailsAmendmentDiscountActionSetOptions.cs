...
namespace Stripe
{
    ...
    public class InvoiceScheduleDetailsAmendmentDiscountActionSetOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public InvoiceScheduleDetailsAmendmentDiscountActionSetSettingsOptions Settings { get; set; }
    }
}
