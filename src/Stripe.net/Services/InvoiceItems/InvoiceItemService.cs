...
namespace Stripe
{
            ...
            IUpdatable<InvoiceItem, InvoiceItemUpdateOptions>
    {
        ...
        /// specified.</p>.
        /// </summary>
        public virtual InvoiceItem Create(
            InvoiceItemCreateOptions options,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<InvoiceItem>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/invoiceitems",
                options,
        ...
        /// specified.</p>.
        /// </summary>
        public virtual Task<InvoiceItem> CreateAsync(
            InvoiceItemCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<InvoiceItem>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/invoiceitems",
                options,
        ...
        /// invoice.</p>.
        /// </summary>
        public virtual InvoiceItem Delete(
            string id,
            InvoiceItemDeleteOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<InvoiceItem>(
                BaseAddress.Api,
                HttpMethod.Delete,
                $"/v1/invoiceitems/{WebUtility.UrlEncode(id)}",
                options,
                requestOptions
            );
        }
        ...
        /// invoice.</p>.
        /// </summary>
        public virtual Task<InvoiceItem> DeleteAsync(
            string id,
            InvoiceItemDeleteOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual InvoiceItem Get(
            string id,
            InvoiceItemGetOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<InvoiceItem>(
        ...
        /// <p>Retrieves the invoice item with the given ID.</p>.
        /// </summary>
        public virtual Task<InvoiceItem> GetAsync(
            string id,
            InvoiceItemGetOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        ...
        /// </summary>
        public virtual StripeList<InvoiceItem> List(
            InvoiceItemListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.Request<StripeList<InvoiceItem>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/invoiceitems",
                options,
        ...
        /// date, with the most recently created invoice items appearing first.</p>.
        /// </summary>
        public virtual Task<StripeList<InvoiceItem>> ListAsync(
            InvoiceItemListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<StripeList<InvoiceItem>>(
                BaseAddress.Api,
                HttpMethod.Get,
                $"/v1/invoiceitems",
                options,
        ...
        /// date, with the most recently created invoice items appearing first.</p>.
        /// </summary>
        public virtual IEnumerable<InvoiceItem> ListAutoPaging(
            InvoiceItemListOptions options = null,
            RequestOptions requestOptions = null
        )
        {
            return this.ListRequestAutoPaging<InvoiceItem>(
                $"/v1/invoiceitems",
                options,
                requestOptions
            );
        ...
        /// date, with the most recently created invoice items appearing first.</p>.
        /// </summary>
        public virtual IAsyncEnumerable<InvoiceItem> ListAutoPagingAsync(
            InvoiceItemListOptions options = null,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.ListRequestAutoPagingAsync<InvoiceItem>(
                $"/v1/invoiceitems",
                options,
                requestOptions,
                cancellationToken
        ...
        /// </summary>
        public virtual InvoiceItem Update(
            string id,
        ...
        /// an invoice item is only possible before the invoice it’s attached to is closed.</p>.
        /// </summary>
        public virtual Task<InvoiceItem> UpdateAsync(
            string id,
            InvoiceItemUpdateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
