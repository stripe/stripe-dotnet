...
namespace Stripe
{
        ...
        INestedCreatable<UsageRecord, SubscriptionItemUsageRecordCreateOptions>
    {
        ...
        internal SubscriptionItemUsageRecordService(ApiRequestor requestor)
            : base(requestor)
        {
        }

        public SubscriptionItemUsageRecordService(IStripeClient client)
            : base(client)
        {
        }
        ...
        /// </summary>
        public virtual UsageRecord Create(string parentId, SubscriptionItemUsageRecordCreateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.Request<UsageRecord>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items/{WebUtility.UrlEncode(parentId)}/usage_records", options, requestOptions);
        }
        ...
        /// href="https://stripe.com/docs/billing/subscriptions/tiers">tiered pricing</a> model.</p>.
        /// </summary>
        public virtual Task<UsageRecord> CreateAsync(string parentId, SubscriptionItemUsageRecordCreateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
            return this.RequestAsync<UsageRecord>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_items/{WebUtility.UrlEncode(parentId)}/usage_records", options, requestOptions, cancellationToken);
        }
    }
}
