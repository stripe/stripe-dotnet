...
namespace Stripe.FinancialConnections
{
        ...
        IRetrievable<Transaction, TransactionGetOptions>
    {
        ...
        {
            return this.Request<Transaction>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/transactions/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Transaction>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/transactions/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Transaction>>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/transactions", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Transaction>>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/transactions", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Transaction>($"/v1/financial_connections/transactions", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Transaction>($"/v1/financial_connections/transactions", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
