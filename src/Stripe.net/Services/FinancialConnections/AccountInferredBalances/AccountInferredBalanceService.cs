...
namespace Stripe.FinancialConnections
{
        ...
        INestedListable<AccountInferredBalance, AccountInferredBalanceListOptions>
    {
        ...
        {
            return this.Request<StripeList<AccountInferredBalance>>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/accounts/{parentId}/inferred_balances", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<AccountInferredBalance>>(BaseAddress.Api, HttpMethod.Get, $"/v1/financial_connections/accounts/{parentId}/inferred_balances", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<AccountInferredBalance>($"/v1/financial_connections/accounts/{parentId}/inferred_balances", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<AccountInferredBalance>($"/v1/financial_connections/accounts/{parentId}/inferred_balances", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
