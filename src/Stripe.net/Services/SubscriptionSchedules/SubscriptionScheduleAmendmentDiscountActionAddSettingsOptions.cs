...
namespace Stripe
{
    ...
    public class SubscriptionScheduleAmendmentDiscountActionAddSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionScheduleAmendmentDiscountActionAddSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
