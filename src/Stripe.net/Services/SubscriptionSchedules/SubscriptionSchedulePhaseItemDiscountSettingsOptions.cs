...
namespace Stripe
{
    ...
    public class SubscriptionSchedulePhaseItemDiscountSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionSchedulePhaseItemDiscountSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
