...
namespace Stripe
{
    ...
    {
        private SubscriptionSchedulePhaseBillingThresholdsOptions billingThresholds;
        private List<string> defaultTaxRates;
        private string description;
        private List<SubscriptionSchedulePhaseDiscountOptions> discounts;
        ...
        public SubscriptionSchedulePhaseBillingThresholdsOptions BillingThresholds
        {
        ...
        public List<SubscriptionSchedulePhaseDiscountOptions> Discounts
        {
            get => this.discounts;
            set
            {
