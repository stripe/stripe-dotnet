...
namespace Stripe
{
    ...
    public class SubscriptionScheduleDefaultSettingsInvoiceSettingsOptions : INestedOptions, IHasSetTracking
    {
        ...
        private List<SubscriptionScheduleDefaultSettingsInvoiceSettingsCustomFieldOptions> customFields;
        ...
        [STJS.JsonIgnore(Condition = STJS.JsonIgnoreCondition.WhenWritingNull)]
        public List<SubscriptionScheduleDefaultSettingsInvoiceSettingsCustomFieldOptions> CustomFields
        {
