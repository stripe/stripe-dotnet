...
namespace Stripe
{
    ...
    public class SubscriptionScheduleAmendmentDiscountActionSetSettingsOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionScheduleAmendmentDiscountActionSetSettingsServicePeriodAnchorConfigOptions ServicePeriodAnchorConfig { get; set; }
