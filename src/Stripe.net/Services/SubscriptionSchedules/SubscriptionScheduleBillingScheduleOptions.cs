...
namespace Stripe
{
    ...
    public class SubscriptionScheduleBillingScheduleOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public List<SubscriptionScheduleBillingScheduleAppliesToOptions> AppliesTo { get; set; }
...
#endif
        public SubscriptionScheduleBillingScheduleBillUntilOptions BillUntil { get; set; }
