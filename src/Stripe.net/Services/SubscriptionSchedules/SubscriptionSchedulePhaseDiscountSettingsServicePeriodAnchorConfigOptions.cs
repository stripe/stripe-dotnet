...
namespace Stripe
{
    ...
    public class SubscriptionSchedulePhaseDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionSchedulePhaseDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
