...
namespace Stripe
{
        ...
        IUpdatable<SubscriptionSchedule, SubscriptionScheduleUpdateOptions>
    {
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/amend", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/amend", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/cancel", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/cancel", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_schedules/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_schedules/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<SubscriptionSchedule>>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_schedules", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<SubscriptionSchedule>>(BaseAddress.Api, HttpMethod.Get, $"/v1/subscription_schedules", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<SubscriptionSchedule>($"/v1/subscription_schedules", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<SubscriptionSchedule>($"/v1/subscription_schedules", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/release", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}/release", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<SubscriptionSchedule>(BaseAddress.Api, HttpMethod.Post, $"/v1/subscription_schedules/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
