...
namespace Stripe
{
    ...
    public class SubscriptionSchedulePhaseItemDiscountSettingsServicePeriodAnchorConfigOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SubscriptionSchedulePhaseItemDiscountSettingsServicePeriodAnchorConfigCustomOptions Custom { get; set; }
