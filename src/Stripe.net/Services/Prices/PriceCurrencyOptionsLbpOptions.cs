...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLbpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLbpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLbpTierOptions> Tiers { get; set; }
