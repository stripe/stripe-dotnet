...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMznOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMznCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMznTierOptions> Tiers { get; set; }
