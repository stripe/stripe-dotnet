...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLakOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLakCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLakTierOptions> Tiers { get; set; }
