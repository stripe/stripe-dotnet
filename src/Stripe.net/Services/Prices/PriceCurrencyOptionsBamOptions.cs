...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBamOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBamCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBamTierOptions> Tiers { get; set; }
