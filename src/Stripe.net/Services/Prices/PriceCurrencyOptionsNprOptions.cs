...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNprOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNprCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNprTierOptions> Tiers { get; set; }
