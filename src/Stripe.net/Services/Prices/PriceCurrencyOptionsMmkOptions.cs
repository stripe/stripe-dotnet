...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMmkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMmkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMmkTierOptions> Tiers { get; set; }
