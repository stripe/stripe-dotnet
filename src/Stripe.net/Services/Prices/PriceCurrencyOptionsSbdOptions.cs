...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSbdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSbdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSbdTierOptions> Tiers { get; set; }
