...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBsdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBsdTierOptions> Tiers { get; set; }
