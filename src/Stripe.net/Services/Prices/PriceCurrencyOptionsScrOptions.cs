...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsScrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsScrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsScrTierOptions> Tiers { get; set; }
