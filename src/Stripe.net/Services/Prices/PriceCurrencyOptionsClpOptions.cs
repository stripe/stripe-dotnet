...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsClpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsClpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsClpTierOptions> Tiers { get; set; }
