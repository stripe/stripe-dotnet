...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPhpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPhpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPhpTierOptions> Tiers { get; set; }
