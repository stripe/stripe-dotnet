...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBdtOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBdtCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBdtTierOptions> Tiers { get; set; }
