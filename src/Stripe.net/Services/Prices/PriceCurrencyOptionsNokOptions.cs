...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNokOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNokCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNokTierOptions> Tiers { get; set; }
