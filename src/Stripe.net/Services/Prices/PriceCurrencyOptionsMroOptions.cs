...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMroOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMroCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMroTierOptions> Tiers { get; set; }
