...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBgnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBgnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBgnTierOptions> Tiers { get; set; }
