...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSzlOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSzlCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSzlTierOptions> Tiers { get; set; }
