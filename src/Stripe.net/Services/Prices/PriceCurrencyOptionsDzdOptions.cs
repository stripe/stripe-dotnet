...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDzdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDzdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDzdTierOptions> Tiers { get; set; }
