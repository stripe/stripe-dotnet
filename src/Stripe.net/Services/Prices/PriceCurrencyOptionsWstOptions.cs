...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsWstOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsWstCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsWstTierOptions> Tiers { get; set; }
