...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMvrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMvrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMvrTierOptions> Tiers { get; set; }
