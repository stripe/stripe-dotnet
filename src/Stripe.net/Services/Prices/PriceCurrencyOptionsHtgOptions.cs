...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHtgOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHtgCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHtgTierOptions> Tiers { get; set; }
