...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsFkpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsFkpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsFkpTierOptions> Tiers { get; set; }
