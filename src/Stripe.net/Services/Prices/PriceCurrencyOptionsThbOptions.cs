...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsThbOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsThbCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsThbTierOptions> Tiers { get; set; }
