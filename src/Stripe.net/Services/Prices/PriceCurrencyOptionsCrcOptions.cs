...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCrcOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCrcCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCrcTierOptions> Tiers { get; set; }
