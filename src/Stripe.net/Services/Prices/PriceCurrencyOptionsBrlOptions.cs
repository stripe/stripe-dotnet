...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBrlOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBrlCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBrlTierOptions> Tiers { get; set; }
