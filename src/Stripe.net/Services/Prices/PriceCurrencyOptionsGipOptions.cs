...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGipOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGipCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGipTierOptions> Tiers { get; set; }
