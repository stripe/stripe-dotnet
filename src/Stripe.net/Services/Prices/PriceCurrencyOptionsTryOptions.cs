...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTryOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTryCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTryTierOptions> Tiers { get; set; }
