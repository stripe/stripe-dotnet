...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsShpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsShpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsShpTierOptions> Tiers { get; set; }
