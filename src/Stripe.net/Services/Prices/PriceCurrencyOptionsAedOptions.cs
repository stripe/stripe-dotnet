...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAedOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAedCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAedTierOptions> Tiers { get; set; }
