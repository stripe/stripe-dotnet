...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTtdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTtdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTtdTierOptions> Tiers { get; set; }
