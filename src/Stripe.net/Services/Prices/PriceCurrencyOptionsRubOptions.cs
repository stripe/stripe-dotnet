...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRubOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRubCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRubTierOptions> Tiers { get; set; }
