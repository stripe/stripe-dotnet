...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPlnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPlnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPlnTierOptions> Tiers { get; set; }
