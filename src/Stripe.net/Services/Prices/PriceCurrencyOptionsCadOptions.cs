...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCadOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCadTierOptions> Tiers { get; set; }
