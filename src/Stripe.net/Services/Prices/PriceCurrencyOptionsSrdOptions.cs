...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSrdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSrdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSrdTierOptions> Tiers { get; set; }
