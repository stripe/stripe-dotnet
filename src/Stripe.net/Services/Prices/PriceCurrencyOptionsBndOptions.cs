...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBndOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBndTierOptions> Tiers { get; set; }
