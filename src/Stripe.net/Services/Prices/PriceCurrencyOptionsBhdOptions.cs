...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBhdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBhdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBhdTierOptions> Tiers { get; set; }
