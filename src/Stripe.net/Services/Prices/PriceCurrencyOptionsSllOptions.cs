...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSllOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSllCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSllTierOptions> Tiers { get; set; }
