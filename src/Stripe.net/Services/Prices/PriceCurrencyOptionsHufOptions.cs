...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHufOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHufCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHufTierOptions> Tiers { get; set; }
