...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPgkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPgkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPgkTierOptions> Tiers { get; set; }
