...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSekOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSekCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSekTierOptions> Tiers { get; set; }
