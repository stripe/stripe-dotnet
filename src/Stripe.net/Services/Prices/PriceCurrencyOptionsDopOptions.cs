...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDopOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDopCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDopTierOptions> Tiers { get; set; }
