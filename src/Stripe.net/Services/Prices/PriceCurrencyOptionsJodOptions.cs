...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJodOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJodCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJodTierOptions> Tiers { get; set; }
