...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRonOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRonCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRonTierOptions> Tiers { get; set; }
