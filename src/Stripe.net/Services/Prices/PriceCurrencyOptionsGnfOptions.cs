...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGnfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGnfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGnfTierOptions> Tiers { get; set; }
