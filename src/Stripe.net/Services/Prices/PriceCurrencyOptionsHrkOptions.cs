...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHrkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHrkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHrkTierOptions> Tiers { get; set; }
