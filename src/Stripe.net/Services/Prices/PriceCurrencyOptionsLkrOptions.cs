...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLkrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLkrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLkrTierOptions> Tiers { get; set; }
