...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBynOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBynCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBynTierOptions> Tiers { get; set; }
