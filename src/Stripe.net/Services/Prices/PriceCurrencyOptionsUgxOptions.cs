...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUgxOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUgxCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUgxTierOptions> Tiers { get; set; }
