...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJpyOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJpyCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJpyTierOptions> Tiers { get; set; }
