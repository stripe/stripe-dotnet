...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIdrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIdrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIdrTierOptions> Tiers { get; set; }
