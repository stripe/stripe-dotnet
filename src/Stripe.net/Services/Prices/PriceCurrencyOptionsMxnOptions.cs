...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMxnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMxnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMxnTierOptions> Tiers { get; set; }
