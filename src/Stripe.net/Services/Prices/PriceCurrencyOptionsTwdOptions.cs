...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTwdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTwdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTwdTierOptions> Tiers { get; set; }
