...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKmfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKmfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKmfTierOptions> Tiers { get; set; }
