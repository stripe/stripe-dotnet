...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSgdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSgdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSgdTierOptions> Tiers { get; set; }
