...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBmdTierOptions> Tiers { get; set; }
