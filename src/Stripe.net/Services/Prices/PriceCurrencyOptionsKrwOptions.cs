...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKrwOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKrwCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKrwTierOptions> Tiers { get; set; }
