...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCdfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCdfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCdfTierOptions> Tiers { get; set; }
