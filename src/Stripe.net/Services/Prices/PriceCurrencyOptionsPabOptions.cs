...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPabOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPabCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPabTierOptions> Tiers { get; set; }
