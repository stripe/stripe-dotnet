...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRsdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRsdTierOptions> Tiers { get; set; }
