...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXcdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXcdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXcdTierOptions> Tiers { get; set; }
