...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsJmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsJmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsJmdTierOptions> Tiers { get; set; }
