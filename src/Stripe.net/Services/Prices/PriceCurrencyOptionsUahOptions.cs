...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUahOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUahCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUahTierOptions> Tiers { get; set; }
