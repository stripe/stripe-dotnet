...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBobOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBobCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBobTierOptions> Tiers { get; set; }
