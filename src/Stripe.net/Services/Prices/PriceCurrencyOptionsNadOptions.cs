...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNadOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNadTierOptions> Tiers { get; set; }
