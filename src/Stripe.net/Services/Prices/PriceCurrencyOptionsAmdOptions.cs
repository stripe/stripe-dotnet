...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAmdTierOptions> Tiers { get; set; }
