...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIlsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIlsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIlsTierOptions> Tiers { get; set; }
