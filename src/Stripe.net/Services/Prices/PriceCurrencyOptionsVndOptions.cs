...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsVndOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsVndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsVndTierOptions> Tiers { get; set; }
