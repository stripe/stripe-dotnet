...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHnlOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHnlCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHnlTierOptions> Tiers { get; set; }
