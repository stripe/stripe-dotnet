...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAfnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAfnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAfnTierOptions> Tiers { get; set; }
