...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMurOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMurCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMurTierOptions> Tiers { get; set; }
