...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPkrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPkrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPkrTierOptions> Tiers { get; set; }
