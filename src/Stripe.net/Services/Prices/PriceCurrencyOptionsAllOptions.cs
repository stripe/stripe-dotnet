...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAllOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAllCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAllTierOptions> Tiers { get; set; }
