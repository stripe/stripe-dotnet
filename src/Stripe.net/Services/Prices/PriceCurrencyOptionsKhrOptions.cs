...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKhrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKhrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKhrTierOptions> Tiers { get; set; }
