...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMgaOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMgaCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMgaTierOptions> Tiers { get; set; }
