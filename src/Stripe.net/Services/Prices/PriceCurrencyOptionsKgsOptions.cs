...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKgsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKgsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKgsTierOptions> Tiers { get; set; }
