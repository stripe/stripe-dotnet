...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMkdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMkdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMkdTierOptions> Tiers { get; set; }
