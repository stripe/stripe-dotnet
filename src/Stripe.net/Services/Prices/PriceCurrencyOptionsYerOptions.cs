...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsYerOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsYerCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsYerTierOptions> Tiers { get; set; }
