...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDjfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDjfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDjfTierOptions> Tiers { get; set; }
