...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsChfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsChfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsChfTierOptions> Tiers { get; set; }
