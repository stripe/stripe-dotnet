...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKesOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKesCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKesTierOptions> Tiers { get; set; }
