...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsVuvOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsVuvCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsVuvTierOptions> Tiers { get; set; }
