...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsIskOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsIskCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsIskTierOptions> Tiers { get; set; }
