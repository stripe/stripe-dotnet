...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEgpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEgpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEgpTierOptions> Tiers { get; set; }
