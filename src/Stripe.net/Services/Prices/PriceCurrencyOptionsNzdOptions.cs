...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNzdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNzdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNzdTierOptions> Tiers { get; set; }
