...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsDkkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsDkkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsDkkTierOptions> Tiers { get; set; }
