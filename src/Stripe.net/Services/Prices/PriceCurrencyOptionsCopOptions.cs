...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCopOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCopCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCopTierOptions> Tiers { get; set; }
