...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsQarOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsQarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsQarTierOptions> Tiers { get; set; }
