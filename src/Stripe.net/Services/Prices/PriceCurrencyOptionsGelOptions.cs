...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGelOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGelCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGelTierOptions> Tiers { get; set; }
