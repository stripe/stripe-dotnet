...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsZmwOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsZmwCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsZmwTierOptions> Tiers { get; set; }
