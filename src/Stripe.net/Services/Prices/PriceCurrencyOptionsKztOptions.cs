...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKztOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKztCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKztTierOptions> Tiers { get; set; }
