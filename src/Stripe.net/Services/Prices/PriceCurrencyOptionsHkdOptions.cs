...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsHkdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsHkdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsHkdTierOptions> Tiers { get; set; }
