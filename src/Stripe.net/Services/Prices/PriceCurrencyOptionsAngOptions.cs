...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAngOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAngCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAngTierOptions> Tiers { get; set; }
