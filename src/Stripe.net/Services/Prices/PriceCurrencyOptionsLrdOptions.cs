...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLrdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLrdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLrdTierOptions> Tiers { get; set; }
