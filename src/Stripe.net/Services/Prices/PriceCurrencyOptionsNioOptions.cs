...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNioOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNioCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNioTierOptions> Tiers { get; set; }
