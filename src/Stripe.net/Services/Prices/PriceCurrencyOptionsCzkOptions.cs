...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCzkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCzkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCzkTierOptions> Tiers { get; set; }
