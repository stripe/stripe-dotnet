...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAznOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAznCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAznTierOptions> Tiers { get; set; }
