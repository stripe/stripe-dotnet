...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTjsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTjsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTjsTierOptions> Tiers { get; set; }
