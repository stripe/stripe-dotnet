...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUzsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUzsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUzsTierOptions> Tiers { get; set; }
