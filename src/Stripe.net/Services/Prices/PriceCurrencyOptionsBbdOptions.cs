...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBbdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBbdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBbdTierOptions> Tiers { get; set; }
