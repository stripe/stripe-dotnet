...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGmdTierOptions> Tiers { get; set; }
