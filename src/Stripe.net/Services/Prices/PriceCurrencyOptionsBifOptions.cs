...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBifOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBifCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBifTierOptions> Tiers { get; set; }
