...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsArsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsArsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsArsTierOptions> Tiers { get; set; }
