...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPygOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPygCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPygTierOptions> Tiers { get; set; }
