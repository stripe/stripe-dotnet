...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSarOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSarTierOptions> Tiers { get; set; }
