...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMwkOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMwkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMwkTierOptions> Tiers { get; set; }
