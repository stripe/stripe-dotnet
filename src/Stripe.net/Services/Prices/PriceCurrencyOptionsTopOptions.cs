...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTopOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTopCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTopTierOptions> Tiers { get; set; }
