...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMyrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMyrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMyrTierOptions> Tiers { get; set; }
