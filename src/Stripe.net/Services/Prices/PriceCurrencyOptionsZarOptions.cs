...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsZarOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsZarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsZarTierOptions> Tiers { get; set; }
