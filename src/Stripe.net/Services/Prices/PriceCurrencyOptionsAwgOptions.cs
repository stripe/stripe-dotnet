...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAwgOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAwgCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAwgTierOptions> Tiers { get; set; }
