...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCnyOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCnyCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCnyTierOptions> Tiers { get; set; }
