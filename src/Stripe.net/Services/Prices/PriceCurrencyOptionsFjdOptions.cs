...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsFjdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsFjdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsFjdTierOptions> Tiers { get; set; }
