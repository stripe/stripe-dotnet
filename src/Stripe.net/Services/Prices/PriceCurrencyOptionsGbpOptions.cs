...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGbpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGbpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGbpTierOptions> Tiers { get; set; }
