...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBwpOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBwpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBwpTierOptions> Tiers { get; set; }
