...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBzdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBzdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBzdTierOptions> Tiers { get; set; }
