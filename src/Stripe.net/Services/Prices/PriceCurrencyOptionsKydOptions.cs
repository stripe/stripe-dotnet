...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKydOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKydCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKydTierOptions> Tiers { get; set; }
