...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGydOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGydCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGydTierOptions> Tiers { get; set; }
