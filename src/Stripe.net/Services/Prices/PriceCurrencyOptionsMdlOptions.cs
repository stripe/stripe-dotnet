...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMdlOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMdlCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMdlTierOptions> Tiers { get; set; }
