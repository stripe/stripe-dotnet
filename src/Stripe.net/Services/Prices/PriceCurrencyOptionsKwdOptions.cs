...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsKwdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsKwdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsKwdTierOptions> Tiers { get; set; }
