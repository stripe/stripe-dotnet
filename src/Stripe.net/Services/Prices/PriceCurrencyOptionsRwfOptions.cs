...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsRwfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsRwfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsRwfTierOptions> Tiers { get; set; }
