...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXpfOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXpfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXpfTierOptions> Tiers { get; set; }
