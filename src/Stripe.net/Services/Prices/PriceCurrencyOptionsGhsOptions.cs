...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGhsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGhsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGhsTierOptions> Tiers { get; set; }
