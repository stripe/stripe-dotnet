...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsPenOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsPenCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsPenTierOptions> Tiers { get; set; }
