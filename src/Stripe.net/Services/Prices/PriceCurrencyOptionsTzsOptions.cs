...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTzsOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTzsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTzsTierOptions> Tiers { get; set; }
