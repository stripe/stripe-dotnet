...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEtbOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEtbCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEtbTierOptions> Tiers { get; set; }
