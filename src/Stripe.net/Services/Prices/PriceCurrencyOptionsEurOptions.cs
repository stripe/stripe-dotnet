...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsEurOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsEurCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsEurTierOptions> Tiers { get; set; }
