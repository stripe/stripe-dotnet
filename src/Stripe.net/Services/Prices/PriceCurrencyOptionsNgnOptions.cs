...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsNgnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsNgnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsNgnTierOptions> Tiers { get; set; }
