...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsSosOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsSosCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsSosTierOptions> Tiers { get; set; }
