...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMopOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMopCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMopTierOptions> Tiers { get; set; }
