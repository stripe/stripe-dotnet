...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsStdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsStdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsStdTierOptions> Tiers { get; set; }
