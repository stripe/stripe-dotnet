...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsGtqOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsGtqCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsGtqTierOptions> Tiers { get; set; }
