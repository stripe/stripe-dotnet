...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsLslOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsLslCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsLslTierOptions> Tiers { get; set; }
