...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsTndOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsTndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsTndTierOptions> Tiers { get; set; }
