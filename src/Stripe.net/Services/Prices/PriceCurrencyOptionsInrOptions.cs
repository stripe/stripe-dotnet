...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsInrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsInrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsInrTierOptions> Tiers { get; set; }
