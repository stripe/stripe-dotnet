...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMadOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMadTierOptions> Tiers { get; set; }
