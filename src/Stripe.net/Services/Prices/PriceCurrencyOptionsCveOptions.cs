...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsCveOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsCveCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsCveTierOptions> Tiers { get; set; }
