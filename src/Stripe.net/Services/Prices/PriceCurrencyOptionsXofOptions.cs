...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXofOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXofCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXofTierOptions> Tiers { get; set; }
