...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsBtnOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsBtnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsBtnTierOptions> Tiers { get; set; }
