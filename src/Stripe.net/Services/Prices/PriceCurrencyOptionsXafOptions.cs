...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsXafOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsXafCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsXafTierOptions> Tiers { get; set; }
