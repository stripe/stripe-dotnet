...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsMntOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsMntCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsMntTierOptions> Tiers { get; set; }
