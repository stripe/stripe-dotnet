...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsOmrOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsOmrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsOmrTierOptions> Tiers { get; set; }
