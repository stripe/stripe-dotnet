...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsAudOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsAudCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsAudTierOptions> Tiers { get; set; }
