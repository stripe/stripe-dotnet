...
namespace Stripe
{
    ...
    public class PriceCurrencyOptionsUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public PriceCurrencyOptionsUsdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<PriceCurrencyOptionsUsdTierOptions> Tiers { get; set; }
