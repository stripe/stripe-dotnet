...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLakOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsLakCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsLakTierOptions> Tiers { get; set; }
