...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSzlOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSzlCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSzlTierOptions> Tiers { get; set; }
