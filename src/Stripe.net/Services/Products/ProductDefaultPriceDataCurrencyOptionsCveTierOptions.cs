...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCveTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCveTierOptionsUpTo> UpTo { get; set; }
    }
}
