...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsJmdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyJmdTierOptionsUpTo> UpTo { get; set; }
    }
}
