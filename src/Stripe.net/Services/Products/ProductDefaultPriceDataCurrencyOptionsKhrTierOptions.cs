...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKhrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKhrTierOptionsUpTo> UpTo { get; set; }
    }
}
