...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHtgOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsHtgCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsHtgTierOptions> Tiers { get; set; }
