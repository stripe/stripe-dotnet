...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKwdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsKwdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsKwdTierOptions> Tiers { get; set; }
