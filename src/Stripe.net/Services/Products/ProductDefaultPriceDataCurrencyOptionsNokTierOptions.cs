...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNokTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNokTierOptionsUpTo> UpTo { get; set; }
    }
}
