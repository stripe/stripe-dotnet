...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsIdrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyIdrTierOptionsUpTo> UpTo { get; set; }
    }
}
