...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMgaTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMgaTierOptionsUpTo> UpTo { get; set; }
    }
}
