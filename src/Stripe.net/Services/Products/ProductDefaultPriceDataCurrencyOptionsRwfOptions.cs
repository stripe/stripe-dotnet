...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRwfOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsRwfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsRwfTierOptions> Tiers { get; set; }
