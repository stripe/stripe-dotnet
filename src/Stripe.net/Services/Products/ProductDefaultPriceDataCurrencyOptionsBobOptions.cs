...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBobOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBobCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBobTierOptions> Tiers { get; set; }
