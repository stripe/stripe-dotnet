...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMznTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMznTierOptionsUpTo> UpTo { get; set; }
    }
}
