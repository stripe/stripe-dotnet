...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRubOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsRubCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsRubTierOptions> Tiers { get; set; }
