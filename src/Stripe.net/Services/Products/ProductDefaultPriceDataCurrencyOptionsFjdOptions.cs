...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsFjdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsFjdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsFjdTierOptions> Tiers { get; set; }
