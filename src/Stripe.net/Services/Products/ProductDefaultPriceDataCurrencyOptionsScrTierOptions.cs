...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsScrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyScrTierOptionsUpTo> UpTo { get; set; }
    }
}
