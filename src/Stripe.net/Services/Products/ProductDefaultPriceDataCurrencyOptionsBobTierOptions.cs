...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBobTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBobTierOptionsUpTo> UpTo { get; set; }
    }
}
