...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGbpOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGbpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGbpTierOptions> Tiers { get; set; }
