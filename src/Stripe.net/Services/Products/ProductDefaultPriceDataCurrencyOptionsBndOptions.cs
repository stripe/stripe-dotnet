...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBndOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBndTierOptions> Tiers { get; set; }
