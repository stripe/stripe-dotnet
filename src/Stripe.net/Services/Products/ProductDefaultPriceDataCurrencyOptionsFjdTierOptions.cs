...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsFjdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyFjdTierOptionsUpTo> UpTo { get; set; }
    }
}
