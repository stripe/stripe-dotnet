...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNadOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsNadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsNadTierOptions> Tiers { get; set; }
