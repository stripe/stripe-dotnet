...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCdfTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCdfTierOptionsUpTo> UpTo { get; set; }
    }
}
