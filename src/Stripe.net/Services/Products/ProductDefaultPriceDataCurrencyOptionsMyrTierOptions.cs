...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMyrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMyrTierOptionsUpTo> UpTo { get; set; }
    }
}
