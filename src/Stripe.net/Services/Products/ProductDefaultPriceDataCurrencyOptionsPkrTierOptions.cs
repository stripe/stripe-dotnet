...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPkrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPkrTierOptionsUpTo> UpTo { get; set; }
    }
}
