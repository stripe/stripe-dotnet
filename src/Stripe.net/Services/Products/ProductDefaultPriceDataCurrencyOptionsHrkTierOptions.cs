...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHrkTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyHrkTierOptionsUpTo> UpTo { get; set; }
    }
}
