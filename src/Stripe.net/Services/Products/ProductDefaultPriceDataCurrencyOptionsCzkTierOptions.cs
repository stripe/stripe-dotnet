...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCzkTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCzkTierOptionsUpTo> UpTo { get; set; }
    }
}
