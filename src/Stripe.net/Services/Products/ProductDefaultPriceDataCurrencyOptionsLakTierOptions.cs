...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLakTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyLakTierOptionsUpTo> UpTo { get; set; }
    }
}
