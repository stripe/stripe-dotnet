...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBsdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBsdTierOptionsUpTo> UpTo { get; set; }
    }
}
