...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMroTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMroTierOptionsUpTo> UpTo { get; set; }
    }
}
