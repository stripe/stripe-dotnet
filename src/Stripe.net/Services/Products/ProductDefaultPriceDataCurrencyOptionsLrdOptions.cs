...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLrdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsLrdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsLrdTierOptions> Tiers { get; set; }
