...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSbdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencySbdTierOptionsUpTo> UpTo { get; set; }
    }
}
