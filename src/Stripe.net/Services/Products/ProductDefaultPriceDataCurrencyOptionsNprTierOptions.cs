...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNprTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNprTierOptionsUpTo> UpTo { get; set; }
    }
}
