...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSrdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencySrdTierOptionsUpTo> UpTo { get; set; }
    }
}
