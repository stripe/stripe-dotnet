...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKrwTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKrwTierOptionsUpTo> UpTo { get; set; }
    }
}
