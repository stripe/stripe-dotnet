...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsOmrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsOmrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsOmrTierOptions> Tiers { get; set; }
