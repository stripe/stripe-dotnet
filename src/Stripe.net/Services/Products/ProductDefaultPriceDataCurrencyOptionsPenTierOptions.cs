...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPenTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPenTierOptionsUpTo> UpTo { get; set; }
    }
}
