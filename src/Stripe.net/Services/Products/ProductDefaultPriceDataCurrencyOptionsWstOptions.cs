...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsWstOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsWstCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsWstTierOptions> Tiers { get; set; }
