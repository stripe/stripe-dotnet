...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNzdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNzdTierOptionsUpTo> UpTo { get; set; }
    }
}
