...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTtdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTtdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTtdTierOptions> Tiers { get; set; }
