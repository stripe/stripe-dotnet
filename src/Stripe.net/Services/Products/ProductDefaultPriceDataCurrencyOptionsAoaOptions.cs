...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAoaOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsAoaCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsAoaTierOptions> Tiers { get; set; }
