...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSzlTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencySzlTierOptionsUpTo> UpTo { get; set; }
    }
}
