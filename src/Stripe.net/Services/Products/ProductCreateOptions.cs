namespace Stripe
{
    ...
    public class ProductCreateOptions : BaseOptions, IHasId, IHasMetadata
    {
        ...
        /// <summary>
        /// An array of Connect application names or identifiers that should
        /// not be able to order the SKUs for this product.
        /// </summary>
        ...
        /// <summary>
        /// The identifier for the product. Must be unique. If not provided, an
        ...
        /// associated with this product can override this value by having its
        ...
        /// <summary>
        /// The type of the product. Either <c>service</c> or <c>good</c>.
        /// </summary>
        [JsonProperty("type")]
