...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBhdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBhdTierOptionsUpTo> UpTo { get; set; }
    }
}
