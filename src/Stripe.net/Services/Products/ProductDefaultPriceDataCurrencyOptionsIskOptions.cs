...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsIskOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsIskCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsIskTierOptions> Tiers { get; set; }
