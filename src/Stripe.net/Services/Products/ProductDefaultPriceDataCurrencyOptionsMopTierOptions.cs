...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMopTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMopTierOptionsUpTo> UpTo { get; set; }
    }
}
