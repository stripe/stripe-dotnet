...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLslOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsLslCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsLslTierOptions> Tiers { get; set; }
