...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHufOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsHufCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsHufTierOptions> Tiers { get; set; }
