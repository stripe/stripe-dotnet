...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsThbOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsThbCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsThbTierOptions> Tiers { get; set; }
