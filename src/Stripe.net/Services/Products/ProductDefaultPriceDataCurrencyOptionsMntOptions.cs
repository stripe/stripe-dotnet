...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMntOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMntCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMntTierOptions> Tiers { get; set; }
