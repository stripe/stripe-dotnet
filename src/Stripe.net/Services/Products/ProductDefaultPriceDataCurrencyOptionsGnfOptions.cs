...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGnfOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGnfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGnfTierOptions> Tiers { get; set; }
