...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPlnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsPlnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsPlnTierOptions> Tiers { get; set; }
