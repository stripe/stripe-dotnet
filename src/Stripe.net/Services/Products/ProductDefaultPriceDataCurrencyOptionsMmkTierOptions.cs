...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMmkTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMmkTierOptionsUpTo> UpTo { get; set; }
    }
}
