...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsVuvTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyVuvTierOptionsUpTo> UpTo { get; set; }
    }
}
