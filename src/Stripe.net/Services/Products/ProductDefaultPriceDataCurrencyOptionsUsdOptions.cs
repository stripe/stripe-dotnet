...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUsdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUsdTierOptions> Tiers { get; set; }
