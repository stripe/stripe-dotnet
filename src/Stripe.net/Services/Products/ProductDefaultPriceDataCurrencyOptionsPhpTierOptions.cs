...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPhpTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPhpTierOptionsUpTo> UpTo { get; set; }
    }
}
