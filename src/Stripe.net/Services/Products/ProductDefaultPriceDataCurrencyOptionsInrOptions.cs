...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsInrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsInrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsInrTierOptions> Tiers { get; set; }
