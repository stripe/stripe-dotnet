...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPabOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsPabCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsPabTierOptions> Tiers { get; set; }
