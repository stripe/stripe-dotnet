...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsXofOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsXofCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsXofTierOptions> Tiers { get; set; }
