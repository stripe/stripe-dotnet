...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBtnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBtnTierOptionsUpTo> UpTo { get; set; }
    }
}
