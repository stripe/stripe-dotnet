...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNgnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNgnTierOptionsUpTo> UpTo { get; set; }
    }
}
