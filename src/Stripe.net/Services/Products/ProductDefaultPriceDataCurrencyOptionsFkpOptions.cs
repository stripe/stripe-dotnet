...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsFkpOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsFkpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsFkpTierOptions> Tiers { get; set; }
