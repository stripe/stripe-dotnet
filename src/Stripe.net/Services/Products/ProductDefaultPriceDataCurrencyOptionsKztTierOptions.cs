...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKztTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKztTierOptionsUpTo> UpTo { get; set; }
    }
}
