...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSarOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSarTierOptions> Tiers { get; set; }
