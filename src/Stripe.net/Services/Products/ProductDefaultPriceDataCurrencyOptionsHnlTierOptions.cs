...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHnlTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyHnlTierOptionsUpTo> UpTo { get; set; }
    }
}
