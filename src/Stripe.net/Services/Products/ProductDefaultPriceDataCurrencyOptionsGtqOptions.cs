...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGtqOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGtqCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGtqTierOptions> Tiers { get; set; }
