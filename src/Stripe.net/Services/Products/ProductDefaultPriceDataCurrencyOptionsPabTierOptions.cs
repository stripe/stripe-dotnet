...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPabTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPabTierOptionsUpTo> UpTo { get; set; }
    }
}
