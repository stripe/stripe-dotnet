...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUsdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyUsdTierOptionsUpTo> UpTo { get; set; }
    }
}
