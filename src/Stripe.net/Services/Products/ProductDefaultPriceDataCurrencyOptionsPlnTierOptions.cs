...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPlnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPlnTierOptionsUpTo> UpTo { get; set; }
    }
}
