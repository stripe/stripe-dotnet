...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsDopTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyDopTierOptionsUpTo> UpTo { get; set; }
    }
}
