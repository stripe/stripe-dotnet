...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAngTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAngTierOptionsUpTo> UpTo { get; set; }
    }
}
