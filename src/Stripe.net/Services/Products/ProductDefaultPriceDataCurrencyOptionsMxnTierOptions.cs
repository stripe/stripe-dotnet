...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMxnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMxnTierOptionsUpTo> UpTo { get; set; }
    }
}
