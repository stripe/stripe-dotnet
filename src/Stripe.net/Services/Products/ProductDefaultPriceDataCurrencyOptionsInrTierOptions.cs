...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsInrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyInrTierOptionsUpTo> UpTo { get; set; }
    }
}
