...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsEurTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyEurTierOptionsUpTo> UpTo { get; set; }
    }
}
