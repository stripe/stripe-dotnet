...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKesOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsKesCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsKesTierOptions> Tiers { get; set; }
