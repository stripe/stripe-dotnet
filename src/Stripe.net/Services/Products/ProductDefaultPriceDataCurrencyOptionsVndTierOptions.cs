...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsVndTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyVndTierOptionsUpTo> UpTo { get; set; }
    }
}
