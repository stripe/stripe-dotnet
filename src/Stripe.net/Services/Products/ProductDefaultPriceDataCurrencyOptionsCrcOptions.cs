...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCrcOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsCrcCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsCrcTierOptions> Tiers { get; set; }
