...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsShpOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsShpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsShpTierOptions> Tiers { get; set; }
