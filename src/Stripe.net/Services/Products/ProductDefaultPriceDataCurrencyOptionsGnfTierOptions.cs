...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGnfTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyGnfTierOptionsUpTo> UpTo { get; set; }
    }
}
