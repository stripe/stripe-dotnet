...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNioOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsNioCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsNioTierOptions> Tiers { get; set; }
