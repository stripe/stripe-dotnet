...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsShpTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyShpTierOptionsUpTo> UpTo { get; set; }
    }
}
