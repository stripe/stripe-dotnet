...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUyuTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyUyuTierOptionsUpTo> UpTo { get; set; }
    }
}
