...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBmdTierOptions> Tiers { get; set; }
