...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRsdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyRsdTierOptionsUpTo> UpTo { get; set; }
    }
}
