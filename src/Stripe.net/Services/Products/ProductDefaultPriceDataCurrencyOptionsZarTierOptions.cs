...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsZarTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyZarTierOptionsUpTo> UpTo { get; set; }
    }
}
