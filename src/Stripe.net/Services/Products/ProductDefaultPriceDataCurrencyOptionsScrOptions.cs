...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsScrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsScrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsScrTierOptions> Tiers { get; set; }
