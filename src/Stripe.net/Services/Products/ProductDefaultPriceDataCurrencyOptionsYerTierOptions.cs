...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsYerTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyYerTierOptionsUpTo> UpTo { get; set; }
    }
}
