...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLkrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyLkrTierOptionsUpTo> UpTo { get; set; }
    }
}
