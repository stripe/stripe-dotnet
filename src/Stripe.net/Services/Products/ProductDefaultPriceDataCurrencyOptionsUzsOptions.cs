...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUzsOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUzsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUzsTierOptions> Tiers { get; set; }
