...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSekOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSekCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSekTierOptions> Tiers { get; set; }
