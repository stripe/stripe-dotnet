...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKwdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKwdTierOptionsUpTo> UpTo { get; set; }
    }
}
