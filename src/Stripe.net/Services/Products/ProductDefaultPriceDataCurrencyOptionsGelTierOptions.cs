...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGelTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyGelTierOptionsUpTo> UpTo { get; set; }
    }
}
