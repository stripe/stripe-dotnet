...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPenOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsPenCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsPenTierOptions> Tiers { get; set; }
