...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAngOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsAngCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsAngTierOptions> Tiers { get; set; }
