...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTndOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTndTierOptions> Tiers { get; set; }
