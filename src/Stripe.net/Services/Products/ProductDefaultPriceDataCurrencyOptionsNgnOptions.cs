...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNgnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsNgnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsNgnTierOptions> Tiers { get; set; }
