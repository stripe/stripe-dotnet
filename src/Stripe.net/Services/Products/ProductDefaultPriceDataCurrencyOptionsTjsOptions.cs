...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTjsOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTjsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTjsTierOptions> Tiers { get; set; }
