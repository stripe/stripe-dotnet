...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCadOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsCadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsCadTierOptions> Tiers { get; set; }
