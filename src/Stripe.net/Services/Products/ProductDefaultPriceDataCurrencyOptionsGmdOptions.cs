...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGmdTierOptions> Tiers { get; set; }
