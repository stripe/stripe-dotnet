...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsQarTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyQarTierOptionsUpTo> UpTo { get; set; }
    }
}
