...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBdtTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBdtTierOptionsUpTo> UpTo { get; set; }
    }
}
