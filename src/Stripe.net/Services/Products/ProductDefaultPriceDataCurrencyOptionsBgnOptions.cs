...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBgnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBgnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBgnTierOptions> Tiers { get; set; }
