...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsVuvOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsVuvCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsVuvTierOptions> Tiers { get; set; }
