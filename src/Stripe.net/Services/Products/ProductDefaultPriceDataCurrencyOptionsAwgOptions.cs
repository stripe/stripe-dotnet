...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAwgOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsAwgCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsAwgTierOptions> Tiers { get; set; }
