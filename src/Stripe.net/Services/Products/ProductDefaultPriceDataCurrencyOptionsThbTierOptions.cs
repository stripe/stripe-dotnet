...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsThbTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyThbTierOptionsUpTo> UpTo { get; set; }
    }
}
