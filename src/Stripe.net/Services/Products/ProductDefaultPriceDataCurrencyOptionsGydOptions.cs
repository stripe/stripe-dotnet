...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGydOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGydCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGydTierOptions> Tiers { get; set; }
