...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMntTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMntTierOptionsUpTo> UpTo { get; set; }
    }
}
