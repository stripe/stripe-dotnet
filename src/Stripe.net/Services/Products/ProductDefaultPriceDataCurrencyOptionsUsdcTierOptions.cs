...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUsdcTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyUsdcTierOptionsUpTo> UpTo { get; set; }
    }
}
