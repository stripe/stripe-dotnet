...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHtgTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyHtgTierOptionsUpTo> UpTo { get; set; }
    }
}
