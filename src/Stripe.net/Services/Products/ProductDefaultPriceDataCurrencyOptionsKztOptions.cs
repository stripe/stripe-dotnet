...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKztOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsKztCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsKztTierOptions> Tiers { get; set; }
