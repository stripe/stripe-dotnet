...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUyuOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUyuCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUyuTierOptions> Tiers { get; set; }
