...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMvrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMvrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMvrTierOptions> Tiers { get; set; }
