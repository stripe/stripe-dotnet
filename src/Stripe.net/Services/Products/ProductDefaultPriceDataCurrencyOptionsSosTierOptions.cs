...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSosTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencySosTierOptionsUpTo> UpTo { get; set; }
    }
}
