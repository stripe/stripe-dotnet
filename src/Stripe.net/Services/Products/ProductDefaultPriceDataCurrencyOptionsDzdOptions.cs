...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsDzdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsDzdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsDzdTierOptions> Tiers { get; set; }
