...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKesTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKesTierOptionsUpTo> UpTo { get; set; }
    }
}
