...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsChfOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsChfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsChfTierOptions> Tiers { get; set; }
