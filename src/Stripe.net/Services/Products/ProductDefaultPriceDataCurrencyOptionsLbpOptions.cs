...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLbpOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsLbpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsLbpTierOptions> Tiers { get; set; }
