...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNioTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNioTierOptionsUpTo> UpTo { get; set; }
    }
}
