...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsEurOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsEurCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsEurTierOptions> Tiers { get; set; }
