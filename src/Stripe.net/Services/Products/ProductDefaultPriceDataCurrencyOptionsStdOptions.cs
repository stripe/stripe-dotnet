...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsStdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsStdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsStdTierOptions> Tiers { get; set; }
