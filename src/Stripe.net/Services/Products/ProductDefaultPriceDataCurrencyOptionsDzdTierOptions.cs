...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsDzdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyDzdTierOptionsUpTo> UpTo { get; set; }
    }
}
