...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMurTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMurTierOptionsUpTo> UpTo { get; set; }
    }
}
