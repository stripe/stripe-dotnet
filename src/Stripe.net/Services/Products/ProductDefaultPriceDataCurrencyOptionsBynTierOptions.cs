...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBynTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBynTierOptionsUpTo> UpTo { get; set; }
    }
}
