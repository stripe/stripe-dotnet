...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBtnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBtnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBtnTierOptions> Tiers { get; set; }
