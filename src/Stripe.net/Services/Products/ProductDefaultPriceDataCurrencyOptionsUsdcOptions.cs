...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUsdcOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUsdcCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUsdcTierOptions> Tiers { get; set; }
