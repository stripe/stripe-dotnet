...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsVndOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsVndCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsVndTierOptions> Tiers { get; set; }
