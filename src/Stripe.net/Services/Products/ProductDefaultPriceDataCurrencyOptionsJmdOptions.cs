...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsJmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsJmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsJmdTierOptions> Tiers { get; set; }
