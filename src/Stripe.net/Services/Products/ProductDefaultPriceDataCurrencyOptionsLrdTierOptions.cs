...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLrdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyLrdTierOptionsUpTo> UpTo { get; set; }
    }
}
