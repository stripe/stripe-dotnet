...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMkdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMkdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMkdTierOptions> Tiers { get; set; }
