...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPygTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPygTierOptionsUpTo> UpTo { get; set; }
    }
}
