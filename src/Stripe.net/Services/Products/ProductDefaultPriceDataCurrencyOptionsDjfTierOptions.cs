...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsDjfTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyDjfTierOptionsUpTo> UpTo { get; set; }
    }
}
