...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAllTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAllTierOptionsUpTo> UpTo { get; set; }
    }
}
