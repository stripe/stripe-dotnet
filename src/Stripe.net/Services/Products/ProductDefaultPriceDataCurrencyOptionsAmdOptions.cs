...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAmdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsAmdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsAmdTierOptions> Tiers { get; set; }
