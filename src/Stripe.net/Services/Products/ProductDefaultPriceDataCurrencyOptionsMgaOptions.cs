...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMgaOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMgaCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMgaTierOptions> Tiers { get; set; }
