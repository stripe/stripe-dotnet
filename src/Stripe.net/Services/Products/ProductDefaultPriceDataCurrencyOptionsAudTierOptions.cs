...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAudTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAudTierOptionsUpTo> UpTo { get; set; }
    }
}
