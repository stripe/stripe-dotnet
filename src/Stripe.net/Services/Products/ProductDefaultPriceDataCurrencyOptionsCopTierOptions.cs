...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCopTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCopTierOptionsUpTo> UpTo { get; set; }
    }
}
