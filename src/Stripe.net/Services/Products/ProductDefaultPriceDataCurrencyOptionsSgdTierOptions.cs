...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSgdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencySgdTierOptionsUpTo> UpTo { get; set; }
    }
}
