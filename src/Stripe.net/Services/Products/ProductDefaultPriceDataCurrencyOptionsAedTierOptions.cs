...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAedTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAedTierOptionsUpTo> UpTo { get; set; }
    }
}
