...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGipTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyGipTierOptionsUpTo> UpTo { get; set; }
    }
}
