...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsArsTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyArsTierOptionsUpTo> UpTo { get; set; }
    }
}
