...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsArsOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsArsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsArsTierOptions> Tiers { get; set; }
