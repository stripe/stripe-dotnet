...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRsdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsRsdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsRsdTierOptions> Tiers { get; set; }
