...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsZmwOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsZmwCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsZmwTierOptions> Tiers { get; set; }
