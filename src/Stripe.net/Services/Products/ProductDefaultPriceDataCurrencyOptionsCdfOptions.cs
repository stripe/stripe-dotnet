...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCdfOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsCdfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsCdfTierOptions> Tiers { get; set; }
