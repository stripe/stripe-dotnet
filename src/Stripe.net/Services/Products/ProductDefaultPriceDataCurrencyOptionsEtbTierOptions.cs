...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsEtbTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyEtbTierOptionsUpTo> UpTo { get; set; }
    }
}
