...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHufTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyHufTierOptionsUpTo> UpTo { get; set; }
    }
}
