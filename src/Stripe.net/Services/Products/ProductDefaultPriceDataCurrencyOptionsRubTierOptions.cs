...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRubTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyRubTierOptionsUpTo> UpTo { get; set; }
    }
}
