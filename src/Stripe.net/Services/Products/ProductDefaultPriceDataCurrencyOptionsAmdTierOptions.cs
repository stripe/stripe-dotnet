...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAmdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAmdTierOptionsUpTo> UpTo { get; set; }
    }
}
