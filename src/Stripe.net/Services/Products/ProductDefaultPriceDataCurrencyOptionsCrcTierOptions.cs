...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCrcTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCrcTierOptionsUpTo> UpTo { get; set; }
    }
}
