...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsJodOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsJodCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsJodTierOptions> Tiers { get; set; }
