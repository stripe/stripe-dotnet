...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMadTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMadTierOptionsUpTo> UpTo { get; set; }
    }
}
