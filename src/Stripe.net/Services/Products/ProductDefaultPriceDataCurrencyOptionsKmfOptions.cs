...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKmfOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsKmfCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsKmfTierOptions> Tiers { get; set; }
