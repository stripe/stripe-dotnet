...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGipOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsGipCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsGipTierOptions> Tiers { get; set; }
