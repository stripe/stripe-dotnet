...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUgxOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUgxCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUgxTierOptions> Tiers { get; set; }
