...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBamTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBamTierOptionsUpTo> UpTo { get; set; }
    }
}
