...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCadTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyCadTierOptionsUpTo> UpTo { get; set; }
    }
}
