...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsClpTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyClpTierOptionsUpTo> UpTo { get; set; }
    }
}
