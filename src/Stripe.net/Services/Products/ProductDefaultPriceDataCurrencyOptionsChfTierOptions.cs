...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsChfTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyChfTierOptionsUpTo> UpTo { get; set; }
    }
}
