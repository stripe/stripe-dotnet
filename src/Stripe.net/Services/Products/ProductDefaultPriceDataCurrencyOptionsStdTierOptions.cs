...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsStdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyStdTierOptionsUpTo> UpTo { get; set; }
    }
}
