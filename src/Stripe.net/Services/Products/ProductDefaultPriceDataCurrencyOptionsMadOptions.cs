...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMadOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMadCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMadTierOptions> Tiers { get; set; }
