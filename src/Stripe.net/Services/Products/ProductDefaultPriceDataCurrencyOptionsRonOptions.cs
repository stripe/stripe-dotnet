...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRonOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsRonCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsRonTierOptions> Tiers { get; set; }
