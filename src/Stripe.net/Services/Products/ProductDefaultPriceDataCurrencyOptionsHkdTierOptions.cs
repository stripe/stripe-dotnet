...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHkdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyHkdTierOptionsUpTo> UpTo { get; set; }
    }
}
