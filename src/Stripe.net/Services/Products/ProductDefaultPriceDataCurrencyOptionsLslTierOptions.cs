...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLslTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyLslTierOptionsUpTo> UpTo { get; set; }
    }
}
