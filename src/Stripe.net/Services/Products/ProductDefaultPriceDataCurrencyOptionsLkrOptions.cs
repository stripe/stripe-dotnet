...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsLkrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsLkrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsLkrTierOptions> Tiers { get; set; }
