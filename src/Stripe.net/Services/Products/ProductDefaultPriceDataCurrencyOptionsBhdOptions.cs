...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBhdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBhdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBhdTierOptions> Tiers { get; set; }
