...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsQarOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsQarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsQarTierOptions> Tiers { get; set; }
