...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAwgTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAwgTierOptionsUpTo> UpTo { get; set; }
    }
}
