...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTopTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyTopTierOptionsUpTo> UpTo { get; set; }
    }
}
