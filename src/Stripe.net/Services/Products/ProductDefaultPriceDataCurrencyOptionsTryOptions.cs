...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTryOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTryCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTryTierOptions> Tiers { get; set; }
