...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGtqTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyGtqTierOptionsUpTo> UpTo { get; set; }
    }
}
