...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsOmrTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyOmrTierOptionsUpTo> UpTo { get; set; }
    }
}
