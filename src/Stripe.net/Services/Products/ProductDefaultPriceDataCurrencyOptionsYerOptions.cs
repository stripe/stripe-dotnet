...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsYerOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsYerCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsYerTierOptions> Tiers { get; set; }
