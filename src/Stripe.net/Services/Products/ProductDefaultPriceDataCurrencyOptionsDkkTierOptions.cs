...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsDkkTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyDkkTierOptionsUpTo> UpTo { get; set; }
    }
}
