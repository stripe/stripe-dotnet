...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsJpyOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsJpyCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsJpyTierOptions> Tiers { get; set; }
