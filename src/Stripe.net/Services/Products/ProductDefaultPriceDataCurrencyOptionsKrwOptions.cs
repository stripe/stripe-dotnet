...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKrwOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsKrwCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsKrwTierOptions> Tiers { get; set; }
