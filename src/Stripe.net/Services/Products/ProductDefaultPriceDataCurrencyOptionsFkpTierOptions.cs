...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsFkpTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyFkpTierOptionsUpTo> UpTo { get; set; }
    }
}
