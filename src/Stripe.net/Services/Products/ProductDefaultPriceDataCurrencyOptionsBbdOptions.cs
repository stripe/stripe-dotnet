...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBbdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBbdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBbdTierOptions> Tiers { get; set; }
