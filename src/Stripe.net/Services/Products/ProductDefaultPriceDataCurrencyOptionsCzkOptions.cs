...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCzkOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsCzkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsCzkTierOptions> Tiers { get; set; }
