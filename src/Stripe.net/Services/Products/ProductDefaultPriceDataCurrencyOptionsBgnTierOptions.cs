...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBgnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBgnTierOptionsUpTo> UpTo { get; set; }
    }
}
