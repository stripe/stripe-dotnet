...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSosOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSosCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSosTierOptions> Tiers { get; set; }
