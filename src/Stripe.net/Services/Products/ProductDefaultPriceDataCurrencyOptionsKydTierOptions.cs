...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsKydTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyKydTierOptionsUpTo> UpTo { get; set; }
    }
}
