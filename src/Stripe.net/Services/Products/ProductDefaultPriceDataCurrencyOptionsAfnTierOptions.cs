...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAfnTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAfnTierOptionsUpTo> UpTo { get; set; }
    }
}
