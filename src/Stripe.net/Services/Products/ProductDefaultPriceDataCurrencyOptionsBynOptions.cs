...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBynOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBynCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBynTierOptions> Tiers { get; set; }
