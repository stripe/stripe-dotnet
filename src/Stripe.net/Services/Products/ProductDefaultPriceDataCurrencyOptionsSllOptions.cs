...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSllOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSllCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSllTierOptions> Tiers { get; set; }
