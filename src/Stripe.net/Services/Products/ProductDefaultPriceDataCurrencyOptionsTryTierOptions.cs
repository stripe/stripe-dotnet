...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTryTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyTryTierOptionsUpTo> UpTo { get; set; }
    }
}
