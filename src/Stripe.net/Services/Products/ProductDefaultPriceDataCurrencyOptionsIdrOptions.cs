...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsIdrOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsIdrCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsIdrTierOptions> Tiers { get; set; }
