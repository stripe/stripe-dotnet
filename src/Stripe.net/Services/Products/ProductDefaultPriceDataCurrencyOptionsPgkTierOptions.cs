...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPgkTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyPgkTierOptionsUpTo> UpTo { get; set; }
    }
}
