...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsIskTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyIskTierOptionsUpTo> UpTo { get; set; }
    }
}
