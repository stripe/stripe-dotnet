...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTwdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTwdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTwdTierOptions> Tiers { get; set; }
