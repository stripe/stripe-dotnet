...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsCveOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsCveCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsCveTierOptions> Tiers { get; set; }
