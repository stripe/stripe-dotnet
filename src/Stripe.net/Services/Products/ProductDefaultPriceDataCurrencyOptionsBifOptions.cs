...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBifOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBifCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBifTierOptions> Tiers { get; set; }
