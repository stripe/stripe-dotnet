...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBrlTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBrlTierOptionsUpTo> UpTo { get; set; }
    }
}
