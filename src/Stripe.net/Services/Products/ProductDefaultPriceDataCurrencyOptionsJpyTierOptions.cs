...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsJpyTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyJpyTierOptionsUpTo> UpTo { get; set; }
    }
}
