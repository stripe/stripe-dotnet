...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsZarOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsZarCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsZarTierOptions> Tiers { get; set; }
