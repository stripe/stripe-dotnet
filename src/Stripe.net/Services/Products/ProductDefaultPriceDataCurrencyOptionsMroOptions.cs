...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMroOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMroCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMroTierOptions> Tiers { get; set; }
