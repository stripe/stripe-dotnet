...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsHrkOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsHrkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsHrkTierOptions> Tiers { get; set; }
