...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBdtOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsBdtCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsBdtTierOptions> Tiers { get; set; }
