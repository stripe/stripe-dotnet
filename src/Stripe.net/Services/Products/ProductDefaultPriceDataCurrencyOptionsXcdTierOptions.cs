...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsXcdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyXcdTierOptionsUpTo> UpTo { get; set; }
    }
}
