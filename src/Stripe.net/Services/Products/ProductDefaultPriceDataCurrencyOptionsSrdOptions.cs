...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsSrdOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsSrdCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsSrdTierOptions> Tiers { get; set; }
