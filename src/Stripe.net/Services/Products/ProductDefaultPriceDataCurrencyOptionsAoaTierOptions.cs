...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAoaTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyAoaTierOptionsUpTo> UpTo { get; set; }
    }
}
