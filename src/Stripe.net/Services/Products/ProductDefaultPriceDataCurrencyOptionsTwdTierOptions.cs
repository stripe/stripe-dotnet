...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTwdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyTwdTierOptionsUpTo> UpTo { get; set; }
    }
}
