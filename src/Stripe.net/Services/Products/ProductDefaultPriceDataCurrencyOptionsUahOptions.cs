...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsUahOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsUahCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsUahTierOptions> Tiers { get; set; }
