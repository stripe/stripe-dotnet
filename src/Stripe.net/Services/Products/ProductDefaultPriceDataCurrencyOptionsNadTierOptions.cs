...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsNadTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyNadTierOptionsUpTo> UpTo { get; set; }
    }
}
