...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMkdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyMkdTierOptionsUpTo> UpTo { get; set; }
    }
}
