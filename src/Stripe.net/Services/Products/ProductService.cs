...
namespace Stripe
{
        ...
        IUpdatable<Product, ProductUpdateOptions>
    {
        ...
        /// </summary>
        public virtual string SerializeBatchCreate(ProductCreateOptions options = null, RequestOptions requestOptions = null)
        {
        ...
        /// </summary>
        public virtual string SerializeBatchDelete(string id, ProductDeleteOptions options = null, RequestOptions requestOptions = null)
        {
            var requestId = Guid.NewGuid().ToString();
            var stripeVersion = StripeConfiguration.ApiVersion;
            var stripeContext = requestOptions?.StripeContext;
        ...
        /// </summary>
        public virtual string SerializeBatchUpdate(string id, ProductUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            var requestId = Guid.NewGuid().ToString();
            var stripeVersion = StripeConfiguration.ApiVersion;
            var stripeContext = requestOptions?.StripeContext;
