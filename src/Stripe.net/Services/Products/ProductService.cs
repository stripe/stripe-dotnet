...
namespace Stripe
{
        ...
        IUpdatable<Product, ProductUpdateOptions>
    {
        ...
        public virtual Product Update(string id, ProductUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.UpdateEntity(id, options, requestOptions);
        }

        public virtual Task<Product> UpdateAsync(string id, ProductUpdateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
