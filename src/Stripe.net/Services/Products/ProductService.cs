...
namespace Stripe
{
        ...
        IUpdatable<Product, ProductUpdateOptions>
    {
        ...
        {
            return this.Request<Product>(BaseAddress.Api, HttpMethod.Post, $"/v1/products", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Product>(BaseAddress.Api, HttpMethod.Post, $"/v1/products", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Product>(BaseAddress.Api, HttpMethod.Delete, $"/v1/products/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Product>(BaseAddress.Api, HttpMethod.Delete, $"/v1/products/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Product>(BaseAddress.Api, HttpMethod.Get, $"/v1/products/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Product>(BaseAddress.Api, HttpMethod.Get, $"/v1/products/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Product>>(BaseAddress.Api, HttpMethod.Get, $"/v1/products", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Product>>(BaseAddress.Api, HttpMethod.Get, $"/v1/products", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Product>($"/v1/products", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Product>($"/v1/products", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeSearchResult<Product>>(BaseAddress.Api, HttpMethod.Get, $"/v1/products/search", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeSearchResult<Product>>(BaseAddress.Api, HttpMethod.Get, $"/v1/products/search", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.SearchRequestAutoPaging<Product>($"/v1/products/search", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.SearchRequestAutoPagingAsync<Product>($"/v1/products/search", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Product>(BaseAddress.Api, HttpMethod.Post, $"/v1/products/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Product>(BaseAddress.Api, HttpMethod.Post, $"/v1/products/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
