...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBmdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBmdTierOptionsUpTo> UpTo { get; set; }
    }
}
