...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsRwfTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyRwfTierOptionsUpTo> UpTo { get; set; }
    }
}
