...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsTzsOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsTzsCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsTzsTierOptions> Tiers { get; set; }
