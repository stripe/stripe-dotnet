...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsPhpOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsPhpCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsPhpTierOptions> Tiers { get; set; }
