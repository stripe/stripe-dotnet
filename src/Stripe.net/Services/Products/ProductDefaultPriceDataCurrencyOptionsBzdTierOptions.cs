...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsBzdTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyBzdTierOptionsUpTo> UpTo { get; set; }
    }
}
