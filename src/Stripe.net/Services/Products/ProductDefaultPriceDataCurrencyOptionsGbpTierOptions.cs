...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsGbpTierOptions : INestedOptions
    {
        /// <summary>
        ...
        public AnyOf<long?, ProductDefaultPriceDataCurrencyGbpTierOptionsUpTo> UpTo { get; set; }
    }
}
