...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMxnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMxnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMxnTierOptions> Tiers { get; set; }
