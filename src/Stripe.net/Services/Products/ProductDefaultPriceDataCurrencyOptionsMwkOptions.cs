...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsMwkOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsMwkCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsMwkTierOptions> Tiers { get; set; }
