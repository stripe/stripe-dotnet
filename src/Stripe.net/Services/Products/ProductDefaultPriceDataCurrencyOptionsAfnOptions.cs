...
namespace Stripe
{
    ...
    public class ProductDefaultPriceDataCurrencyOptionsAfnOptions : INestedOptions
    {
        /// <summary>
        ...
        public ProductDefaultPriceDataCurrencyOptionsAfnCustomUnitAmountOptions CustomUnitAmount { get; set; }
        ...
        /// </summary>
        [JsonProperty("tiers")]
        public List<ProductDefaultPriceDataCurrencyOptionsAfnTierOptions> Tiers { get; set; }
