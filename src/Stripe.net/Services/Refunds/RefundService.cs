...
namespace Stripe
{
        ...
        IUpdatable<Refund, RefundUpdateOptions>
    {
        ...
        {
            return this.Request<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds/{id}/cancel", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds/{id}/cancel", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Refund>(BaseAddress.Api, HttpMethod.Get, $"/v1/refunds/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Refund>(BaseAddress.Api, HttpMethod.Get, $"/v1/refunds/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<StripeList<Refund>>(BaseAddress.Api, HttpMethod.Get, $"/v1/refunds", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<StripeList<Refund>>(BaseAddress.Api, HttpMethod.Get, $"/v1/refunds", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.ListRequestAutoPaging<Refund>($"/v1/refunds", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.ListRequestAutoPagingAsync<Refund>($"/v1/refunds", options, requestOptions, ApiMode.V1, cancellationToken);
        }
        ...
        {
            return this.Request<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds/{id}", options, requestOptions, ApiMode.V1);
        }
        ...
        {
            return this.RequestAsync<Refund>(BaseAddress.Api, HttpMethod.Post, $"/v1/refunds/{id}", options, requestOptions, ApiMode.V1, cancellationToken);
        }
    }
}
