...
namespace Stripe
{
            ...
            ICreatable<AccountSession, AccountSessionCreateOptions>
    {
        ...
        /// </summary>
        public virtual AccountSession Create(
            AccountSessionCreateOptions options,
        ...
        /// can use on their front-end to grant client-side API access.</p>.
        /// </summary>
        public virtual Task<AccountSession> CreateAsync(
            AccountSessionCreateOptions options,
            RequestOptions requestOptions = null,
            CancellationToken cancellationToken = default
        )
        {
            return this.RequestAsync<AccountSession>(
                BaseAddress.Api,
                HttpMethod.Post,
                $"/v1/account_sessions",
                options,
