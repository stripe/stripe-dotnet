...
namespace Stripe
{
    ...
    public class SetupIntentPaymentMethodOptionsKlarnaSubscriptionOptions : INestedOptions
    {
        /// <summary>
...
#endif
        public SetupIntentPaymentMethodOptionsKlarnaSubscriptionNextBillingOptions NextBilling { get; set; }
