...
namespace Stripe
{
    ...
    public class SetupIntentUpdateOptions : BaseOptions, IHasMetadata
    {
        ...
        /// </summary>
        [JsonProperty("allowed_payment_method_types", NullValueHandling = NullValueHandling.Ignore)]
        [STJS.JsonPropertyName("allowed_payment_method_types")]
        [STJS.JsonIgnore(Condition = STJS.JsonIgnoreCondition.WhenWritingNull)]
        public List<string> AllowedPaymentMethodTypes
        {
            get => this.allowedPaymentMethodTypes;
            set
            {
                this.allowedPaymentMethodTypes = value;
        ...
        /// <c>scalapay</c>, <c>sepa_debit</c>, <c>sequra</c>, <c>sofort</c>, <c>sunbit</c>,
