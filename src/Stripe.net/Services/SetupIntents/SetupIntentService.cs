...
namespace Stripe
{
        ...
        IUpdatable<SetupIntent, SetupIntentUpdateOptions>
    {
        ...
        public virtual SetupIntent Update(string id, SetupIntentUpdateOptions options = null, RequestOptions requestOptions = null)
        {
            return this.UpdateEntity(id, options, requestOptions);
        }

        public virtual Task<SetupIntent> UpdateAsync(string id, SetupIntentUpdateOptions options = null, RequestOptions requestOptions = null, CancellationToken cancellationToken = default)
        {
