...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2CoreAccountIncludingConfigurationMerchantUpdatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V2CoreAccountIncludingConfigurationMerchantUpdatedEvent>();
        }

        public Task<V2CoreAccountIncludingConfigurationMerchantUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CoreAccountIncludingConfigurationMerchantUpdatedEvent>();
        }
    }
}
