...
namespace Stripe.Events
{
    ...
    /// Automations.
    /// </summary>
    public class V1InvoiceWillBeDueEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V1InvoiceWillBeDueEvent FetchEvent()
        {
            return this.FetchEvent<V1InvoiceWillBeDueEvent>();
        }

        public Task<V1InvoiceWillBeDueEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1InvoiceWillBeDueEvent>();
        }
    }
}
