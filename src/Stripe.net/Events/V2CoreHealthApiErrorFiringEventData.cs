...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthApiErrorFiringEventData : StripeEntity<V2CoreHealthApiErrorFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthApiErrorFiringEventDataImpact Impact { get; set; }
