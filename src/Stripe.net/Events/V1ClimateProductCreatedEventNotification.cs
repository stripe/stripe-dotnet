...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ClimateProductCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ClimateProductCreatedEvent>();
        }

        public Task<V1ClimateProductCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ClimateProductCreatedEvent>();
        }
    }
}
