...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2PaymentsSettlementAllocationIntentSplitCanceledEvent : V2.Core.Event
    {
        /// <summary>
        ...
        public V2PaymentsSettlementAllocationIntentSplitCanceledEventData Data { get; set; }
