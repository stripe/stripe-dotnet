...
namespace Stripe.Events
{
    ...
    public class PushedV1CheckoutSessionAsyncPaymentSucceededEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1CheckoutSessionAsyncPaymentSucceededEvent>();
        }

        public Task<V1CheckoutSessionAsyncPaymentSucceededEvent> PullAsync()
        {
            return this.PullEventAsync<V1CheckoutSessionAsyncPaymentSucceededEvent>();
        }
    }
}
