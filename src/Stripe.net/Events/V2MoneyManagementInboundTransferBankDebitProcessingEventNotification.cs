...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementInboundTransferBankDebitProcessingEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V2MoneyManagementInboundTransferBankDebitProcessingEvent>();
        }

        public Task<V2MoneyManagementInboundTransferBankDebitProcessingEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementInboundTransferBankDebitProcessingEvent>();
        }
    }
}
