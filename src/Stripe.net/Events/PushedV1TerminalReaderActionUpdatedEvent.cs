...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1TerminalReaderActionUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1TerminalReaderActionUpdatedEvent Pull()
        {
            return this.PullEvent<V1TerminalReaderActionUpdatedEvent>();
        }

        public Task<V1TerminalReaderActionUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1TerminalReaderActionUpdatedEvent>();
        }
    }
}
