...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthMetronomeNotificationLatencyResolvedEventData : StripeEntity<V2CoreHealthMetronomeNotificationLatencyResolvedEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthMetronomeNotificationLatencyResolvedEventDataImpact Impact { get; set; }
