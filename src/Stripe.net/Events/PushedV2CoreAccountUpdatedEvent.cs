...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2CoreAccountUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2CoreAccountUpdatedEvent Pull()
        {
            return this.PullEvent<V2CoreAccountUpdatedEvent>();
        }

        public Task<V2CoreAccountUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2CoreAccountUpdatedEvent>();
        }
    }
}
