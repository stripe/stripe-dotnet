...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ClimateOrderDelayedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ClimateOrderDelayedEvent>();
        }

        public Task<V1ClimateOrderDelayedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ClimateOrderDelayedEvent>();
        }
    }
}
