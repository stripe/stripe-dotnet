...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1IssuingPersonalizationDesignUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1IssuingPersonalizationDesignUpdatedEvent Pull()
        {
            return this.PullEvent<V1IssuingPersonalizationDesignUpdatedEvent>();
        }

        public Task<V1IssuingPersonalizationDesignUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1IssuingPersonalizationDesignUpdatedEvent>();
        }
    }
}
