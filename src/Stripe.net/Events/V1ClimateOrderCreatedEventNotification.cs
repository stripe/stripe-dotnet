...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ClimateOrderCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ClimateOrderCreatedEvent>();
        }

        public Task<V1ClimateOrderCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ClimateOrderCreatedEvent>();
        }
    }
}
