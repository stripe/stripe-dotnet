...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CreditNoteVoidedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CreditNoteVoidedEvent>();
        }

        public Task<V1CreditNoteVoidedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CreditNoteVoidedEvent>();
        }
    }
}
