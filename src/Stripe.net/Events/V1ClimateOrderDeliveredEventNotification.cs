...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ClimateOrderDeliveredEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ClimateOrderDeliveredEvent>();
        }

        public Task<V1ClimateOrderDeliveredEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ClimateOrderDeliveredEvent>();
        }
    }
}
