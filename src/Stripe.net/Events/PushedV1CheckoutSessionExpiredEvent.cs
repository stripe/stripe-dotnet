...
namespace Stripe.Events
{
    ...
    public class PushedV1CheckoutSessionExpiredEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1CheckoutSessionExpiredEvent>();
        }

        public Task<V1CheckoutSessionExpiredEvent> PullAsync()
        {
            return this.PullEventAsync<V1CheckoutSessionExpiredEvent>();
        }
    }
}
