...
namespace Stripe.Events
{
    ...
    /// capture.
    /// </summary>
    public class V1ChargeUpdatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeUpdatedEvent>();
        }

        public Task<V1ChargeUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeUpdatedEvent>();
        }
    }
}
