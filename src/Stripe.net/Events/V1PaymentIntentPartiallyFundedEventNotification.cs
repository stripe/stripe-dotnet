...
namespace Stripe.Events
{
    ...
    public class V1PaymentIntentPartiallyFundedEventNotification : V2.Core.EventNotification
    {
        ...
        public V1PaymentIntentPartiallyFundedEvent FetchEvent()
        {
            return this.FetchEvent<V1PaymentIntentPartiallyFundedEvent>();
        }

        public Task<V1PaymentIntentPartiallyFundedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1PaymentIntentPartiallyFundedEvent>();
        }
    }
}
