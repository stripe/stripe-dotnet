...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementPayoutMethodUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementPayoutMethodUpdatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementPayoutMethodUpdatedEvent>();
        }

        public Task<V2MoneyManagementPayoutMethodUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementPayoutMethodUpdatedEvent>();
        }
    }
}
