...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementCreatedEventDataOrchestratorDetails : StripeEntity<V2OrchestratedCommerceAgreementCreatedEventDataOrchestratorDetails>
    {
        /// <summary>
