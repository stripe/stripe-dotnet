...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2BillingRateCardCustomPricingUnitOverageRateCreatedEvent : V2.Core.Event
    {
        /// <summary>
        ...
        public V2BillingRateCardCustomPricingUnitOverageRateCreatedEventData Data { get; set; }
