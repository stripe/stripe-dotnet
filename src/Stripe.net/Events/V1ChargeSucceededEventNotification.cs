...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ChargeSucceededEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeSucceededEvent>();
        }

        public Task<V1ChargeSucceededEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeSucceededEvent>();
        }
    }
}
