...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingLicensedItemCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingLicensedItemCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingLicensedItemCreatedEvent>();
        }

        public Task<V2BillingLicensedItemCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingLicensedItemCreatedEvent>();
        }
    }
}
