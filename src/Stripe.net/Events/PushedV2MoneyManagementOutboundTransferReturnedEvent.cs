...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundTransferReturnedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferReturnedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundTransferReturnedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferReturnedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundTransferReturnedEvent>();
        }
    }
}
