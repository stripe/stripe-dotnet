...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementPartiallyConfirmedEventDataOrchestratorDetails : StripeEntity<V2OrchestratedCommerceAgreementPartiallyConfirmedEventDataOrchestratorDetails>
    {
        /// <summary>
