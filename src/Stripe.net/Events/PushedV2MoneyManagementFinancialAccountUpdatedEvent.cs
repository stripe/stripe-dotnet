...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementFinancialAccountUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementFinancialAccountUpdatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementFinancialAccountUpdatedEvent>();
        }

        public Task<V2MoneyManagementFinancialAccountUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementFinancialAccountUpdatedEvent>();
        }
    }
}
