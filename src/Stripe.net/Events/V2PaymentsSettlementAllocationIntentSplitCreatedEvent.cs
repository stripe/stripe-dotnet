...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2PaymentsSettlementAllocationIntentSplitCreatedEvent : V2.Core.Event
    {
        /// <summary>
        ...
        public V2PaymentsSettlementAllocationIntentSplitCreatedEventData Data { get; set; }
