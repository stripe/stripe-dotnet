...
namespace Stripe.Events
{
    ...
    public class V1CustomerSubscriptionUpdatedEventNotification : V2.Core.EventNotification
    {
        ...
        public V1CustomerSubscriptionUpdatedEvent FetchEvent()
        {
            return this.FetchEvent<V1CustomerSubscriptionUpdatedEvent>();
        }

        public Task<V1CustomerSubscriptionUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CustomerSubscriptionUpdatedEvent>();
        }
    }
}
