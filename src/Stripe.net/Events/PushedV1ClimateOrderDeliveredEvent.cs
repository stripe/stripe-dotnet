...
namespace Stripe.Events
{
    ...
    public class PushedV1ClimateOrderDeliveredEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ClimateOrderDeliveredEvent>();
        }

        public Task<V1ClimateOrderDeliveredEvent> PullAsync()
        {
            return this.PullEventAsync<V1ClimateOrderDeliveredEvent>();
        }
    }
}
