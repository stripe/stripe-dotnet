...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementConfirmedEventDataSellerDetails : StripeEntity<V2OrchestratedCommerceAgreementConfirmedEventDataSellerDetails>
    {
        /// <summary>
