...
namespace Stripe.Events
{
    ...
    /// updated.
    /// </summary>
    public class V2CoreAccountIncludingConfigurationMoneyManagerCapabilityStatusUpdatedEvent : V2.Core.Event
    {
        /// <summary>
        /// Data for the v2.core.account[configuration.money_manager].capability_status_updated
        /// event.
        /// </summary>
        [JsonProperty("data")]
