...
namespace Stripe.Events
{
    ...
    public class PushedV2CoreClaimableSandboxExpiredEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V2CoreClaimableSandboxExpiredEvent>();
        }

        public Task<V2CoreClaimableSandboxExpiredEvent> PullAsync()
        {
            return this.PullEventAsync<V2CoreClaimableSandboxExpiredEvent>();
        }
    }
}
