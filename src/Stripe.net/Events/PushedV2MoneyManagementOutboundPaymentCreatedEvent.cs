...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundPaymentCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentCreatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundPaymentCreatedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundPaymentCreatedEvent>();
        }
    }
}
