...
namespace Stripe.Events
{
    ...
    public class V2CommerceProductCatalogImportsSucceededEventNotification : V2.Core.EventNotification
    {
        ...
        {
            return this.FetchEvent<V2CommerceProductCatalogImportsSucceededEvent>();
        }

        public Task<V2CommerceProductCatalogImportsSucceededEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CommerceProductCatalogImportsSucceededEvent>();
        }
    }
}
