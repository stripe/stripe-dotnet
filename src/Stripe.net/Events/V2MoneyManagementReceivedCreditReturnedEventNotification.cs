...
namespace Stripe.Events
{
    ...
    /// your balance.
    /// </summary>
    public class V2MoneyManagementReceivedCreditReturnedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedCreditReturnedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementReceivedCreditReturnedEvent>();
        }

        public Task<V2MoneyManagementReceivedCreditReturnedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementReceivedCreditReturnedEvent>();
        }
    }
}
