...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CouponDeletedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CouponDeletedEvent>();
        }

        public Task<V1CouponDeletedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CouponDeletedEvent>();
        }
    }
}
