...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementFinancialAccountCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementFinancialAccountCreatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementFinancialAccountCreatedEvent>();
        }

        public Task<V2MoneyManagementFinancialAccountCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementFinancialAccountCreatedEvent>();
        }
    }
}
