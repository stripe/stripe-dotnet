...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementOutboundPaymentFailedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentFailedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementOutboundPaymentFailedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementOutboundPaymentFailedEvent>();
        }
    }
}
