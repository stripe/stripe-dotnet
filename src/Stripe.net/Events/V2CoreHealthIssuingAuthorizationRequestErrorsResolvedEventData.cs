...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEventData : StripeEntity<V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEventData>
    {
        /// <summary>
...
#endif
        public V2CoreHealthIssuingAuthorizationRequestErrorsResolvedEventDataImpact Impact { get; set; }
