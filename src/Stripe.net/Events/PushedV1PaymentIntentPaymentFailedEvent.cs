...
namespace Stripe.Events
{
    ...
    /// payment.
    /// </summary>
    public class PushedV1PaymentIntentPaymentFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1PaymentIntentPaymentFailedEvent Pull()
        {
            return this.PullEvent<V1PaymentIntentPaymentFailedEvent>();
        }

        public Task<V1PaymentIntentPaymentFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V1PaymentIntentPaymentFailedEvent>();
        }
    }
}
