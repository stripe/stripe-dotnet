...
namespace Stripe.Events
{
    ...
    public class V2CommerceProductCatalogImportsFailedEventNotification : V2.Core.EventNotification
    {
        ...
        {
            return this.FetchEvent<V2CommerceProductCatalogImportsFailedEvent>();
        }

        public Task<V2CommerceProductCatalogImportsFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CommerceProductCatalogImportsFailedEvent>();
        }
    }
}
