...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1InvoiceDeletedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1InvoiceDeletedEvent Pull()
        {
            return this.PullEvent<V1InvoiceDeletedEvent>();
        }

        public Task<V1InvoiceDeletedEvent> PullAsync()
        {
            return this.PullEventAsync<V1InvoiceDeletedEvent>();
        }
    }
}
