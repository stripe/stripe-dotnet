...
namespace Stripe.Events
{
    ...
    public class PushedV1BillingPortalConfigurationUpdatedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1BillingPortalConfigurationUpdatedEvent>();
        }

        public Task<V1BillingPortalConfigurationUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1BillingPortalConfigurationUpdatedEvent>();
        }
    }
}
