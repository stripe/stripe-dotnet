...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthElementsErrorFiringEventData : StripeEntity<V2CoreHealthElementsErrorFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthElementsErrorFiringEventDataImpact Impact { get; set; }
