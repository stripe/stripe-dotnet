...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthAuthorizationRateDropFiringEventDataImpact : StripeEntity<V2CoreHealthAuthorizationRateDropFiringEventDataImpact>
    {
        /// <summary>
...
#endif
        public List<V2CoreHealthAuthorizationRateDropFiringEventDataImpactDimension> Dimensions { get; set; }
