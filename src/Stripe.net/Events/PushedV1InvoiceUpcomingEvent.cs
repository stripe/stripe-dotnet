...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1InvoiceUpcomingEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1InvoiceUpcomingEvent Pull()
        {
            return this.PullEvent<V1InvoiceUpcomingEvent>();
        }

        public Task<V1InvoiceUpcomingEvent> PullAsync()
        {
            return this.PullEventAsync<V1InvoiceUpcomingEvent>();
        }
    }
}
