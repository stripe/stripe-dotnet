...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementReceivedDebitFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedDebitFailedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementReceivedDebitFailedEvent>();
        }

        public Task<V2MoneyManagementReceivedDebitFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementReceivedDebitFailedEvent>();
        }
    }
}
