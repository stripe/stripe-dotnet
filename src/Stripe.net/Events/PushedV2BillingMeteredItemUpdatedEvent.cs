...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingMeteredItemUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingMeteredItemUpdatedEvent Pull()
        {
            return this.PullEvent<V2BillingMeteredItemUpdatedEvent>();
        }

        public Task<V2BillingMeteredItemUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingMeteredItemUpdatedEvent>();
        }
    }
}
