...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthApiLatencyResolvedEventDataImpactTopImpactedAccount : StripeEntity<V2CoreHealthApiLatencyResolvedEventDataImpactTopImpactedAccount>
    {
        /// <summary>
