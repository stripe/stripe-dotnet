...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementAdjustmentCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementAdjustmentCreatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementAdjustmentCreatedEvent>();
        }

        public Task<V2MoneyManagementAdjustmentCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementAdjustmentCreatedEvent>();
        }
    }
}
