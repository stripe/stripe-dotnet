...
namespace Stripe.Events
{
    ...
    /// paused.
    /// </summary>
    public class V1CustomerSubscriptionPausedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V1CustomerSubscriptionPausedEvent FetchEvent()
        {
            return this.FetchEvent<V1CustomerSubscriptionPausedEvent>();
        }

        public Task<V1CustomerSubscriptionPausedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CustomerSubscriptionPausedEvent>();
        }
    }
}
