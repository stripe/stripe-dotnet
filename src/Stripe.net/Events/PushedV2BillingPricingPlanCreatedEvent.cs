...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingPricingPlanCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingPricingPlanCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingPricingPlanCreatedEvent>();
        }

        public Task<V2BillingPricingPlanCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingPricingPlanCreatedEvent>();
        }
    }
}
