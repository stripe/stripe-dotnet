...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementFinancialAddressFailedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementFinancialAddressFailedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementFinancialAddressFailedEvent>();
        }

        public Task<V2MoneyManagementFinancialAddressFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementFinancialAddressFailedEvent>();
        }
    }
}
