...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthInvoiceCountDroppedResolvedEventData : StripeEntity<V2CoreHealthInvoiceCountDroppedResolvedEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthInvoiceCountDroppedResolvedEventDataImpact Impact { get; set; }
