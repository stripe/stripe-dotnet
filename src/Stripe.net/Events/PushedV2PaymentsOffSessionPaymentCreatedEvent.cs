...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2PaymentsOffSessionPaymentCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2PaymentsOffSessionPaymentCreatedEvent Pull()
        {
            return this.PullEvent<V2PaymentsOffSessionPaymentCreatedEvent>();
        }

        public Task<V2PaymentsOffSessionPaymentCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2PaymentsOffSessionPaymentCreatedEvent>();
        }
    }
}
