...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingBillSettingUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingBillSettingUpdatedEvent Pull()
        {
            return this.PullEvent<V2BillingBillSettingUpdatedEvent>();
        }

        public Task<V2BillingBillSettingUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingBillSettingUpdatedEvent>();
        }
    }
}
