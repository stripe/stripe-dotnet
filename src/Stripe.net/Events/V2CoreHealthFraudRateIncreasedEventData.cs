...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthFraudRateIncreasedEventData : StripeEntity<V2CoreHealthFraudRateIncreasedEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthFraudRateIncreasedEventDataImpact Impact { get; set; }
