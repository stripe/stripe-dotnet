...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingLicenseFeeVersionCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingLicenseFeeVersionCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingLicenseFeeVersionCreatedEvent>();
        }

        public Task<V2BillingLicenseFeeVersionCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingLicenseFeeVersionCreatedEvent>();
        }
    }
}
