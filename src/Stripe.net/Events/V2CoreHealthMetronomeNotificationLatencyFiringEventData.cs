...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthMetronomeNotificationLatencyFiringEventData : StripeEntity<V2CoreHealthMetronomeNotificationLatencyFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthMetronomeNotificationLatencyFiringEventDataImpact Impact { get; set; }
