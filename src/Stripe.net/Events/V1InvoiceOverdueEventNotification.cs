...
namespace Stripe.Events
{
    ...
    /// Automations.
    /// </summary>
    public class V1InvoiceOverdueEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V1InvoiceOverdueEvent FetchEvent()
        {
            return this.FetchEvent<V1InvoiceOverdueEvent>();
        }

        public Task<V1InvoiceOverdueEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1InvoiceOverdueEvent>();
        }
    }
}
