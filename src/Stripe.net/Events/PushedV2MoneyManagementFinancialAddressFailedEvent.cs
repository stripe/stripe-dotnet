...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementFinancialAddressFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementFinancialAddressFailedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementFinancialAddressFailedEvent>();
        }

        public Task<V2MoneyManagementFinancialAddressFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementFinancialAddressFailedEvent>();
        }
    }
}
