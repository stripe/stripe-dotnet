...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2CoreAccountPersonCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        {
            return this.PullEvent<V2CoreAccountPersonCreatedEvent>();
        }

        public Task<V2CoreAccountPersonCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2CoreAccountPersonCreatedEvent>();
        }
    }
}
