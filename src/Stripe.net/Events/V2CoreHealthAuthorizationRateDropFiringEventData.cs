...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthAuthorizationRateDropFiringEventData : StripeEntity<V2CoreHealthAuthorizationRateDropFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthAuthorizationRateDropFiringEventDataImpact Impact { get; set; }
