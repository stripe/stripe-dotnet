...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1IssuingAuthorizationRequestEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1IssuingAuthorizationRequestEvent Pull()
        {
            return this.PullEvent<V1IssuingAuthorizationRequestEvent>();
        }

        public Task<V1IssuingAuthorizationRequestEvent> PullAsync()
        {
            return this.PullEventAsync<V1IssuingAuthorizationRequestEvent>();
        }
    }
}
