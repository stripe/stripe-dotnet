...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthMeterEventSummariesDelayedResolvedEventData : StripeEntity<V2CoreHealthMeterEventSummariesDelayedResolvedEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthMeterEventSummariesDelayedResolvedEventDataImpact Impact { get; set; }
