...
namespace Stripe.Events
{
    ...
    public class PushedV1ChargeDisputeFundsWithdrawnEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ChargeDisputeFundsWithdrawnEvent>();
        }

        public Task<V1ChargeDisputeFundsWithdrawnEvent> PullAsync()
        {
            return this.PullEventAsync<V1ChargeDisputeFundsWithdrawnEvent>();
        }
    }
}
