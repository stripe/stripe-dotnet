...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CapabilityUpdatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CapabilityUpdatedEvent>();
        }

        public Task<V1CapabilityUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CapabilityUpdatedEvent>();
        }
    }
}
