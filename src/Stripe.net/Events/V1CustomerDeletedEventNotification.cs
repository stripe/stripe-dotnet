...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CustomerDeletedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CustomerDeletedEvent>();
        }

        public Task<V1CustomerDeletedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CustomerDeletedEvent>();
        }
    }
}
