...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1InvoiceOverpaidEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1InvoiceOverpaidEvent Pull()
        {
            return this.PullEvent<V1InvoiceOverpaidEvent>();
        }

        public Task<V1InvoiceOverpaidEvent> PullAsync()
        {
            return this.PullEventAsync<V1InvoiceOverpaidEvent>();
        }
    }
}
