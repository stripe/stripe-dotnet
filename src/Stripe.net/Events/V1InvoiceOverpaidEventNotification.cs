...
namespace Stripe.Events
{
    ...
    public class V1InvoiceOverpaidEventNotification : V2.EventNotification
    {
        ...
        public V1InvoiceOverpaidEvent FetchEvent()
        {
            return this.FetchEvent<V1InvoiceOverpaidEvent>();
        }

        public Task<V1InvoiceOverpaidEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1InvoiceOverpaidEvent>();
        }
    }
}
