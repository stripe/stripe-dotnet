...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementConfirmedEventData : StripeEntity<V2OrchestratedCommerceAgreementConfirmedEventData>
    {
        /// <summary>
        ...
        public V2OrchestratedCommerceAgreementConfirmedEventDataOrchestratorDetails OrchestratorDetails { get; set; }
        ...
        public V2OrchestratedCommerceAgreementConfirmedEventDataSellerDetails SellerDetails { get; set; }
    }
}
