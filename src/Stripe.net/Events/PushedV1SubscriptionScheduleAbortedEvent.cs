...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1SubscriptionScheduleAbortedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1SubscriptionScheduleAbortedEvent Pull()
        {
            return this.PullEvent<V1SubscriptionScheduleAbortedEvent>();
        }

        public Task<V1SubscriptionScheduleAbortedEvent> PullAsync()
        {
            return this.PullEventAsync<V1SubscriptionScheduleAbortedEvent>();
        }
    }
}
