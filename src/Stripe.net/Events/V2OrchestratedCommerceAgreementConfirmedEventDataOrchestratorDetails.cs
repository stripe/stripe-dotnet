...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementConfirmedEventDataOrchestratorDetails : StripeEntity<V2OrchestratedCommerceAgreementConfirmedEventDataOrchestratorDetails>
    {
        /// <summary>
