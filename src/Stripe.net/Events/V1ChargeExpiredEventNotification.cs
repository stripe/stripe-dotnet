...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ChargeExpiredEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeExpiredEvent>();
        }

        public Task<V1ChargeExpiredEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeExpiredEvent>();
        }
    }
}
