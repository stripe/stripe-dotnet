...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEvent>();
        }

        public Task<V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2BillingRateCardSubscriptionCollectionAwaitingCustomerActionEvent>();
        }
    }
}
