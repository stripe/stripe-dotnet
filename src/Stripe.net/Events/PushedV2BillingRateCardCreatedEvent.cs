...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingRateCardCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingRateCardCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingRateCardCreatedEvent>();
        }

        public Task<V2BillingRateCardCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingRateCardCreatedEvent>();
        }
    }
}
