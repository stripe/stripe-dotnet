...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CouponUpdatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CouponUpdatedEvent>();
        }

        public Task<V1CouponUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CouponUpdatedEvent>();
        }
    }
}
