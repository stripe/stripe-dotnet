...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1BillingPortalConfigurationCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1BillingPortalConfigurationCreatedEvent>();
        }

        public Task<V1BillingPortalConfigurationCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1BillingPortalConfigurationCreatedEvent>();
        }
    }
}
