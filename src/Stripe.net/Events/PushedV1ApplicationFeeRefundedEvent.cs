...
namespace Stripe.Events
{
    ...
    public class PushedV1ApplicationFeeRefundedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ApplicationFeeRefundedEvent>();
        }

        public Task<V1ApplicationFeeRefundedEvent> PullAsync()
        {
            return this.PullEventAsync<V1ApplicationFeeRefundedEvent>();
        }
    }
}
