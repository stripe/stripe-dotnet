...
namespace Stripe.Events
{
    ...
    /// resumed.
    /// </summary>
    public class PushedV1CustomerSubscriptionResumedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1CustomerSubscriptionResumedEvent Pull()
        {
            return this.PullEvent<V1CustomerSubscriptionResumedEvent>();
        }

        public Task<V1CustomerSubscriptionResumedEvent> PullAsync()
        {
            return this.PullEventAsync<V1CustomerSubscriptionResumedEvent>();
        }
    }
}
