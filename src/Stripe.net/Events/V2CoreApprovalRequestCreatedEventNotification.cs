...
namespace Stripe.Events
{
    ...
    public class V2CoreApprovalRequestCreatedEventNotification : V2.Core.EventNotification
    {
        ...
        {
            return this.FetchEvent<V2CoreApprovalRequestCreatedEvent>();
        }

        public Task<V2CoreApprovalRequestCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CoreApprovalRequestCreatedEvent>();
        }
    }
}
