...
namespace Stripe.Events
{
    ...
    public class PushedV1ClimateOrderCanceledEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ClimateOrderCanceledEvent>();
        }

        public Task<V1ClimateOrderCanceledEvent> PullAsync()
        {
            return this.PullEventAsync<V1ClimateOrderCanceledEvent>();
        }
    }
}
