...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ChargeDisputeCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeDisputeCreatedEvent>();
        }

        public Task<V1ChargeDisputeCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeDisputeCreatedEvent>();
        }
    }
}
