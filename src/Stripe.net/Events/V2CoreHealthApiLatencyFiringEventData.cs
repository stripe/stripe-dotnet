...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthApiLatencyFiringEventData : StripeEntity<V2CoreHealthApiLatencyFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthApiLatencyFiringEventDataImpact Impact { get; set; }
