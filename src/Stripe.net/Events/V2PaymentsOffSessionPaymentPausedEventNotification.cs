...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2PaymentsOffSessionPaymentPausedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2PaymentsOffSessionPaymentPausedEvent FetchEvent()
        {
            return this.FetchEvent<V2PaymentsOffSessionPaymentPausedEvent>();
        }

        public Task<V2PaymentsOffSessionPaymentPausedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2PaymentsOffSessionPaymentPausedEvent>();
        }
    }
}
