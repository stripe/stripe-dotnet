...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1IssuingDisputeFundsRescindedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1IssuingDisputeFundsRescindedEvent Pull()
        {
            return this.PullEvent<V1IssuingDisputeFundsRescindedEvent>();
        }

        public Task<V1IssuingDisputeFundsRescindedEvent> PullAsync()
        {
            return this.PullEventAsync<V1IssuingDisputeFundsRescindedEvent>();
        }
    }
}
