...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementOutboundTransferPostedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferPostedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementOutboundTransferPostedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferPostedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementOutboundTransferPostedEvent>();
        }
    }
}
