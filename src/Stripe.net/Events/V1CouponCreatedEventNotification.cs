...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CouponCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CouponCreatedEvent>();
        }

        public Task<V1CouponCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CouponCreatedEvent>();
        }
    }
}
