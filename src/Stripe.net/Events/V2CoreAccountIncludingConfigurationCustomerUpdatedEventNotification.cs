...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2CoreAccountIncludingConfigurationCustomerUpdatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V2CoreAccountIncludingConfigurationCustomerUpdatedEvent>();
        }

        public Task<V2CoreAccountIncludingConfigurationCustomerUpdatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CoreAccountIncludingConfigurationCustomerUpdatedEvent>();
        }
    }
}
