...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementReceivedDebitUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedDebitUpdatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementReceivedDebitUpdatedEvent>();
        }

        public Task<V2MoneyManagementReceivedDebitUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementReceivedDebitUpdatedEvent>();
        }
    }
}
