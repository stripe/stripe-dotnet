...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementRecipientVerificationUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementRecipientVerificationUpdatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementRecipientVerificationUpdatedEvent>();
        }

        public Task<V2MoneyManagementRecipientVerificationUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementRecipientVerificationUpdatedEvent>();
        }
    }
}
