...
namespace Stripe.Events
{
    ...
    /// is unretryable.
    /// </summary>
    public class PushedV2PaymentsOffSessionPaymentFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2PaymentsOffSessionPaymentFailedEvent Pull()
        {
            return this.PullEvent<V2PaymentsOffSessionPaymentFailedEvent>();
        }

        public Task<V2PaymentsOffSessionPaymentFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2PaymentsOffSessionPaymentFailedEvent>();
        }
    }
}
