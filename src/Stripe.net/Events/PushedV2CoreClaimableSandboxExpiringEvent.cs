...
namespace Stripe.Events
{
    ...
    public class PushedV2CoreClaimableSandboxExpiringEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V2CoreClaimableSandboxExpiringEvent>();
        }

        public Task<V2CoreClaimableSandboxExpiringEvent> PullAsync()
        {
            return this.PullEventAsync<V2CoreClaimableSandboxExpiringEvent>();
        }
    }
}
