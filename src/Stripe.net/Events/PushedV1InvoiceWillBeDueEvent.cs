...
namespace Stripe.Events
{
    ...
    /// Automations.
    /// </summary>
    public class PushedV1InvoiceWillBeDueEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1InvoiceWillBeDueEvent Pull()
        {
            return this.PullEvent<V1InvoiceWillBeDueEvent>();
        }

        public Task<V1InvoiceWillBeDueEvent> PullAsync()
        {
            return this.PullEventAsync<V1InvoiceWillBeDueEvent>();
        }
    }
}
