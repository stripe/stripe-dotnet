...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundTransferCanceledEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferCanceledEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundTransferCanceledEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferCanceledEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundTransferCanceledEvent>();
        }
    }
}
