...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CreditNoteCreatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CreditNoteCreatedEvent>();
        }

        public Task<V1CreditNoteCreatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CreditNoteCreatedEvent>();
        }
    }
}
