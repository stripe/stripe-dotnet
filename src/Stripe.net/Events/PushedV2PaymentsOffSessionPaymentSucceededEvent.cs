...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2PaymentsOffSessionPaymentSucceededEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2PaymentsOffSessionPaymentSucceededEvent Pull()
        {
            return this.PullEvent<V2PaymentsOffSessionPaymentSucceededEvent>();
        }

        public Task<V2PaymentsOffSessionPaymentSucceededEvent> PullAsync()
        {
            return this.PullEventAsync<V2PaymentsOffSessionPaymentSucceededEvent>();
        }
    }
}
