...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthWebhookLatencyResolvedEventData : StripeEntity<V2CoreHealthWebhookLatencyResolvedEventData>
    {
        /// <summary>
...
#endif
        public V2CoreHealthWebhookLatencyResolvedEventDataImpact Impact { get; set; }
