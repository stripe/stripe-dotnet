...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundPaymentUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentUpdatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundPaymentUpdatedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundPaymentUpdatedEvent>();
        }
    }
}
