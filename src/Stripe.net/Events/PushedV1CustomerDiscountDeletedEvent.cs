...
namespace Stripe.Events
{
    ...
    public class PushedV1CustomerDiscountDeletedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1CustomerDiscountDeletedEvent>();
        }

        public Task<V1CustomerDiscountDeletedEvent> PullAsync()
        {
            return this.PullEventAsync<V1CustomerDiscountDeletedEvent>();
        }
    }
}
