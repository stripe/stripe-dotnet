...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1CheckoutSessionCompletedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1CheckoutSessionCompletedEvent>();
        }

        public Task<V1CheckoutSessionCompletedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1CheckoutSessionCompletedEvent>();
        }
    }
}
