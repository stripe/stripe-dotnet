...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthElementsErrorResolvedEventData : StripeEntity<V2CoreHealthElementsErrorResolvedEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthElementsErrorResolvedEventDataImpact Impact { get; set; }
