...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2BillingPricingPlanSubscriptionCollectionCurrentEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V2BillingPricingPlanSubscriptionCollectionCurrentEvent>();
        }

        public Task<V2BillingPricingPlanSubscriptionCollectionCurrentEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2BillingPricingPlanSubscriptionCollectionCurrentEvent>();
        }
    }
}
