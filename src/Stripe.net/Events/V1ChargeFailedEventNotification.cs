...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ChargeFailedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeFailedEvent>();
        }

        public Task<V1ChargeFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeFailedEvent>();
        }
    }
}
