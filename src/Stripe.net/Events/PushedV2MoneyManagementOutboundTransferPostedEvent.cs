...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundTransferPostedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferPostedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundTransferPostedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferPostedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundTransferPostedEvent>();
        }
    }
}
