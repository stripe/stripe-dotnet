...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingRateCardSubscriptionCanceledEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingRateCardSubscriptionCanceledEvent Pull()
        {
            return this.PullEvent<V2BillingRateCardSubscriptionCanceledEvent>();
        }

        public Task<V2BillingRateCardSubscriptionCanceledEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingRateCardSubscriptionCanceledEvent>();
        }
    }
}
