...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1IssuingPersonalizationDesignDeactivatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V1IssuingPersonalizationDesignDeactivatedEvent FetchEvent()
        {
            return this.FetchEvent<V1IssuingPersonalizationDesignDeactivatedEvent>();
        }

        public Task<V1IssuingPersonalizationDesignDeactivatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1IssuingPersonalizationDesignDeactivatedEvent>();
        }
    }
}
