...
namespace Stripe.Events
{
    ...
    /// <c>canceled</c>.
    /// </summary>
    public class PushedV1ReviewClosedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1ReviewClosedEvent Pull()
        {
            return this.PullEvent<V1ReviewClosedEvent>();
        }

        public Task<V1ReviewClosedEvent> PullAsync()
        {
            return this.PullEventAsync<V1ReviewClosedEvent>();
        }
    }
}
