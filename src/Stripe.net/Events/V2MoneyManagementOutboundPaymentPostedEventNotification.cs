...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementOutboundPaymentPostedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentPostedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementOutboundPaymentPostedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentPostedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementOutboundPaymentPostedEvent>();
        }
    }
}
