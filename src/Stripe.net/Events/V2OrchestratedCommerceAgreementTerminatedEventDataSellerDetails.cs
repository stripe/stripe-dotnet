...
namespace Stripe.Events
{
    ...
    public class V2OrchestratedCommerceAgreementTerminatedEventDataSellerDetails : StripeEntity<V2OrchestratedCommerceAgreementTerminatedEventDataSellerDetails>
    {
        /// <summary>
