...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1IssuingPersonalizationDesignRejectedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1IssuingPersonalizationDesignRejectedEvent Pull()
        {
            return this.PullEvent<V1IssuingPersonalizationDesignRejectedEvent>();
        }

        public Task<V1IssuingPersonalizationDesignRejectedEvent> PullAsync()
        {
            return this.PullEventAsync<V1IssuingPersonalizationDesignRejectedEvent>();
        }
    }
}
