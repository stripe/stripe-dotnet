...
namespace Stripe.Events
{
    ...
    /// is unretryable.
    /// </summary>
    public class V2PaymentsOffSessionPaymentFailedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2PaymentsOffSessionPaymentFailedEvent FetchEvent()
        {
            return this.FetchEvent<V2PaymentsOffSessionPaymentFailedEvent>();
        }

        public Task<V2PaymentsOffSessionPaymentFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2PaymentsOffSessionPaymentFailedEvent>();
        }
    }
}
