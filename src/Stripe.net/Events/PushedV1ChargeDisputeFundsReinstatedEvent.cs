...
namespace Stripe.Events
{
    ...
    public class PushedV1ChargeDisputeFundsReinstatedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ChargeDisputeFundsReinstatedEvent>();
        }

        public Task<V1ChargeDisputeFundsReinstatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1ChargeDisputeFundsReinstatedEvent>();
        }
    }
}
