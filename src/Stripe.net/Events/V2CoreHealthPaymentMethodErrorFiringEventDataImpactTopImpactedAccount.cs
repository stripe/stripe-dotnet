...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthPaymentMethodErrorFiringEventDataImpactTopImpactedAccount : StripeEntity<V2CoreHealthPaymentMethodErrorFiringEventDataImpactTopImpactedAccount>
    {
        /// <summary>
