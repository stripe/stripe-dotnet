...
namespace Stripe.Events
{
    ...
    public class PushedV1ClimateProductCreatedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V1ClimateProductCreatedEvent>();
        }

        public Task<V1ClimateProductCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1ClimateProductCreatedEvent>();
        }
    }
}
