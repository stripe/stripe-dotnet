...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2CoreAccountPersonUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        {
            return this.PullEvent<V2CoreAccountPersonUpdatedEvent>();
        }

        public Task<V2CoreAccountPersonUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2CoreAccountPersonUpdatedEvent>();
        }
    }
}
