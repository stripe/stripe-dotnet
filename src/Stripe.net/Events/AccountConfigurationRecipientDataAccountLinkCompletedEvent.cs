...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class AccountConfigurationRecipientDataAccountLinkCompletedEvent : V2.Event
    {
        /// <summary>
        ...
        public AccountConfigurationRecipientDataAccountLinkCompletedEventData Data { get; set; }
