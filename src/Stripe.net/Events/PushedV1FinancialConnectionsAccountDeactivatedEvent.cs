...
namespace Stripe.Events
{
    ...
    /// <c>inactive</c>.
    /// </summary>
    public class PushedV1FinancialConnectionsAccountDeactivatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1FinancialConnectionsAccountDeactivatedEvent Pull()
        {
            return this.PullEvent<V1FinancialConnectionsAccountDeactivatedEvent>();
        }

        public Task<V1FinancialConnectionsAccountDeactivatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1FinancialConnectionsAccountDeactivatedEvent>();
        }
    }
}
