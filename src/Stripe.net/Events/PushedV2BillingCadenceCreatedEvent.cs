...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingCadenceCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingCadenceCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingCadenceCreatedEvent>();
        }

        public Task<V2BillingCadenceCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingCadenceCreatedEvent>();
        }
    }
}
