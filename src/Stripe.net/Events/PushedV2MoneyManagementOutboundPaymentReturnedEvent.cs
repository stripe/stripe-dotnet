...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundPaymentReturnedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentReturnedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundPaymentReturnedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentReturnedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundPaymentReturnedEvent>();
        }
    }
}
