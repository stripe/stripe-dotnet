...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementRecipientVerificationCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementRecipientVerificationCreatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementRecipientVerificationCreatedEvent>();
        }

        public Task<V2MoneyManagementRecipientVerificationCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementRecipientVerificationCreatedEvent>();
        }
    }
}
