...
namespace Stripe.Events
{
    ...
    public class PushedV2ReportingReportRunFailedEvent : V2.PushedEvent
    {
        ...
        {
            return this.PullEvent<V2ReportingReportRunFailedEvent>();
        }

        public Task<V2ReportingReportRunFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2ReportingReportRunFailedEvent>();
        }
    }
}
