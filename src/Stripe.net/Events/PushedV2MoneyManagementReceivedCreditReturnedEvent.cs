...
namespace Stripe.Events
{
    ...
    /// your balance.
    /// </summary>
    public class PushedV2MoneyManagementReceivedCreditReturnedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedCreditReturnedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementReceivedCreditReturnedEvent>();
        }

        public Task<V2MoneyManagementReceivedCreditReturnedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementReceivedCreditReturnedEvent>();
        }
    }
}
