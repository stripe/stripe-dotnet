...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingPricingPlanComponentUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingPricingPlanComponentUpdatedEvent Pull()
        {
            return this.PullEvent<V2BillingPricingPlanComponentUpdatedEvent>();
        }

        public Task<V2BillingPricingPlanComponentUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingPricingPlanComponentUpdatedEvent>();
        }
    }
}
