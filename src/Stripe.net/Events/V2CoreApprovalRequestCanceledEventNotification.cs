...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2CoreApprovalRequestCanceledEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2CoreApprovalRequestCanceledEvent FetchEvent()
        {
            return this.FetchEvent<V2CoreApprovalRequestCanceledEvent>();
        }

        public Task<V2CoreApprovalRequestCanceledEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CoreApprovalRequestCanceledEvent>();
        }
    }
}
