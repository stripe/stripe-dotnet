...
namespace Stripe.Events
{
    ...
    /// Subscriptions</a>.
    /// </summary>
    public class PushedV1InvoiceCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1InvoiceCreatedEvent Pull()
        {
            return this.PullEvent<V1InvoiceCreatedEvent>();
        }

        public Task<V1InvoiceCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1InvoiceCreatedEvent>();
        }
    }
}
