...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V2MoneyManagementOutboundTransferFailedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferFailedEvent FetchEvent()
        {
            return this.FetchEvent<V2MoneyManagementOutboundTransferFailedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferFailedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2MoneyManagementOutboundTransferFailedEvent>();
        }
    }
}
