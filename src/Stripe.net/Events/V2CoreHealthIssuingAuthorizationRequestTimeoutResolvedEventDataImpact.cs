...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthIssuingAuthorizationRequestTimeoutResolvedEventDataImpact : StripeEntity<V2CoreHealthIssuingAuthorizationRequestTimeoutResolvedEventDataImpact>
    {
        /// <summary>
...
#endif
        public V2CoreHealthIssuingAuthorizationRequestTimeoutResolvedEventDataImpactApprovedAmount ApprovedAmount { get; set; }
...
#endif
        public V2CoreHealthIssuingAuthorizationRequestTimeoutResolvedEventDataImpactDeclinedAmount DeclinedAmount { get; set; }
