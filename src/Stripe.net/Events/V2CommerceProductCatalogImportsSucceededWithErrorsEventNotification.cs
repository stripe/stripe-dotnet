...
namespace Stripe.Events
{
    ...
    public class V2CommerceProductCatalogImportsSucceededWithErrorsEventNotification : V2.Core.EventNotification
    {
        ...
        {
            return this.FetchEvent<V2CommerceProductCatalogImportsSucceededWithErrorsEvent>();
        }

        public Task<V2CommerceProductCatalogImportsSucceededWithErrorsEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2CommerceProductCatalogImportsSucceededWithErrorsEvent>();
        }
    }
}
