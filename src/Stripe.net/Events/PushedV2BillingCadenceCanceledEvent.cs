...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingCadenceCanceledEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingCadenceCanceledEvent Pull()
        {
            return this.PullEvent<V2BillingCadenceCanceledEvent>();
        }

        public Task<V2BillingCadenceCanceledEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingCadenceCanceledEvent>();
        }
    }
}
