...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthSepaDebitDelayedFiringEventData : StripeEntity<V2CoreHealthSepaDebitDelayedFiringEventData>
    {
        /// <summary>
...
#endif
        public V2CoreHealthSepaDebitDelayedFiringEventDataImpact Impact { get; set; }
