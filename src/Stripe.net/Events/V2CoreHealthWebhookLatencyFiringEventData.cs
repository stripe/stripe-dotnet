...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthWebhookLatencyFiringEventData : StripeEntity<V2CoreHealthWebhookLatencyFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthWebhookLatencyFiringEventDataImpact Impact { get; set; }
