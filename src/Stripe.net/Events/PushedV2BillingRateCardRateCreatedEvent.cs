...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingRateCardRateCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingRateCardRateCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingRateCardRateCreatedEvent>();
        }

        public Task<V2BillingRateCardRateCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingRateCardRateCreatedEvent>();
        }
    }
}
