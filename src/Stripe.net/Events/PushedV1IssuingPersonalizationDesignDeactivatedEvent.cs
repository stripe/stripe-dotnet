...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV1IssuingPersonalizationDesignDeactivatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V1IssuingPersonalizationDesignDeactivatedEvent Pull()
        {
            return this.PullEvent<V1IssuingPersonalizationDesignDeactivatedEvent>();
        }

        public Task<V1IssuingPersonalizationDesignDeactivatedEvent> PullAsync()
        {
            return this.PullEventAsync<V1IssuingPersonalizationDesignDeactivatedEvent>();
        }
    }
}
