...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthPaymentMethodErrorFiringEventData : StripeEntity<V2CoreHealthPaymentMethodErrorFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthPaymentMethodErrorFiringEventDataImpact Impact { get; set; }
