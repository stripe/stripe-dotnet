...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundTransferCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferCreatedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundTransferCreatedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundTransferCreatedEvent>();
        }
    }
}
