...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementReceivedCreditAvailableEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedCreditAvailableEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementReceivedCreditAvailableEvent>();
        }

        public Task<V2MoneyManagementReceivedCreditAvailableEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementReceivedCreditAvailableEvent>();
        }
    }
}
