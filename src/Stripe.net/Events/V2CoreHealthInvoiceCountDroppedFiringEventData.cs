...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthInvoiceCountDroppedFiringEventData : StripeEntity<V2CoreHealthInvoiceCountDroppedFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
        ...
        public V2CoreHealthInvoiceCountDroppedFiringEventDataImpact Impact { get; set; }
