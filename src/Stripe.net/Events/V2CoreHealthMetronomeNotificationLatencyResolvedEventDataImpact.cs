...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthMetronomeNotificationLatencyResolvedEventDataImpact : StripeEntity<V2CoreHealthMetronomeNotificationLatencyResolvedEventDataImpact>
    {
        /// <summary>
