...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1ChargePendingEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargePendingEvent>();
        }

        public Task<V1ChargePendingEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargePendingEvent>();
        }
    }
}
