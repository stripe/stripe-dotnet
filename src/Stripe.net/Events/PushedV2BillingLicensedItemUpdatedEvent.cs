...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingLicensedItemUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingLicensedItemUpdatedEvent Pull()
        {
            return this.PullEvent<V2BillingLicensedItemUpdatedEvent>();
        }

        public Task<V2BillingLicensedItemUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingLicensedItemUpdatedEvent>();
        }
    }
}
