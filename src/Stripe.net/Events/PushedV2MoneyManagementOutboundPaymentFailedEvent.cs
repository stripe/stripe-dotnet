...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundPaymentFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentFailedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundPaymentFailedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundPaymentFailedEvent>();
        }
    }
}
