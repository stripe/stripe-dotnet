...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundPaymentPostedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundPaymentPostedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundPaymentPostedEvent>();
        }

        public Task<V2MoneyManagementOutboundPaymentPostedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundPaymentPostedEvent>();
        }
    }
}
