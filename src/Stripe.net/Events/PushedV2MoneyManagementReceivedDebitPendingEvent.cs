...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementReceivedDebitPendingEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementReceivedDebitPendingEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementReceivedDebitPendingEvent>();
        }

        public Task<V2MoneyManagementReceivedDebitPendingEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementReceivedDebitPendingEvent>();
        }
    }
}
