...
namespace Stripe.Events
{
    ...
    public class V2CoreAccountConfigurationRecipientCapabilityStatusUpdatedEventData : StripeEntity<V2CoreAccountConfigurationRecipientCapabilityStatusUpdatedEventData>
    {
        /// <summary>
