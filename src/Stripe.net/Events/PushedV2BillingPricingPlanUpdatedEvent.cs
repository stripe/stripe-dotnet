...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingPricingPlanUpdatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingPricingPlanUpdatedEvent Pull()
        {
            return this.PullEvent<V2BillingPricingPlanUpdatedEvent>();
        }

        public Task<V2BillingPricingPlanUpdatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingPricingPlanUpdatedEvent>();
        }
    }
}
