...
namespace Stripe.Events
{
    ...
    public class V2CoreHealthIssuingAuthorizationRequestTimeoutFiringEventData : StripeEntity<V2CoreHealthIssuingAuthorizationRequestTimeoutFiringEventData>
    {
        /// <summary>
        /// The alert ID.
        /// </summary>
...
#endif
        public V2CoreHealthIssuingAuthorizationRequestTimeoutFiringEventDataImpact Impact { get; set; }
