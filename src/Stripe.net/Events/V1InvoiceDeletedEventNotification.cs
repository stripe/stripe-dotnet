...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class V1InvoiceDeletedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        public V1InvoiceDeletedEvent FetchEvent()
        {
            return this.FetchEvent<V1InvoiceDeletedEvent>();
        }

        public Task<V1InvoiceDeletedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1InvoiceDeletedEvent>();
        }
    }
}
