...
namespace Stripe.Events
{
    ...
    /// refunded payments</a>.
    /// </summary>
    public class V1ChargeDisputeFundsReinstatedEventNotification : V2.Core.EventNotification
    {
        /// <summary>
        ...
        {
            return this.FetchEvent<V1ChargeDisputeFundsReinstatedEvent>();
        }

        public Task<V1ChargeDisputeFundsReinstatedEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V1ChargeDisputeFundsReinstatedEvent>();
        }
    }
}
