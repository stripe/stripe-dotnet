...
namespace Stripe.Events
{
    ...
    public class V2PaymentsSettlementAllocationIntentSplitCanceledEventNotification : V2.Core.EventNotification
    {
        ...
        {
            return this.FetchEvent<V2PaymentsSettlementAllocationIntentSplitCanceledEvent>();
        }

        public Task<V2PaymentsSettlementAllocationIntentSplitCanceledEvent> FetchEventAsync()
        {
            return this.FetchEventAsync<V2PaymentsSettlementAllocationIntentSplitCanceledEvent>();
        }
    }
}
