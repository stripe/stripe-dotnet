...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2BillingPricingPlanComponentCreatedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2BillingPricingPlanComponentCreatedEvent Pull()
        {
            return this.PullEvent<V2BillingPricingPlanComponentCreatedEvent>();
        }

        public Task<V2BillingPricingPlanComponentCreatedEvent> PullAsync()
        {
            return this.PullEventAsync<V2BillingPricingPlanComponentCreatedEvent>();
        }
    }
}
