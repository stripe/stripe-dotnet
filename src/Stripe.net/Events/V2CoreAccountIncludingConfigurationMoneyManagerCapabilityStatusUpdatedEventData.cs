...
namespace Stripe.Events
{
    ...
    public class V2CoreAccountIncludingConfigurationMoneyManagerCapabilityStatusUpdatedEventData : StripeEntity<V2CoreAccountIncludingConfigurationMoneyManagerCapabilityStatusUpdatedEventData>
    {
        ...
        /// <c>outbound_transfers.bank_accounts</c>, <c>outbound_transfers.crypto_wallets</c>,
        /// <c>outbound_transfers.financial_accounts</c>, <c>received_credits.bank_accounts</c>,
        /// <c>received_credits.crypto_wallets</c>, or <c>received_debits.bank_accounts</c>.
        /// </summary>
