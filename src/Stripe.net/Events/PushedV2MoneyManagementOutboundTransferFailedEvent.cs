...
namespace Stripe.Events
{
    ...
    /// </summary>
    public class PushedV2MoneyManagementOutboundTransferFailedEvent : V2.PushedEvent
    {
        /// <summary>
        ...
        public V2MoneyManagementOutboundTransferFailedEvent Pull()
        {
            return this.PullEvent<V2MoneyManagementOutboundTransferFailedEvent>();
        }

        public Task<V2MoneyManagementOutboundTransferFailedEvent> PullAsync()
        {
            return this.PullEventAsync<V2MoneyManagementOutboundTransferFailedEvent>();
        }
    }
}
